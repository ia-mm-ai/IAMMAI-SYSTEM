#!/usr/bin/env python3
"""
API-backed vessel v2 for current_state_standing_reader_v1.

This additive file keeps the shell sovereign while correcting the earlier
Responses API schema incompatibility. The model only drafts bounded answer
content. Local code still owns manifest enforcement, input validation, source
...
class CurrentStateStandingReaderAPIVesselV2(CurrentStateStandingReaderHarnessV3):
    ...
    @classmethod
    def from_environment(cls) -> "CurrentStateStandingReaderAPIVesselV2":
        ...
        *,
        ...
        response = self._client.responses.create(
            ...
            text={
                "format": {
                    "type": "json_schema",
                    "name": "current_state_standing_reader_v1_draft_v2",
                    "schema": DRAFT_SCHEMA,
                    "strict": True,
                }
            },
...
def print_usage() -> None:
    usage = (
        "Usage:\n"
        "  python vessel/current_state_standing_reader_v1/api_vessel_v2.py answer <path-to-input-packet.json>\n"
        "  python vessel/current_state_standing_reader_v1/api_vessel_v2.py eval\n"
    )
...
def main(argv: Sequence[str]) -> int:
    ...
    vessel = CurrentStateStandingReaderAPIVesselV2.from_environment()
