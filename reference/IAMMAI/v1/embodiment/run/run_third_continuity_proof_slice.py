#!/usr/bin/env python3
"""
Bounded v1 runner for the third continuity proof slice.
...
validates the canonical continuity body against the v1 continuity schema,
...
try:
    from source_selection import SourceSelectionError, SuccessorContinuitySources, select_successor_continuity_sources
...
def evaluate_preservation_conformance(
    ...
    add_check(
        ...
        bool(written_files.get("continuity_body"))
        and bool(written_files.get("execution_relation")),
    ...
    add_check(
        ...
        and all(
            "/fixture_outputs/negative/" in path
            for path in written_files.get("negative_fixtures", [])
        ),
    ...
    add_check(
        ...
        continuity_dir.name == "continuity"
        and continuity_dir.parent.parent == RUNS_DIR,
...
def build_run_summary(
    ...
    return {
        "summary_type": "v1_third_continuity_proof_slice_summary",
        "execution_identity": execution_id,
        "continuity_turn_identity": continuity_turn_id,
        "continuity_run_directory": repo_relative(continuity_dir),
        "source_selection": {
        ...
        "reading_posture": {
            "positive_path": "read by continuity body, execution relation, preservation, and recorded source-selection layers",
...
def build_manifest(
    ...
    return {
        "manifest_type": "v1_third_continuity_preservation_manifest",
...
def main() -> int:
    ...
    try:
        ...
        positive_body_path = (
            continuity_dir / "canonical_body" / "positive" / "continuity_turn.body.json"
        )
        ...
        execution_relation_path = (
            continuity_dir
            / "execution_relation"
            / "positive"
            / "continuity_execution_relation.json"
        )
        ...
        execution_relation_result_path = (
            continuity_dir
            / "conformance"
            / "execution_relation"
            / "positive"
        ...
        negative_body_path = (
            ...
            / "negative"
            / "body"
            / "successor_without_anchor.body.json"
        )
        ...
        negative_classification = {
            "fixture_class": "conformance_failure",
            "scope": "third_successor_continuity_proof_slice",
            "artifact_family": "continuity_turn",
        ...
        negative_classification_path = (
            continuity_dir / "fixture_outputs" / "negative" / "classification.json"
        )
        ...
        negative_result_path = (
            ...
            / "body"
            / "negative"
            / "successor_without_anchor_continuity_turn.json"
        )
        ...
        preservation_result_path = (
            continuity_dir / "conformance" / "preservation" / "run_write_outcome.json"
        )
        ...
        print(
            f"Failed to write bounded v1 third continuity proof slice outputs: {exc}",
            file=sys.stderr,
        )
        return 1
    ...
    print("Bounded v1 third continuity proof slice completed.")
