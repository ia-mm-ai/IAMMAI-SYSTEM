#!/usr/bin/env python3
"""
Bounded v1 runner for the third ordinary proof slice.
...
explicitly separable execution-bearing envelopes, and preserves the result
through the shared implementation-local preservation layout under
v1/registry/runs/.
"""
...
CONDITION_SET_REF = "condition-set-v1-third-proof-slice-threshold-validation"
ACTOR_REF = "actor-v1-local-operator"
LEGITIMACY_BASIS_REF = "legitimacy-basis-v1-third-proof-slice"
...
def build_run_summary(
    ...
    return {
        "summary_type": "v1_third_proof_slice_summary",
...
def main() -> int:
    ...
    try:
        ...
        manifest_payload = build_manifest_payload(
            layout,
            written_outputs,
            manifest_type="v1_third_proof_slice_preservation_manifest",
            extra={
                "matter_identity": matter_id,
                "continuity_emitted": False,
                "preservation_result_ref": repo_relative(preservation_result_output.path),
    ...
    print("Bounded v1 third ordinary proof slice completed.")
