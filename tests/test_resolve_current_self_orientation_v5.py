"""Tests for bounded current self-orientation v5.

The v5 resolver is a narrow successor to v4. These tests verify that v5
preserves v4 self-orientation posture while recognizing body-signal scope only
as downstream applicability-containment posture.
"""
...
import resolve_current_self_orientation_v5 as resolver
...
def _orientation_non_claims() -> dict[str, bool]:
    return dict(resolver.NON_CLAIM_DEFAULTS)
...
def _scope_non_claims() -> dict[str, bool]:
    return {
        "action_authorized": False,
...
def _make_stack(root: Path, **overrides: object) -> dict[str, object]:
    roots = {
        ...
        "scope": root / "artifacts/integrity_host_v0_min_coexistence_body_signal_scope",
        "v5": root
    ...
    selected_inputs = {
        ...
        "selected_self_orientation_v3_result": {
            "result_id": "self-orientation-v3-001",
            "result_path": "artifacts/synthetic/self_orientation_v3.json",
            "outcome": "SELF_ORIENTED",
        },
    ...
    v4_result = {
        "current_self_orientation_v4_metadata": {
            "self_orientation_result_id": "self-orientation-v4-001",
            "self_orientation_result_type": (
                "IAMMAI_INTEGRITY_HOST_V0_MIN_COEXISTENCE_CURRENT_SELF_ORIENTATION_V4_RESULT"
            ),
            "self_orientation_result_version": "0.4.0",
            "generated_at": "2026-04-26T00:00:00Z",
            "resolver_module": "resolve_current_self_orientation_v4",
            "successor_of_module": "resolve_current_self_orientation_v3",
        },
        ...
        "recognized_body_signal_surfaces": {
            "recognition_posture": "downstream_body_signal_recognition_and_acceptance_only",
        ...
        "bounded_correspondence_checks": [
            {"check_name": "v3_current_basis_not_recency_driven", "passed": True},
            {"check_name": "v4_body_signal_acceptance_is_accepted", "passed": True},
        ],
        "outcome": "SELF_ORIENTED",
        "block": {"block_code": None, "block_reason": None},
        "self_orientation_basis": {
            "basis_kind": "v4_self_orientation_plus_downstream_body_signal_acceptance",
        ...
        "non_claims": _orientation_non_claims(),
    }
    v4_path = roots["v4"] / "current_self_orientation_v4_result.json"
    _write_json(v4_path, v4_result)
    ...
    blocked_artifact["recognized_signal"] = {
        "recognized_signal_id": None,
    ...
    scope_path = roots["scope"] / "body_signal_scope_result.json"
    scope_non_claims = _scope_non_claims()
    scope_non_claims.update(
        overrides.get("scope_nonclaims_update", {})  # type: ignore[arg-type]
    )
    ...
    scope_accepted_matter_id = str(
        overrides.get("scope_accepted_matter_id", "current_signal_recognition_standing")
    )
    scoped_signal = {
        "scoped_signal_id": "scoped-body-pass-signal-001",
        "scoped_signal_category": str(
            overrides.get("scoped_signal_category", "BODY_PASS_SIGNAL")
        ),
        "selected_signal_acceptance_result_id": str(
            overrides.get("scope_selected_acceptance_id", "body-signal-acceptance-001")
        ),
        "selected_signal_acceptance_result_path": str(
            overrides.get("scope_selected_acceptance_path", acceptance_path)
        ),
        "selected_signal_acceptance_outcome": "SIGNAL_ACCEPTED",
        "accepted_signal_id": accepted_signal["accepted_signal_id"],
        "accepted_signal_category": accepted_signal["accepted_signal_category"],
        "recognized_source_artifact_id": body_id,
        "recognized_source_artifact_path": str(body_path),
        "recognized_source_artifact_family": "v0_body_pass_result",
        "recognized_source_artifact_outcome": "V0_BODY_PASS_CONFIRMED",
        "accepted_matter_id": scope_accepted_matter_id,
        ...
        "declared_scope_purpose": (
            "Bind accepted BODY_PASS_SIGNAL only to non-operative current "
            "signal-recognition standing posture."
        ),
        "declared_scope_boundary": (
            "Applies only inside current_signal_recognition_standing and not "
    ...
    scoped_signal.update(overrides.get("scoped_signal_update", {}))  # type: ignore[arg-type]
    scope_summary = {
        "outcome": "SIGNAL_SCOPED",
        "failed_check_count": 0,
        "passed_check_count": 42,
        "selected_signal_acceptance_result_id": "body-signal-acceptance-001",
        "selected_signal_acceptance_result_path": str(acceptance_path),
        "selected_signal_acceptance_result_outcome": "SIGNAL_ACCEPTED",
        "scoped_signal_id": scoped_signal["scoped_signal_id"],
        "scoped_signal_category": scoped_signal["scoped_signal_category"],
        "accepted_matter_id": scope_accepted_matter_id,
        "accepted_matter_family": "body_signal_acceptance_matter",
        "accepted_matter_kind": "recognized_body_signal_posture",
        "declared_scope_id": declared_scope_id,
    ...
    scope_summary.update(overrides.get("scope_summary_update", {}))  # type: ignore[arg-type]
    scope_artifact = {
        "body_signal_scope_metadata": {
            "body_signal_scope_result_id": "body-signal-scope-001",
        ...
        "selected_signal_acceptance_result": {
            "signal_acceptance_result_id": str(
                overrides.get("scope_selected_acceptance_id", "body-signal-acceptance-001")
            ),
            "signal_acceptance_result_path": str(
                overrides.get("scope_selected_acceptance_path", acceptance_path)
            ),
            "signal_acceptance_result_version": "0.1.0",
            "signal_acceptance_outcome": "SIGNAL_ACCEPTED",
            "signal_acceptance_resolver_module": "resolve_body_signal_acceptance",
        },
        "selected_accepted_signal": {
            "accepted_signal_id": accepted_signal["accepted_signal_id"],
            "accepted_signal_category": accepted_signal["accepted_signal_category"],
            "selected_signal_recognition_result_id": str(
                overrides.get("scope_selected_recognition_id", recognition_result_id)
            ),
            "selected_signal_recognition_result_path": str(
                overrides.get("scope_selected_recognition_path", recognition_path)
            ),
        },
        "declared_scope": {
            ...
            "scope_matter_id": scope_accepted_matter_id,
            "scope_purpose": scoped_signal["declared_scope_purpose"],
            "scope_boundary": scoped_signal["declared_scope_boundary"],
            "applies_to": scoped_signal["applies_to"],
            "does_not_apply_to": scoped_signal["does_not_apply_to"],
        },
        "scoped_signal": scoped_signal,
        "body_signal_scope_summary": scope_summary,
        "outcome": str(overrides.get("scope_outcome", "SIGNAL_SCOPED")),
        "block": {"block_code": None, "block_reason": None},
        "non_claims": scope_non_claims,
    }
    if overrides.get("scope_malformed") is True:
        scope_path.write_text("[1, 2, 3]\n", encoding="utf-8")
    elif overrides.get("omit_scope") is not True:
        _write_json(scope_path, scope_artifact)
...
def _patched_stack(**overrides: object):
    with tempfile.TemporaryDirectory() as tmp:
        ...
        with contextlib.ExitStack() as stack:
            ...
            stack.enter_context(
                mock.patch.object(resolver, "BODY_SIGNAL_SCOPE_ROOT", roots["scope"])
            )
            stack.enter_context(
                mock.patch.object(resolver, "CURRENT_SELF_ORIENTATION_V5_ROOT", roots["v5"])
            )
            yield paths


class ResolveCurrentSelfOrientationV5Tests(unittest.TestCase):
    ...
    def test_real_self_oriented_v5_path_has_expected_sections(self) -> None:
    ...
    def test_metadata_preserves_v5_lineage(self) -> None:
        metadata = self.live_result()["current_self_orientation_v5_metadata"]
        ...
        self.assertEqual("0.5.0", metadata["self_orientation_result_version"])
        self.assertTrue(metadata["generated_at"])
        self.assertEqual("resolve_current_self_orientation_v5", metadata["resolver_module"])
        self.assertEqual(
            "resolve_current_self_orientation_v4",
            metadata["successor_of_module"],
        )

    def test_selected_input_set_preserves_v4_and_signal_scope_inputs(self) -> None:
        ...
        self.assertTrue(scope["body_signal_scope_surface_is_downstream_only"])
        self.assertFalse(scope["repo_wide_authority_scan_performed"])

    def test_v4_architecture_sections_remain_distinct(self) -> None:
        result = self.live_result()
        for key in (
            "recognized_current_executable_core_line",
            "recognized_governing_effective_basis",
        ...
        self.assertNotEqual(
            json.dumps(result["recognized_current_state_surfaces"], sort_keys=True),
            json.dumps(result["recognized_body_signal_surfaces"], sort_keys=True),
        )
    ...
    def test_current_governing_basis_remains_upstream_derived(self) -> None:
        ...
        self.assertFalse(basis["signal_scope_creates_authority"])
        self.assertFalse(basis["scoped_signal_creates_permission"])
        ...
        self.assertTrue(
            checks["body_signal_scope_surface_does_not_determine_current_governing_basis"][
                "passed"
            ]
        )

    def test_body_signal_recognition_section_remains_intact(self) -> None:
    ...
    def test_body_signal_acceptance_section_remains_intact(self) -> None:
        body_signal = self.live_result()["recognized_body_signal_surfaces"]
        ...
        for key in (
            "recognition_basis_passed",
            "matter_boundary_passed",
            "acceptance_scope_passed",
            "acceptance_hierarchy_constraints_passed",
            "acceptance_correspondence_requirements_passed",
            "acceptance_non_claims_passed",
        ):
            self.assertTrue(body_signal[key], key)

    def test_body_signal_scope_section_preserves_declared_scope_and_checks(self) -> None:
        body_signal = self.live_result()["recognized_body_signal_surfaces"]
        scope = body_signal["selected_body_signal_scope_result"]
        scoped = body_signal["scoped_signal"]
        declared_scope = body_signal["declared_scope"]
        self.assertEqual("SIGNAL_SCOPED", scope["outcome"])
        self.assertEqual("BODY_PASS_SIGNAL", scoped["scoped_signal_category"])
        self.assertEqual(
            "current_signal_recognition_standing__body_pass_signal_nonoperative_posture_scope",
            declared_scope["scope_id"],
        )
        self.assertEqual("body_signal_scope", declared_scope["scope_family"])
        self.assertEqual("nonoperative_body_pass_signal_posture", declared_scope["scope_kind"])
        self.assertEqual("current_signal_recognition_standing", declared_scope["accepted_matter_id"])
        for key in (
            "scope_boundary_passed",
            "scope_limits_passed",
            "scope_hierarchy_constraints_passed",
            "scope_correspondence_requirements_passed",
            "scope_non_claims_passed",
        ):
            self.assertTrue(body_signal[key], key)

    def test_scoped_signal_non_collapse_posture_is_preserved(self) -> None:
        body_signal = self.live_result()["recognized_body_signal_surfaces"]
        scoped = body_signal["scoped_signal"]
        remains = body_signal["scoped_signal_remains"]
        self.assertTrue(scoped["non_authoritative"])
        self.assertTrue(scoped["non_permission"])
        self.assertTrue(scoped["non_currentness"])
        for key in (
            "non_authoritative",
            "non_permission",
            "non_currentness",
        ...
        self.assertFalse(body_signal["body_signal_scope_creates_authority"])

    def test_closed_signal_line_is_downstream_scoped_and_non_operative(self) -> None:
        basis = self.live_result()["self_orientation_basis"]
        for key in (
            "body_signal_surfaces_remain_downstream",
            "body_signal_recognition_recognized",
            "body_signal_acceptance_accepted",
            "body_signal_scope_scoped",
        ):
            self.assertTrue(basis[key])
        for key in (
            "recognized_signal_creates_permission",
            "accepted_signal_creates_permission",
            "scoped_signal_creates_permission",
            "scoped_signal_establishes_presence",
            "scoped_signal_meets_threshold",
            "scoped_signal_creates_truth",
            "scoped_signal_authorizes_action",
            "scoped_signal_authorizes_follow_on_work",
            "scoped_signal_routes",
            "scoped_signal_creates_workflow",
            "scoped_signal_creates_body_relevance_medium",
            "scoped_signal_applies_outside_declared_scope",
        ):
            self.assertFalse(basis[key], key)

    def test_bounded_correspondence_checks_include_v4_and_v5_checks(self) -> None:
        checks = self.live_result()["bounded_correspondence_checks"]
        names = {check["check_name"] for check in checks}
        self.assertIn("v4_self_orientation_is_self_oriented", names)
        self.assertTrue(V4_SIGNAL_CHECKS.issubset(names))
        self.assertTrue(V5_SCOPE_CHECKS.issubset(names))
        for check in checks:
            if check["check_name"] in V4_SIGNAL_CHECKS | V5_SCOPE_CHECKS:
                self.assertTrue(check["passed"], check)

    def test_summary_helper_preserves_bounded_v5_summary(self) -> None:
        result = self.live_result()
        ...
        for key in (
            ...
            "selected_self_orientation_v4_result_id",
        ...
        for key in (
            ...
            "scoped_signal_remains_non_permission",
            "scoped_signal_remains_non_currentness",
            "scoped_signal_remains_not_present",
            "scoped_signal_remains_not_threshold",
            "scoped_signal_remains_not_truth",
            "scoped_signal_remains_no_action",
            "scoped_signal_remains_no_routing",
            "scoped_signal_remains_no_workflow",
            "scoped_signal_remains_no_body_relevance_medium",
            "scoped_signal_remains_no_application_outside_declared_scope",
        ...
        self.assertEqual(
            "current_signal_recognition_standing__body_pass_signal_nonoperative_posture_scope",
            summary["declared_scope_id"],
        )
        self.assertFalse(summary["non_claims"]["authority_created"])

    def test_path_based_resolution_selects_matching_scope_surface(self) -> None:
        result = self.live_result()
        ...
        self.assertEqual(
            result["selected_orientation_inputs"]["selected_body_signal_scope_result"][
                "result_id"
            ],
            path_result["selected_orientation_inputs"]["selected_body_signal_scope_result"][
                "result_id"
            ],
        )
        self.assertFalse(path_result["self_orientation_basis"]["signal_scope_creates_authority"])

    def test_write_behavior_with_explicit_path(self) -> None:
        result = self.live_result()
        with tempfile.TemporaryDirectory() as tmp:
            output_path = Path(tmp) / "nested" / "v5_result.json"
    ...
    def test_default_output_path_is_bounded_and_non_overwriting(self) -> None:
        ...
        self.assertIn("current_self_orientation_v5_result", first.name)
        self.assertTrue(first.name.endswith(".json"))
        self.assertIn("current_self_orientation_v5_result_001.json", second.name)
    ...
    def test_refused_no_matching_body_signal_scope(self) -> None:
        result = self.assert_blocked_with(
            {"omit_scope": True},
            {"BODY_SIGNAL_SCOPE_UNREADABLE"},
        )
        selected = result["selected_orientation_inputs"]
        self.assertFalse(selected["selected_body_signal_scope_result"])
        self.assertFalse(result["self_orientation_basis"]["signal_scope_creates_permission"])

    def test_refused_body_signal_scope_not_scoped(self) -> None:
        self.assert_blocked_with(
            {"scope_outcome": "BLOCKED"},
            {"BODY_SIGNAL_SCOPE_UNREADABLE", "BODY_SIGNAL_SCOPE_NOT_SCOPED"},
        )

    def test_refused_body_signal_scope_malformed(self) -> None:
        self.assert_blocked_with(
            {"scope_malformed": True},
            {"BODY_SIGNAL_SCOPE_UNREADABLE", "BODY_SIGNAL_SCOPE_MALFORMED"},
        )

    def test_refused_scope_does_not_match_selected_acceptance(self) -> None:
        self.assert_blocked_with(
            {
                "scope_selected_acceptance_id": "different-acceptance",
                "scope_selected_acceptance_path": "different-acceptance.json",
            },
            {
                "BODY_SIGNAL_SCOPE_UNREADABLE",
    ...
    def test_refused_scope_does_not_match_selected_recognition(self) -> None:
        self.assert_blocked_with(
            {
                "scope_selected_recognition_id": "different-recognition",
                "scope_selected_recognition_path": "different-recognition.json",
            },
            {
                "BODY_SIGNAL_SCOPE_UNREADABLE",
        ...
        self.assert_blocked_with(
            {"scoped_signal_category": "OTHER_SIGNAL"},
            {
                "BODY_SIGNAL_SCOPE_DOES_NOT_MATCH_SELECTED_ACCEPTANCE",
                "BODY_SIGNAL_SCOPE_DOES_NOT_MATCH_SELECTED_RECOGNITION",
            },
    ...
    def test_refused_declared_scope_mismatch(self) -> None:
        self.assert_blocked_with(
            {"declared_scope_id": "general_signal_scope"},
            {"BODY_SIGNAL_SCOPE_UNREADABLE", "BODY_SIGNAL_SCOPE_DECLARED_SCOPE_MISMATCH"},
        )

    def test_refused_accepted_matter_mismatch(self) -> None:
        self.assert_blocked_with(
            {"scope_accepted_matter_id": "general_signal_handling"},
            {"BODY_SIGNAL_SCOPE_UNREADABLE", "BODY_SIGNAL_SCOPE_ACCEPTED_MATTER_MISMATCH"},
        )

    def test_refused_scope_presence_threshold_truth_collapse(self) -> None:
        cases = [
            ({"not_present_yet": False}, "BODY_SIGNAL_SCOPE_PRESENCE_COLLAPSE"),
            ({"not_threshold_yet": False}, "BODY_SIGNAL_SCOPE_THRESHOLD_COLLAPSE"),
            ({"not_truth": False}, "BODY_SIGNAL_SCOPE_TRUTH_COLLAPSE"),
        ]
        for scoped_signal_update, expected_code in cases:
            with self.subTest(scoped_signal_update=scoped_signal_update):
                self.assert_blocked_with(
                    {"scoped_signal_update": scoped_signal_update},
                    {expected_code},
                )

    def test_refused_scoped_signal_becomes_authority_permission_currentness(self) -> None:
        cases = [
            ({"non_authoritative": False}, "BODY_SIGNAL_SCOPE_TREATED_AS_AUTHORITY"),
            ({"non_permission": False}, "BODY_SIGNAL_SCOPE_ACTION_PERMISSION_LEAK"),
            (
    ...
    def test_refused_scoped_signal_action_and_follow_on_leaks(self) -> None:
        self.assert_blocked_with(
            {"scoped_signal_update": {"no_action": False}},
            {"BODY_SIGNAL_SCOPE_ACTION_PERMISSION_LEAK"},
        )
        self.assert_blocked_with(
            {"scope_nonclaims_update": {"follow_on_work_authorized": True}},
            {
                "BODY_SIGNAL_SCOPE_UNREADABLE",
    ...
    def test_refused_scoped_signal_routing_workflow_medium_leaks(self) -> None:
        cases = [
            ({"no_routing": False}, "BODY_SIGNAL_SCOPE_ROUTING_LEAK"),
            ({"no_workflow": False}, "BODY_SIGNAL_SCOPE_WORKFLOW_LEAK"),
            (
    ...
    def test_refused_scoped_signal_applies_outside_declared_scope(self) -> None:
        self.assert_blocked_with(
            {"scoped_signal_update": {"no_application_outside_declared_scope": False}},
            {"BODY_SIGNAL_SCOPE_APPLIED_OUTSIDE_DECLARED_SCOPE"},
        )
        self.assert_blocked_with(
            {"scope_nonclaims_update": {"applied_outside_declared_scope": True}},
            {
                "BODY_SIGNAL_SCOPE_UNREADABLE",
                "BODY_SIGNAL_SCOPE_APPLIED_OUTSIDE_DECLARED_SCOPE",
                "NON_CLAIM_MISSING_OR_FLIPPED",
    ...
    def test_refused_signal_scope_surface_treated_as_authority(self) -> None:
        self.assert_blocked_with(
            {"scoped_signal_update": {"non_authoritative": False}},
            {"BODY_SIGNAL_SCOPE_TREATED_AS_AUTHORITY"},
        )

    def test_refused_signal_scope_surface_treated_as_current_governing_basis(self) -> None:
        self.assert_blocked_with(
            {"scoped_signal_update": {"non_currentness": False}},
            {"BODY_SIGNAL_SCOPE_TREATED_AS_CURRENT_OR_GOVERNING_BASIS"},
        )
    ...
    def test_scope_summary_failures_block_without_inventing_signal_scope(self) -> None:
        self.assert_blocked_with(
            {"scope_summary_update": {"failed_check_count": 1}},
            {"BODY_SIGNAL_SCOPE_MALFORMED"},
        )
        self.assert_blocked_with(
            {"scope_summary_update": {"scope_boundary_passed": False}},
            {"BODY_SIGNAL_SCOPE_MALFORMED"},
        )
