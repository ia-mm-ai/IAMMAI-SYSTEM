"""Tests for the local read-only prior-result re-entry boundary resolver.

This suite keeps the target boundary-shaped, selected-state-only, local,
...
class LocalRelevanceMediumReadOnlyPriorResultReentryBoundaryV0MinTest(unittest.TestCase):
    """Executable membrane for one prior-result re-entry boundary object."""
