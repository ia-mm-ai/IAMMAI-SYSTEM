"""Resolve one selected-state local carrier command execution result boundary.

This resolver records a boundary only. It reads one clean selected-state local
carrier command execution artifact as execution basis and may record that a
future command execution result can be considered later. It does not create a
command execution result, return state payload, create a state result object,
perform lookup, execute lookup commands, create permissions, create public or
distributed surfaces, discover files, or authorize follow-on work.
"""
...
class LocalRelevanceMediumReadOnlyLocalCarrierCommandExecutionResultBoundaryV0MinError(
    RuntimeError
):
...
INTENT_RECORD = (
    "RECORD_LOCAL_RELEVANCE_MEDIUM_READ_ONLY_LOCAL_CARRIER_COMMAND_EXECUTION_RESULT_BOUNDARY"
)
INTENT_DO_NOT_RECORD = (
    "DO_NOT_RECORD_LOCAL_RELEVANCE_MEDIUM_READ_ONLY_LOCAL_CARRIER_COMMAND_EXECUTION_RESULT_BOUNDARY"
)
INTENT_BLOCK = (
    "BLOCK_LOCAL_RELEVANCE_MEDIUM_READ_ONLY_LOCAL_CARRIER_COMMAND_EXECUTION_RESULT_BOUNDARY"
)
SUPPORTED_INTENTS = (INTENT_RECORD, INTENT_DO_NOT_RECORD, INTENT_BLOCK)

CORE_QUESTION = (
    "Given one clean LOCAL_RELEVANCE_MEDIUM_READ_ONLY_LOCAL_CARRIER_COMMAND_EXECUTION "
    "for selected command state, may one "
    "LOCAL_RELEVANCE_MEDIUM_READ_ONLY_LOCAL_CARRIER_COMMAND_EXECUTION_RESULT_BOUNDARY "
    "be recorded that permits a future command execution result for that "
    "selected-state command execution to be considered as a separately bounded "
    "step, without creating command execution result, returning state payload, "
    "creating state result object, performing lookup, executing lookup commands, "
...
COMMAND_EXECUTION_RESULT_BOUNDARY_OBJECT_FALSE_FIELDS = (
...
REQUIRED_FALSE_NON_CLAIMS = (
    ...
    "follow_on_work_authorized",
    "artifact_existence_treated_as_command_execution_result_boundary_authority",
    "latest_file_posture_treated_as_command_execution_result_boundary_authority",
    "repo_local_availability_treated_as_command_execution_result_boundary_authority",
    "hidden_repo_state_used_as_command_execution_result_boundary_content",
    "hidden_repo_state_used_as_command_execution_result_boundary_authority",
...
BLOCK_CODES = (
    "LOCAL_RELEVANCE_MEDIUM_READ_ONLY_LOCAL_CARRIER_COMMAND_EXECUTION_RESULT_BOUNDARY_QUESTION_UNDECLARED",
    "LOCAL_RELEVANCE_MEDIUM_READ_ONLY_LOCAL_CARRIER_COMMAND_EXECUTION_RESULT_BOUNDARY_INTENT_UNSUPPORTED",
    "LOCAL_RELEVANCE_MEDIUM_READ_ONLY_LOCAL_CARRIER_COMMAND_EXECUTION_RESULT_BOUNDARY_BLOCK_REQUESTED",
    ...
    "FUTURE_COMMAND_EXECUTION_RESULT_MAY_NOT_BE_CONSIDERED",
    "BOUNDARY_TYPE_MISSING",
    "BOUNDARY_TYPE_NOT_LOCAL_RELEVANCE_MEDIUM_READ_ONLY_LOCAL_CARRIER_COMMAND_EXECUTION_RESULT_BOUNDARY",
    "BOUNDARY_SCOPE_MISSING",
    "BOUNDARY_SCOPE_NOT_SELECTED_STATE_COMMAND_EXECUTION_RESULT_CONSIDERATION_ONLY",
    "COMMAND_EXECUTION_RESULT_CREATED",
    "STATE_PAYLOAD_RETURNED",
    "STATE_RESULT_OBJECT_CREATED",
    "LOOKUP_PERFORMED",
    ...
    "PRIOR_ARTIFACTS_MUTATED",
    "DECLARED_LOCAL_RELEVANCE_MEDIUM_READ_ONLY_LOCAL_CARRIER_COMMAND_EXECUTION_RESULT_BOUNDARY_REQUEST_MALFORMED",
    "DECLARED_LOCAL_RELEVANCE_MEDIUM_READ_ONLY_LOCAL_CARRIER_COMMAND_EXECUTION_RESULT_BOUNDARY_REQUEST_UNREADABLE",
)
...
FORBIDDEN_OUTPUT_ROOTS = (
    "artifacts/integrity_host_v0_min_coexistence_local_relevance_medium_read_only_local_carrier_command_execution_v0_min",
    "artifacts/integrity_host_v0_min_coexistence_local_relevance_medium_read_only_local_carrier_command_execution_boundary_v0_min",
    "artifacts/integrity_host_v0_min_coexistence_local_relevance_medium_read_only_local_carrier_command_surface_v0_min",
    "artifacts/integrity_host_v0_min_coexistence_local_relevance_medium_read_only_local_carrier_command_surface_boundary_v0_min",
    "artifacts/integrity_host_v0_min_coexistence_local_relevance_medium_read_only_reusable_lookup_permission_v0_min",
    "artifacts/integrity_host_v0_min_coexistence_local_relevance_medium_read_only_reusable_lookup_permission_boundary_v0_min",
    "artifacts/integrity_host_v0_min_coexistence_local_relevance_medium_read_only_lookup_pair_coverage_v0_min",
    "artifacts/integrity_host_v0_min_coexistence_local_relevance_medium_read_only_second_orientation_lookup_result_v0_min",
    "artifacts/integrity_host_v0_min_coexistence_local_relevance_medium_read_only_orientation_lookup_result_v0_min",
    "artifacts/integrity_host_v0_min_coexistence_local_relevance_medium_read_only_orientation_index_system_v0_min",
    "artifacts/integrity_host_v0_min_coexistence_local_relevance_medium_read_only_state_reader_v0_min",
    "artifacts/integrity_host_v0_min_coexistence_local_relevance_medium_comparison_view_v0_min",
    ...
    "artifacts/integrity_host_v0_min_coexistence_runtime_layer_closure_v0_min",
    "artifacts/integrity_host_v0_min_coexistence_runtime_loop_v0_min",
    ...
    "artifacts/integrity_host_v0_min_coexistence_reception_v0_min",
    ...
    "artifacts/integrity_host_v0_min_coexistence_deployment_v0_min",
    "artifacts/integrity_host_v0_min_coexistence_public_release_v0_min",
)
...
def _check(
    ...
    if not passed:
        public_code = (
            ...
            else "DECLARED_LOCAL_RELEVANCE_MEDIUM_READ_ONLY_LOCAL_CARRIER_COMMAND_EXECUTION_RESULT_BOUNDARY_REQUEST_MALFORMED"
        )
...
def _artifact_result_version(
    ...
    for candidate in (
        ...
        metadata.get("local_relevance_medium_read_only_local_carrier_command_execution_version"),
...
def _read_json_artifact(path_value: Any) -> tuple[dict[str, Any] | None, str | None]:
    try:
        path = Path(path_value)
    except TypeError:
        return None, "COMMAND_EXECUTION_ARTIFACT_UNREADABLE"
    try:
    ...
    if not _is_mapping(artifact):
        return None, "COMMAND_EXECUTION_ARTIFACT_NOT_JSON_OBJECT"
...
def _append_declared_request_checks(
    ...
    question = declared.get(
        "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_question"
    )
    _check(
        checks,
        "command execution result boundary question declared",
    ...
    intent = declared.get(
        "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_intent"
    )
    _check(
        checks,
...
def _append_true_posture_checks(
    ...
    for field, code in expected_true.items():
        if field in declared:
            _check(
                checks,
...
def _validate_command_execution_artifact(
    ...
    artifact, read_code = _read_json_artifact(artifact_path)
    _check(
        checks,
    ...
    failed_check_count = _artifact_failed_check_count(artifact, metadata_key, summary_key)
    basis.update(
        {
            "outcome": outcome,
    ...
    for field in COMMAND_EXECUTION_RESULT_BOUNDARY_OBJECT_FALSE_FIELDS:
...
def _append_boundary_membrane_checks(
    ...
    _check(
        checks,
        "artifact existence not command execution result boundary authority",
        declared.get(
            "artifact_existence_treated_as_command_execution_result_boundary_authority"
        )
        is not True,
    ...
    _check(
        checks,
        "latest file posture not command execution result boundary authority",
        declared.get(
            "latest_file_posture_treated_as_command_execution_result_boundary_authority"
        )
        is not True,
    ...
    _check(
        checks,
        "repo local availability not command execution result boundary authority",
        declared.get(
            "repo_local_availability_treated_as_command_execution_result_boundary_authority"
        )
        is not True,
    ...
    _check(
        checks,
        "hidden repo state not command execution result boundary content",
        declared.get("hidden_repo_state_used_as_command_execution_result_boundary_content")
        is not True,
        False,
        declared.get("hidden_repo_state_used_as_command_execution_result_boundary_content"),
        "HIDDEN_REPO_STATE_USED_AS_COMMAND_EXECUTION_RESULT_BOUNDARY_CONTENT",
    ...
    _check(
        checks,
        "hidden repo state not command execution result boundary authority",
        declared.get("hidden_repo_state_used_as_command_execution_result_boundary_authority")
        is not True,
        False,
        declared.get("hidden_repo_state_used_as_command_execution_result_boundary_authority"),
        "HIDDEN_REPO_STATE_USED_AS_COMMAND_EXECUTION_RESULT_BOUNDARY_AUTHORITY",
...
def _build_boundary_object(
    ...
    boundary = {
        "boundary_id": str(
            declared.get(
                "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_id",
                DEFAULT_BOUNDARY_ID,
            )
        ),
        "boundary_type": BOUNDARY_TYPE,
        ...
        "boundary_scope": BOUNDARY_SCOPE,
        "basis_command_execution_artifact": _sanitize(basis.get("artifact")),
        "basis_command_execution_outcome": basis.get("outcome"),
        "basis_command_execution_result_version": basis.get("result_version"),
        "basis_command_execution_failed_check_count": basis.get("failed_check_count"),
        "selected_command": selected_command,
        ...
        "future_command_execution_result_may_be_considered": recorded,
    }
    for field in COMMAND_EXECUTION_RESULT_BOUNDARY_OBJECT_FALSE_FIELDS:
...
def _build_statement(
    ...
    basis_preserved = (
        recorded
        and boundary.get("basis_command_execution_outcome")
        == COMMAND_EXECUTION_RECORDED_OUTCOME
        and boundary.get("basis_command_execution_result_version") == RESULT_VERSION
        and boundary.get("basis_command_execution_failed_check_count") == 0
    )
    return {
        "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_recorded": recorded,
        "basis_command_execution_artifact_preserved": basis_preserved,
        ...
        "selected_command_execution_recorded": boundary.get(
            "selected_command_execution_recorded"
        )
        is True,
        "command_execution_performed": boundary.get("command_execution_performed")
        is True,
        "command_execution_local_only": boundary.get("command_execution_local_only")
        is True,
        "command_execution_read_only": boundary.get("command_execution_read_only")
        is True,
        "future_command_execution_result_may_be_considered": boundary.get(
            "future_command_execution_result_may_be_considered"
        )
        is True,
...
def _build_non_meaning(non_claims: Mapping[str, bool]) -> dict[str, Any]:
    return {
        "command_execution_result_boundary_is_not_command_execution_result": True,
        "command_execution_result_boundary_is_not_state_payload_return": True,
        "command_execution_result_boundary_is_not_state_result_object": True,
        "command_execution_result_boundary_performs_no_lookup": True,
        "command_execution_result_boundary_executes_no_lookup_command": True,
        "command_execution_result_boundary_creates_no_operation_permission": True,
        "command_execution_result_boundary_creates_no_runtime_permission": True,
        "command_execution_result_boundary_creates_no_public_api": True,
        "command_execution_result_boundary_creates_no_participant_facing_interface": True,
        "command_execution_result_boundary_creates_no_distributed_network_behavior": True,
        "command_execution_result_boundary_creates_no_general_lookup_permission": True,
        "command_execution_result_boundary_creates_no_arbitrary_lookup_permission": True,
        "command_execution_result_boundary_creates_no_registry_search_query_or_ranking": True,
        "command_execution_result_boundary_authorizes_no_follow_on_work": True,
...
def _what_remains_open() -> list[str]:
    return [
        "local relevance medium read-only local carrier command execution result boundary test",
        "local relevance medium read-only local carrier command execution result boundary live artifact",
        "local relevance medium read-only local carrier command execution result boundary terminal summary, if needed",
...
def _determine_outcome(
    ...
    requested = declared.get(
        "requested_local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_outcome"
    )
...
def _build_block(outcome: str, checks: list[dict[str, Any]], declared: Mapping[str, Any]) -> dict[str, Any] | None:
    ...
    if not isinstance(reason, str) or not reason.strip():
        reason = "local relevance medium read-only local carrier command execution result boundary blocked"
    return {
        "blocked": True,
        "code": code,
        "block_code": code,
...
def _finalize_result(
    ...
    metadata = {
        "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_id": boundary[
            "boundary_id"
        ],
        "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_type": BOUNDARY_TYPE,
        "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_version": RESULT_VERSION,
    ...
    selected_artifact_basis = {
        "selected_command_execution_artifact": _sanitize(basis.get("artifact")),
        "basis_command_execution_outcome": basis.get("outcome"),
        "basis_command_execution_result_version": basis.get("result_version"),
        "basis_command_execution_failed_check_count": basis.get("failed_check_count"),
    ...
    if outcome == OUTCOME_NOT_RECORDED:
        not_recorded_basis.append(
            _sanitize(declared.get("not_recorded_basis") or "boundary not recorded")
        )

    result: dict[str, Any] = {
        "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_metadata": metadata,
        "declared_local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_question": declared_question,
        "selected_command_execution_artifact_basis": selected_artifact_basis,
        "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary": boundary,
        "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_checks": checks,
        "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_statement": statement,
        "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_non_meaning": _build_non_meaning(
            non_claims
        ),
...
def resolve_local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_v0_min(
    declared_local_relevance_medium_read_only_local_carrier_command_execution_result_boundary: Mapping[
        str, Any
    ]
    | None = None,
) -> dict[str, Any]:
    """Resolve one command execution result boundary request."""

    if declared_local_relevance_medium_read_only_local_carrier_command_execution_result_boundary is None:
        declared = build_declared_local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_v0_min_request()
    elif not _is_mapping(
        declared_local_relevance_medium_read_only_local_carrier_command_execution_result_boundary
    ):
        checks: list[dict[str, Any]] = []
        _check(
            checks,
        ...
        declared = {
            "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_id": DEFAULT_BOUNDARY_ID,
            "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_question": None,
            "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_intent": None,
    ...
    basis, _command_execution = _validate_command_execution_artifact(checks, declared)
    _append_boundary_membrane_checks(checks, declared)
    _check(
        checks,
...
def resolve_local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_v0_min_from_path(
    declared_local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_path: Path
    | str,
) -> dict[str, Any]:
    ...
    try:
        path = Path(
            declared_local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_path
        )
        with path.open("r", encoding="utf-8") as handle:
        ...
        return _finalize_result(declared_fallback, checks, basis)
    if not _is_mapping(declared):
        return resolve_local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_v0_min(
            declared
        )
    return resolve_local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_v0_min(
        declared
...
def build_local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_v0_min_summary(
    ...
    def false_summary(field: str) -> bool:
        return boundary.get(field) is False and non_claims.get(field) is False
    ...
    return {
        ...
        "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_recorded": result.get(
            "outcome"
        )
        == OUTCOME_RECORDED,
        "basis_command_execution_artifact_preserved": boundary.get(
        ...
        "boundary_object_summary": {
            ...
            "basis_command_execution_outcome": boundary.get(
                "basis_command_execution_outcome"
            ),
            "basis_command_execution_result_version": boundary.get(
                "basis_command_execution_result_version"
            ),
            "basis_command_execution_failed_check_count": boundary.get(
                "basis_command_execution_failed_check_count"
            ),
        },
        "command_execution_result_not_created": false_summary(
            "command_execution_result_created"
        ),
...
def _path_has_component_prefix(path: Path, root: Path) -> bool:
...
def _assert_output_path_allowed(path: Path) -> None:
    output_root_parts = OUTPUT_ROOT.parts
    if output_root_parts not in [
        path.parts[index : index + len(output_root_parts)]
        for index in range(0, len(path.parts) - len(output_root_parts) + 1)
    ]:
        # Explicit output paths are allowed outside the default root, but never
        # inside exact prior artifact roots.
        pass
    for forbidden in FORBIDDEN_OUTPUT_ROOTS:
        if _path_has_component_prefix(path, Path(forbidden)):
            raise LocalRelevanceMediumReadOnlyLocalCarrierCommandExecutionResultBoundaryV0MinError(
                f"refusing to write command execution result boundary output under prior root: {forbidden}"
            )
...
def write_local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_v0_min_result(
    result: Mapping[str, Any],
    output_path: Path | str | None = None,
) -> Path:
    """Write a resolver result JSON without silently overwriting existing files."""
    ...
    filename = (
        f"{boundary_id}__"
        "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_v0_min_result.json"
    )
...
def build_declared_local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_v0_min_request(
    *,
    local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_id: str = DEFAULT_BOUNDARY_ID,
    ...
    **overrides: Any,
    ...
    request: dict[str, Any] = {
        ...
        "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_question": CORE_QUESTION,
        "local_relevance_medium_read_only_local_carrier_command_execution_result_boundary_intent": intent,
