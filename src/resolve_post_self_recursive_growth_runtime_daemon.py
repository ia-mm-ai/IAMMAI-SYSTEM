"""Bounded post-self-recursive-growth runtime-daemon resolver.

This module records one bounded runtime-daemon posture from clean
runtime-daemon-boundary basis. It does not create a runtime loop, public API,
...
class PostSelfRecursiveGrowthRuntimeDaemonError(Exception):
    """Bounded resolver error for runtime-daemon request handling."""


RESULT_VERSION = "0.1.0"
RESOLVER_MODULE = "resolve_post_self_recursive_growth_runtime_daemon"

OUTCOME_RECORDED = "POST_SELF_RECURSIVE_GROWTH_RUNTIME_DAEMON_RECORDED"
OUTCOME_NOT_RECORDED = "POST_SELF_RECURSIVE_GROWTH_RUNTIME_DAEMON_NOT_RECORDED"
OUTCOME_REQUIRES_ADDITIONAL_BASIS = (
    "POST_SELF_RECURSIVE_GROWTH_RUNTIME_DAEMON_REQUIRES_ADDITIONAL_BASIS"
)
OUTCOME_BLOCKED = "POST_SELF_RECURSIVE_GROWTH_RUNTIME_DAEMON_BLOCKED"
OUTCOME_FAMILY = (
    OUTCOME_RECORDED,
...
OUTPUT_ROOT = Path(
    "artifacts/integrity_host_v0_min_coexistence_post_self_recursive_growth_runtime_daemon"
)

INTENT_RECORD = "RECORD_POST_SELF_RECURSIVE_GROWTH_RUNTIME_DAEMON"
INTENT_DO_NOT_RECORD = "DO_NOT_RECORD_POST_SELF_RECURSIVE_GROWTH_RUNTIME_DAEMON"
INTENT_BLOCK = "BLOCK_POST_SELF_RECURSIVE_GROWTH_RUNTIME_DAEMON"
SUPPORTED_INTENTS = (INTENT_RECORD, INTENT_DO_NOT_RECORD, INTENT_BLOCK)

RUNTIME_DAEMON_QUESTION = (
    "Can the clean post-self-recursive-growth runtime-daemon-boundary basis be "
    "used to record one bounded runtime-daemon posture without creating runtime "
    "loop, public API, participant-facing interface, distributed network "
    ...
    "broader reusable permission, derivative reception, vessel relation, another "
    "reception request, adoption, receiving-context governance, publication flow, "
    "or follow-on work?"
)

SUPPORTED_SCOPE_VALUES = (
    "RUNTIME_DAEMON_SPEC_ONLY",
    "ONE_BOUNDED_RUNTIME_DAEMON_POSTURE_RECORDED",
    "RUNTIME_DAEMON_BOUNDARY_BASIS_PRESERVED",
    "SELF_RECURSIVE_GROWTH_BASIS_PRESERVED",
    "BOUNDED_SELF_RECURSIVE_GROWTH_ENVELOPE_PRESERVED",
    "BOUNDED_RUNTIME_DAEMON_ENVELOPE_DECLARED",
    "RUNTIME_DAEMON_NOT_RUNTIME_LOOP",
    "RUNTIME_DAEMON_NOT_PUBLIC_API",
    "RUNTIME_DAEMON_NOT_PARTICIPANT_FACING_INTERFACE",
    "RUNTIME_DAEMON_NOT_DISTRIBUTED_NETWORK_BEHAVIOR",
    ...
    "HIDDEN_REPO_STATE_NOT_USED_AS_RUNTIME_DAEMON_AUTHORITY",
    "REPO_LOCAL_AVAILABILITY_NOT_RUNTIME_DAEMON_AUTHORITY",
    "ARTIFACT_EXISTENCE_NOT_RUNTIME_DAEMON_AUTHORITY",
    "LATEST_FILE_POSTURE_NOT_RUNTIME_DAEMON_AUTHORITY",
...
SUPPORTED_RUNTIME_DAEMON_SCOPE = SUPPORTED_SCOPE_VALUES
...
REQUIRED_FALSE_NON_CLAIMS = (
    ...
    "runtime_daemon_treated_as_source_transfer",
    "runtime_daemon_treated_as_source_receipt",
    "runtime_daemon_treated_as_reception_authorization",
    "runtime_daemon_treated_as_source",
    "runtime_daemon_treated_as_authority",
    "runtime_daemon_treated_as_currentness",
    "runtime_daemon_treated_as_deployment",
    "runtime_daemon_treated_as_public_release",
    "runtime_daemon_treated_as_operation_permission",
    "runtime_daemon_treated_as_broader_reusable_permission",
    "runtime_daemon_treated_as_follow_on_work",
    "runtime_daemon_boundary_treated_as_runtime_daemon_without_review",
    "self_recursive_growth_treated_as_runtime_daemon_without_review",
    "bounded_self_recursive_growth_envelope_treated_as_runtime_daemon_without_review",
    "artifact_existence_treated_as_runtime_daemon_authority",
    "artifact_path_treated_as_currentness",
    "latest_file_posture_treated_as_runtime_daemon_authority",
    "repo_local_availability_treated_as_runtime_daemon_authority",
    "hidden_repo_state_used_as_runtime_daemon_content",
    "hidden_repo_state_used_as_runtime_daemon_authority",
    "source_created",
    "authority_created",
    "currentness_created",
    "deployment_created",
...
ALLOWED_TRUE_RECORDED_FIELDS = (
    "runtime_daemon_recorded",
    "bounded_runtime_daemon_posture_recorded",
    "runtime_daemon_boundary_basis_preserved",
    "self_recursive_growth_basis_preserved",
    "bounded_self_recursive_growth_envelope_preserved",
    "bounded_runtime_daemon_envelope_declared",
...
BLOCK_CODES = (
    "RUNTIME_DAEMON_QUESTION_UNDECLARED",
    "RUNTIME_DAEMON_INTENT_UNSUPPORTED",
    ...
    "RUNTIME_DAEMON_BOUNDARY_DID_NOT_DECLARE_FUTURE_RUNTIME_DAEMON_REVIEW",
    "RUNTIME_DAEMON_BOUNDARY_ALREADY_CREATED_RUNTIME_DAEMON",
    "RUNTIME_DAEMON_BOUNDARY_ALREADY_CREATED_RUNTIME_LOOP",
    "RUNTIME_DAEMON_BOUNDARY_ALREADY_CREATED_PUBLIC_API",
    "RUNTIME_DAEMON_BOUNDARY_ALREADY_CREATED_PARTICIPANT_FACING_INTERFACE",
    "RUNTIME_DAEMON_BOUNDARY_ALREADY_CREATED_DISTRIBUTED_NETWORK_BEHAVIOR",
    ...
    "RUNTIME_DAEMON_BOUNDARY_AUTHORIZED_FUTURE_WORK",
    ...
    "BOUNDED_SELF_RECURSIVE_GROWTH_ENVELOPE_TREATED_AS_RUNTIME_DAEMON_BEFORE_REVIEW",
    "BOUNDED_SELF_RECURSIVE_GROWTH_ENVELOPE_AUTHORIZED_ARBITRARY_RUNTIME_ACTIVITY_BEFORE_REVIEW",
    "RUNTIME_HOSTING_BOUNDARY_V1_FAILURE_REPAIRED_OR_HIDDEN_OR_CLAIMED_PASSED",
    "RUNTIME_DAEMON_RECORDED_BEFORE_REVIEW",
    "RUNTIME_DAEMON_TREATED_AS_RUNTIME_LOOP",
    "RUNTIME_DAEMON_TREATED_AS_PUBLIC_API",
    "RUNTIME_DAEMON_TREATED_AS_PARTICIPANT_FACING_INTERFACE",
    "RUNTIME_DAEMON_TREATED_AS_DISTRIBUTED_NETWORK_BEHAVIOR",
    ...
    "UNSUPPORTED_RUNTIME_DAEMON_SCOPE",
    "DECLARED_RUNTIME_DAEMON_REQUEST_MALFORMED",
    "DECLARED_RUNTIME_DAEMON_REQUEST_UNREADABLE",
)
...
HOSTILE_SENTINELS = (
    ...
    "RAW_BOUNDED_RUNTIME_DAEMON_ENVELOPE_BODY_MUST_NOT_RETURN",
...
SENSITIVE_CONTENT_KEYS = {
    ...
    "raw_bounded_runtime_daemon_envelope_body",
    ...
    "raw_runtime_body",
    "runtime_daemon_body",
    "bounded_runtime_daemon_envelope_body",
    "runtime_body",
    "source_body",
    "authority_body",
    "hidden_repo_state",
...
def _selected_scope(request: Mapping[str, Any]) -> list[str]:
    raw_scope = request.get("runtime_daemon_scope", SUPPORTED_SCOPE_VALUES)
...
def _requested_envelope(request: Mapping[str, Any]) -> dict[str, Any]:
    requested = request.get("requested_bounded_runtime_daemon_envelope")
    if isinstance(requested, Mapping):
        return _sanitize_value(requested)
    return {
        "bounded_runtime_daemon_envelope_id": "bounded_runtime_daemon_envelope_v0",
        "posture": "one bounded runtime-daemon posture recorded from selected clean runtime-daemon-boundary and self-recursive-growth basis",
        "limits": [
            "one bounded standing-runtime-daemon posture only",
            "no runtime loop",
            "no public API",
            ...
            "no source, authority, currentness, deployment, public release, operation permission, broader reusable permission, or follow-on work",
        ],
        "does_not_authorize_arbitrary_runtime_activity": True,
...
def _add_basis_recorded_checks(
    ...
    missing_code: str = "SELECTED_BASIS_NOT_REFERENCE_SHAPED",
    outcome_code: str = "SELECTED_BASIS_NOT_REFERENCE_SHAPED",
    version_code: str = "SELECTED_BASIS_NOT_REFERENCE_SHAPED",
    failed_code: str = "SELECTED_BASIS_NOT_REFERENCE_SHAPED",
) -> None:
    declared = _basis_declared(request, section)
    _add_check(checks, f"{label}_basis_declared", declared, True, declared, missing_code)
    outcome = _basis_value(
        request,
        section,
        f"{label}_result_outcome",
        ("outcome", "result_outcome", f"{label}_outcome"),
    )
    _add_check(
        checks,
    ...
    version = _basis_value(
        request,
        section,
        f"{label}_result_version",
        ("result_version", "version", f"{label}_version"),
    )
    _add_check(
        checks,
    ...
    failed_count = _basis_value(
        request,
        section,
        f"{label}_failed_check_count",
        ("failed_check_count", "failed_checks", f"{label}_failed_check_count"),
    )
    _add_check(checks, f"{label}_failed_checks_zero", _is_zero(failed_count), 0, failed_count, failed_code)
...
def _add_runtime_daemon_checks(request: Mapping[str, Any]) -> list[dict[str, Any]]:
    checks: list[dict[str, Any]] = []

    question = request.get("runtime_daemon_question")
    _add_check(
        checks,
        "runtime_daemon_question_declared",
        question == RUNTIME_DAEMON_QUESTION,
        RUNTIME_DAEMON_QUESTION,
        question,
        "RUNTIME_DAEMON_QUESTION_UNDECLARED",
    )

    intent = request.get("runtime_daemon_intent")
    _add_check(
        checks,
        "runtime_daemon_intent_supported",
    ...
    _add_check(
        checks,
        "runtime_daemon_scope_supported",
    ...
    _add_check(
        checks,
        "runtime_daemon_boundary_basis_declared",
        _basis_declared(request, "selected_runtime_daemon_boundary_basis"),
        True,
        _basis_declared(request, "selected_runtime_daemon_boundary_basis"),
        "RUNTIME_DAEMON_BOUNDARY_BASIS_MISSING",
    )
    boundary_outcome = _basis_value(
        request,
        "selected_runtime_daemon_boundary_basis",
        "selected_runtime_daemon_boundary_result_outcome",
        ("outcome", "result_outcome"),
    )
    _add_check(
        checks,
        "runtime_daemon_boundary_outcome_recorded",
        boundary_outcome == "POST_SELF_RECURSIVE_GROWTH_RUNTIME_DAEMON_BOUNDARY_RECORDED",
        "POST_SELF_RECURSIVE_GROWTH_RUNTIME_DAEMON_BOUNDARY_RECORDED",
        boundary_outcome,
        "RUNTIME_DAEMON_BOUNDARY_NOT_RECORDED",
    )
    boundary_version = _basis_value(
        request,
        "selected_runtime_daemon_boundary_basis",
        "selected_runtime_daemon_boundary_result_version",
        ("result_version", "version"),
    )
    _add_check(
        checks,
        "runtime_daemon_boundary_version_0_1_0",
        boundary_version == "0.1.0",
        "0.1.0",
        boundary_version,
        "RUNTIME_DAEMON_BOUNDARY_VERSION_NOT_0_1_0",
    )
    boundary_failed = _basis_value(
        request,
        "selected_runtime_daemon_boundary_basis",
        "selected_runtime_daemon_boundary_failed_check_count",
        ("failed_check_count", "failed_checks"),
    )
    _add_check(
        checks,
        "runtime_daemon_boundary_failed_checks_zero",
        _is_zero(boundary_failed),
        0,
        boundary_failed,
        "RUNTIME_DAEMON_BOUNDARY_FAILED_CHECKS_PRESENT",
    )
    declared_future_review = _basis_value(
        request,
        "selected_runtime_daemon_boundary_basis",
        "selected_runtime_daemon_boundary_declared_future_review",
        ("one_future_runtime_daemon_review_declared", "declared_future_runtime_daemon_review"),
    )
    _add_check(
        checks,
        "runtime_daemon_boundary_declared_future_runtime_daemon_review",
        _as_bool(declared_future_review) is True,
        True,
        declared_future_review,
        "RUNTIME_DAEMON_BOUNDARY_DID_NOT_DECLARE_FUTURE_RUNTIME_DAEMON_REVIEW",
    )

    for field, code in (
        ("selected_runtime_daemon_boundary_already_created_runtime_daemon", "RUNTIME_DAEMON_BOUNDARY_ALREADY_CREATED_RUNTIME_DAEMON"),
        ("selected_runtime_daemon_boundary_already_created_runtime_loop", "RUNTIME_DAEMON_BOUNDARY_ALREADY_CREATED_RUNTIME_LOOP"),
        ("selected_runtime_daemon_boundary_already_created_public_api", "RUNTIME_DAEMON_BOUNDARY_ALREADY_CREATED_PUBLIC_API"),
        ("selected_runtime_daemon_boundary_already_created_participant_facing_interface", "RUNTIME_DAEMON_BOUNDARY_ALREADY_CREATED_PARTICIPANT_FACING_INTERFACE"),
        ("selected_runtime_daemon_boundary_already_created_distributed_network_behavior", "RUNTIME_DAEMON_BOUNDARY_ALREADY_CREATED_DISTRIBUTED_NETWORK_BEHAVIOR"),
        ("selected_runtime_daemon_boundary_treated_as_runtime_daemon", "RUNTIME_DAEMON_BOUNDARY_TREATED_AS_RUNTIME_DAEMON"),
        ("selected_runtime_daemon_boundary_treated_as_runtime_loop", "RUNTIME_DAEMON_BOUNDARY_TREATED_AS_RUNTIME_LOOP"),
        ("selected_runtime_daemon_boundary_treated_as_public_api", "RUNTIME_DAEMON_BOUNDARY_TREATED_AS_PUBLIC_API"),
        ("selected_runtime_daemon_boundary_authorized_future_work", "RUNTIME_DAEMON_BOUNDARY_AUTHORIZED_FUTURE_WORK"),
    ):
        _add_absence_check(checks, request, field, code)

    boundary_non_claims = _basis_value(
        request,
        "selected_runtime_daemon_boundary_basis",
        "selected_runtime_daemon_boundary_non_claims_canonicalized",
        ("result_level_non_claims_canonical_false", "non_claims_canonicalized"),
    )
    _add_check(
        checks,
        "runtime_daemon_boundary_non_claims_canonicalized",
        _as_bool(boundary_non_claims) is True,
        True,
        boundary_non_claims,
        "NON_CLAIM_MISSING_OR_FLIPPED",
    )

    terminal_basis = request.get("selected_runtime_daemon_boundary_terminal_summary_basis")
    terminal_declared = terminal_basis is not None and terminal_basis != {}
    _add_check(
        checks,
        "runtime_daemon_boundary_terminal_summary_basis_declared",
        terminal_declared,
        True,
        terminal_declared,
        "RUNTIME_DAEMON_BOUNDARY_BASIS_MISSING",
    ...
    if isinstance(terminal_basis, Mapping):
        terminal_runtime_daemon_not_created = terminal_basis.get("runtime_daemon_not_created")
        terminal_no_daemon_selected = terminal_basis.get("no_runtime_daemon_selected")
        terminal_separate_review = terminal_basis.get("separate_future_review_required")
    else:
        terminal_runtime_daemon_not_created = None
        terminal_no_daemon_selected = None
        terminal_separate_review = None
    _add_check(
        checks,
        "runtime_daemon_boundary_terminal_summary_states_runtime_daemon_not_created",
        _as_bool(terminal_runtime_daemon_not_created) is True,
        True,
        terminal_runtime_daemon_not_created,
        "RUNTIME_DAEMON_BOUNDARY_ALREADY_CREATED_RUNTIME_DAEMON",
    )
    _add_check(
        checks,
        "runtime_daemon_boundary_terminal_summary_states_no_runtime_daemon_selected",
        _as_bool(terminal_no_daemon_selected) is True,
        True,
        terminal_no_daemon_selected,
        "RUNTIME_DAEMON_BOUNDARY_ALREADY_CREATED_RUNTIME_DAEMON",
    )
    _add_check(
        checks,
        "runtime_daemon_boundary_terminal_summary_requires_separate_future_review",
    ...
    self_growth_terminal_declared = _basis_declared(
        request, "selected_self_recursive_growth_terminal_summary_basis"
    )
    _add_check(
        checks,
        "self_recursive_growth_terminal_summary_basis_declared",
        self_growth_terminal_declared,
        True,
        self_growth_terminal_declared,
        "SELF_RECURSIVE_GROWTH_BASIS_MISSING",
    )
    ...
    _add_check(
        checks,
        "self_recursive_growth_basis_declared",
        _basis_declared(request, "selected_self_recursive_growth_basis"),
        True,
        _basis_declared(request, "selected_self_recursive_growth_basis"),
        "SELF_RECURSIVE_GROWTH_BASIS_MISSING",
    )
    self_growth_outcome = _basis_value(
        request,
    ...
    _add_check(
        checks,
        "self_recursive_growth_outcome_recorded",
        self_growth_outcome == "POST_SELF_CONTINUATION_SELF_RECURSIVE_GROWTH_RECORDED",
        "POST_SELF_CONTINUATION_SELF_RECURSIVE_GROWTH_RECORDED",
        self_growth_outcome,
        "SELF_RECURSIVE_GROWTH_NOT_RECORDED",
    )
    self_growth_version = _basis_value(
        request,
        "selected_self_recursive_growth_basis",
    ...
    _add_check(
        checks,
        "self_recursive_growth_version_0_1_0",
        self_growth_version == "0.1.0",
        "0.1.0",
        self_growth_version,
        "SELF_RECURSIVE_GROWTH_NOT_RECORDED",
    )
    self_growth_failed = _basis_value(
        request,
        "selected_self_recursive_growth_basis",
    ...
    _add_check(
        checks,
        "self_recursive_growth_failed_checks_zero",
        _is_zero(self_growth_failed),
        0,
        self_growth_failed,
        "SELF_RECURSIVE_GROWTH_NOT_RECORDED",
    )
    for shortcut, names, check_name in (
        (
            "selected_self_recursive_growth_bounded_posture_recorded",
            ("bounded_self_recursive_growth_posture_recorded", "self_recursive_growth_recorded"),
            "self_recursive_growth_recorded_bounded_posture",
        ),
        (
            "selected_self_recursive_growth_bounded_self_recursive_growth_envelope_recorded",
            ("bounded_self_recursive_growth_envelope_recorded",),
            "self_recursive_growth_recorded_bounded_envelope",
        ),
    ):
        actual = _basis_value(request, "selected_self_recursive_growth_basis", shortcut, names)
        _add_check(checks, check_name, _as_bool(actual) is True, True, actual, "SELF_RECURSIVE_GROWTH_NOT_RECORDED")
    for field, code in (
        ...
        ("selected_self_recursive_growth_already_created_participant_facing_interface", "SELF_RECURSIVE_GROWTH_ALREADY_CREATED_PARTICIPANT_FACING_INTERFACE"),
        ("selected_self_recursive_growth_already_created_distributed_network_behavior", "SELF_RECURSIVE_GROWTH_ALREADY_CREATED_DISTRIBUTED_NETWORK_BEHAVIOR"),
        ("selected_bounded_self_recursive_growth_envelope_treated_as_runtime_daemon_before_review", "BOUNDED_SELF_RECURSIVE_GROWTH_ENVELOPE_TREATED_AS_RUNTIME_DAEMON_BEFORE_REVIEW"),
        ("selected_bounded_self_recursive_growth_envelope_authorized_arbitrary_runtime_activity_before_review", "BOUNDED_SELF_RECURSIVE_GROWTH_ENVELOPE_AUTHORIZED_ARBITRARY_RUNTIME_ACTIVITY_BEFORE_REVIEW"),
    ):
        _add_absence_check(checks, request, field, code)

    for section, label, expected_outcome, expected_version in (
        (
        ...
        (
            ...
            "POST_SUCCESSOR_RUNTIME_STEP_RUNTIME_HOSTING_BOUNDARY_V2_RECORDED",
            "0.2.0",
        ),
        (
    ...
    for field in (
        "runtime_daemon_spec_only_posture",
        "one_bounded_runtime_daemon_posture",
        "runtime_daemon_boundary_basis_preserved_posture",
        "self_recursive_growth_basis_preserved_posture",
        "bounded_self_recursive_growth_envelope_preserved_posture",
        "bounded_runtime_daemon_envelope_declared_posture",
        "runtime_daemon_not_runtime_loop_posture",
        "runtime_daemon_not_public_api_posture",
        "runtime_daemon_not_participant_facing_interface_posture",
        "runtime_daemon_not_distributed_network_behavior_posture",
        ...
        "repo_local_availability_not_runtime_daemon_authority_posture",
        "artifact_existence_not_runtime_daemon_authority_posture",
        "latest_file_posture_not_runtime_daemon_authority_posture",
        ...
        _add_posture_check(checks, request, field, "SELECTED_BASIS_NOT_REFERENCE_SHAPED")

    absence_fields = (
        ("runtime_daemon_recorded_before_review", "RUNTIME_DAEMON_RECORDED_BEFORE_REVIEW"),
        ...
        ("runtime_daemon_treated_as_source_transfer", "RUNTIME_DAEMON_TREATED_AS_SOURCE_TRANSFER"),
        ("runtime_daemon_treated_as_source_receipt", "RUNTIME_DAEMON_TREATED_AS_SOURCE_RECEIPT"),
        ("runtime_daemon_treated_as_reception_authorization", "RUNTIME_DAEMON_TREATED_AS_RECEPTION_AUTHORIZATION"),
        ("runtime_daemon_treated_as_source", "RUNTIME_DAEMON_TREATED_AS_SOURCE"),
        ("runtime_daemon_treated_as_authority", "RUNTIME_DAEMON_TREATED_AS_AUTHORITY"),
        ("runtime_daemon_treated_as_currentness", "RUNTIME_DAEMON_TREATED_AS_CURRENTNESS"),
        ("runtime_daemon_treated_as_deployment", "RUNTIME_DAEMON_TREATED_AS_DEPLOYMENT"),
        ("runtime_daemon_treated_as_public_release", "RUNTIME_DAEMON_TREATED_AS_PUBLIC_RELEASE"),
        ("runtime_daemon_treated_as_operation_permission", "RUNTIME_DAEMON_TREATED_AS_OPERATION_PERMISSION"),
        ("runtime_daemon_treated_as_broader_reusable_permission", "RUNTIME_DAEMON_TREATED_AS_BROADER_REUSABLE_PERMISSION"),
        ("runtime_daemon_treated_as_follow_on_work", "RUNTIME_DAEMON_TREATED_AS_FOLLOW_ON_WORK"),
        ...
        ("runtime_daemon_boundary_treated_as_runtime_daemon_without_review", "RUNTIME_DAEMON_BOUNDARY_TREATED_AS_RUNTIME_DAEMON"),
        ("self_recursive_growth_treated_as_runtime_daemon_without_review", "SELF_RECURSIVE_GROWTH_NOT_RECORDED"),
        ("bounded_self_recursive_growth_envelope_treated_as_runtime_daemon_without_review", "BOUNDED_SELF_RECURSIVE_GROWTH_ENVELOPE_TREATED_AS_RUNTIME_DAEMON_BEFORE_REVIEW"),
        ...
        ("artifact_existence_treated_as_runtime_daemon_authority", "ARTIFACT_EXISTENCE_TREATED_AS_RUNTIME_DAEMON_AUTHORITY"),
        ("artifact_path_treated_as_currentness", "ARTIFACT_PATH_TREATED_AS_CURRENTNESS"),
        ("latest_file_posture_treated_as_runtime_daemon_authority", "LATEST_FILE_POSTURE_TREATED_AS_RUNTIME_DAEMON_AUTHORITY"),
        ("repo_local_availability_treated_as_runtime_daemon_authority", "REPO_LOCAL_AVAILABILITY_TREATED_AS_RUNTIME_DAEMON_AUTHORITY"),
        ("hidden_repo_state_used_as_runtime_daemon_content", "HIDDEN_REPO_STATE_USED_AS_RUNTIME_DAEMON_CONTENT"),
        ("hidden_repo_state_used_as_runtime_daemon_authority", "HIDDEN_REPO_STATE_USED_AS_RUNTIME_DAEMON_AUTHORITY"),
    ...
    _add_check(
        checks,
        "hostile_raw_body_content_contained",
        not any(sentinel in serialized_sanitized for sentinel in HOSTILE_SENTINELS),
        "no hostile raw/hidden sentinels",
        "contained" if not any(sentinel in serialized_sanitized for sentinel in HOSTILE_SENTINELS) else "uncontained",
        "RAW_FULL_PRIOR_ARTIFACT_BODY_RETURNED",
    )
    _add_check(
        checks,
...
def _statement_for_outcome(outcome: str, checks: list[dict[str, Any]]) -> dict[str, bool]:
    ...
    return {
        "runtime_daemon_recorded": recorded,
        "bounded_runtime_daemon_posture_recorded": recorded,
        "runtime_daemon_boundary_basis_preserved": recorded,
        "self_recursive_growth_basis_preserved": recorded,
        "bounded_self_recursive_growth_envelope_preserved": recorded,
        "bounded_runtime_daemon_envelope_declared": recorded,
        "runtime_daemon_not_runtime_loop": True,
        "runtime_daemon_not_public_api": True,
        "runtime_daemon_not_participant_facing_interface": True,
        "runtime_daemon_not_distributed_network_behavior": True,
        ...
        "hidden_repo_state_not_used_as_runtime_daemon_authority": True,
        "repo_local_availability_not_runtime_daemon_authority": True,
        "artifact_existence_not_runtime_daemon_authority": True,
        "latest_file_posture_not_runtime_daemon_authority": True,
...
def _runtime_daemon_non_meaning() -> dict[str, bool]:
    return {
        "runtime_daemon_is_runtime_loop": False,
        "runtime_daemon_is_public_api": False,
        "runtime_daemon_is_participant_facing_interface": False,
        "runtime_daemon_is_distributed_network_behavior": False,
        "runtime_daemon_is_source_transfer": False,
        "runtime_daemon_is_source_receipt": False,
        "runtime_daemon_is_reception_authorization": False,
        "runtime_daemon_is_source": False,
        "runtime_daemon_is_authority": False,
        "runtime_daemon_is_currentness": False,
        "runtime_daemon_is_deployment": False,
        "runtime_daemon_is_public_release": False,
        "runtime_daemon_is_operation_permission": False,
        "runtime_daemon_is_broader_reusable_permission": False,
        "runtime_daemon_is_follow_on_work": False,
        "runtime_daemon_authorizes_arbitrary_runtime_activity": False,
        "runtime_daemon_authorizes_its_own_successor": False,
    }
...
def _block_from_failure(failure: dict[str, Any] | None, reason: Any = None) -> dict[str, Any] | None:
    if failure is None:
        return None
    code = failure.get("block_code") or failure.get("failure_code") or "DECLARED_RUNTIME_DAEMON_REQUEST_MALFORMED"
    if code not in BLOCK_CODES:
        code = "DECLARED_RUNTIME_DAEMON_REQUEST_MALFORMED"
    return {
        "block_code": code,
...
def _determine_outcome(request: Mapping[str, Any], checks: list[dict[str, Any]]) -> str:
    ...
    requested = request.get("requested_runtime_daemon_outcome")
    ...
    if requested == OUTCOME_NOT_RECORDED or request.get("not_recorded_basis") or request.get("runtime_daemon_intent") == INTENT_DO_NOT_RECORD:
...
def _build_result(request: Mapping[str, Any], checks: list[dict[str, Any]], outcome: str) -> dict[str, Any]:
    request_id = str(request.get("runtime_daemon_request_id") or "post_self_recursive_growth_runtime_daemon_request")
    ...
    result: dict[str, Any] = {
        "post_self_recursive_growth_runtime_daemon_metadata": {
            "post_self_recursive_growth_runtime_daemon_id": request_id,
            "post_self_recursive_growth_runtime_daemon_type": "post_self_recursive_growth_runtime_daemon",
            "post_self_recursive_growth_runtime_daemon_version": RESULT_VERSION,
            "generated_at": _utc_now(),
            "resolver_module": RESOLVER_MODULE,
        },
        "declared_runtime_daemon_question": {
            "runtime_daemon_request_id": request_id,
            "runtime_daemon_question": _sanitize_value(request.get("runtime_daemon_question")),
            "runtime_daemon_intent": _sanitize_value(request.get("runtime_daemon_intent")),
        },
        "selected_runtime_daemon_boundary_basis": _section_or_empty(request, "selected_runtime_daemon_boundary_basis"),
        "selected_runtime_daemon_boundary_terminal_summary_basis": _section_or_empty(
            request, "selected_runtime_daemon_boundary_terminal_summary_basis"
        ),
        ...
        "selected_self_recursive_growth_terminal_summary_basis": _section_or_empty(
            request, "selected_self_recursive_growth_terminal_summary_basis"
        ),
        ...
        "runtime_daemon_spec_only_posture": _posture(True, "RUNTIME_DAEMON_SPEC_ONLY", "spec posture only"),
        "one_bounded_runtime_daemon_posture": _posture(
            outcome == OUTCOME_RECORDED,
            "ONE_BOUNDED_RUNTIME_DAEMON_POSTURE_RECORDED",
            "one bounded runtime-daemon posture only",
        ),
        "runtime_daemon_boundary_basis_preserved_posture": _posture(
            statement["runtime_daemon_boundary_basis_preserved"],
            "RUNTIME_DAEMON_BOUNDARY_BASIS_PRESERVED",
            "runtime-daemon-boundary remains basis",
        ),
        "self_recursive_growth_basis_preserved_posture": _posture(
            statement["self_recursive_growth_basis_preserved"],
            "SELF_RECURSIVE_GROWTH_BASIS_PRESERVED",
            "self-recursive growth remains bounded basis",
        ),
        "bounded_self_recursive_growth_envelope_preserved_posture": _posture(
            statement["bounded_self_recursive_growth_envelope_preserved"],
            "BOUNDED_SELF_RECURSIVE_GROWTH_ENVELOPE_PRESERVED",
            "bounded self-recursive-growth envelope is preserved",
        ),
        "bounded_runtime_daemon_envelope_declared_posture": _posture(
            statement["bounded_runtime_daemon_envelope_declared"],
            "BOUNDED_RUNTIME_DAEMON_ENVELOPE_DECLARED",
            "one narrow bounded runtime-daemon envelope",
        ),
        "runtime_daemon_not_runtime_loop_posture": _posture(True, "RUNTIME_DAEMON_NOT_RUNTIME_LOOP", "runtime daemon is not runtime loop"),
        "runtime_daemon_not_public_api_posture": _posture(True, "RUNTIME_DAEMON_NOT_PUBLIC_API", "runtime daemon is not public API"),
        "runtime_daemon_not_participant_facing_interface_posture": _posture(
            True,
            "RUNTIME_DAEMON_NOT_PARTICIPANT_FACING_INTERFACE",
            "runtime daemon is not participant-facing interface",
        ),
        "runtime_daemon_not_distributed_network_behavior_posture": _posture(
            True,
            "RUNTIME_DAEMON_NOT_DISTRIBUTED_NETWORK_BEHAVIOR",
            "runtime daemon is not distributed network behavior",
        ),
        ...
        "repo_local_availability_not_runtime_daemon_authority_posture": _posture(
            True,
            "REPO_LOCAL_AVAILABILITY_NOT_RUNTIME_DAEMON_AUTHORITY",
            "repo-local availability is not runtime-daemon authority",
        ),
        "artifact_existence_not_runtime_daemon_authority_posture": _posture(
            True,
            "ARTIFACT_EXISTENCE_NOT_RUNTIME_DAEMON_AUTHORITY",
            "artifact existence is not runtime-daemon authority",
        ),
        "latest_file_posture_not_runtime_daemon_authority_posture": _posture(
            True,
            "LATEST_FILE_POSTURE_NOT_RUNTIME_DAEMON_AUTHORITY",
            "latest file posture is not runtime-daemon authority",
        ),
        ...
        "runtime_daemon_scope": scope,
        "runtime_daemon_checks": checks,
        "runtime_daemon_statement": statement,
        "runtime_daemon_non_meaning": _runtime_daemon_non_meaning(),
        "bounded_runtime_daemon_envelope": _requested_envelope(request),
    ...
    result["post_self_recursive_growth_runtime_daemon_summary"] = (
        build_post_self_recursive_growth_runtime_daemon_summary(result)
    )
    return result


def _blocked_request_result(code: str, reason: str, request: Mapping[str, Any] | None = None) -> dict[str, Any]:
    public_code = code if code in BLOCK_CODES else "DECLARED_RUNTIME_DAEMON_REQUEST_MALFORMED"
    safe_request: Mapping[str, Any] = request or {}
    checks: list[dict[str, Any]] = []
    _add_check(checks, "declared_runtime_daemon_request_readable", False, True, reason, public_code)
    return _build_result(safe_request, checks, OUTCOME_BLOCKED)


def resolve_post_self_recursive_growth_runtime_daemon(
    declared_runtime_daemon_request: Mapping[str, Any] | None = None,
) -> dict[str, Any]:
    """Resolve one bounded post-self-recursive-growth runtime-daemon request."""

    if declared_runtime_daemon_request is None:
        return _blocked_request_result(
            "DECLARED_RUNTIME_DAEMON_REQUEST_MALFORMED",
            "declared runtime-daemon request is missing",
        )
    if not isinstance(declared_runtime_daemon_request, Mapping):
        return _blocked_request_result(
            "DECLARED_RUNTIME_DAEMON_REQUEST_MALFORMED",
            "declared runtime-daemon request is not a mapping",
        )

    request = _deepcopy_mapping(declared_runtime_daemon_request)
    checks = _add_runtime_daemon_checks(request)
    outcome = _determine_outcome(request, checks)
    return _build_result(request, checks, outcome)


def resolve_post_self_recursive_growth_runtime_daemon_from_path(
    declared_runtime_daemon_request_path: Path | str,
) -> dict[str, Any]:
    """Read a declared runtime-daemon request JSON file and resolve it."""

    path = Path(declared_runtime_daemon_request_path)
    try:
        loaded = json.loads(path.read_text(encoding="utf-8"))
    except FileNotFoundError:
        return _blocked_request_result(
            "DECLARED_RUNTIME_DAEMON_REQUEST_UNREADABLE",
            f"declared runtime-daemon request path not found: {path}",
        )
    except OSError as exc:
        return _blocked_request_result(
            "DECLARED_RUNTIME_DAEMON_REQUEST_UNREADABLE",
            f"declared runtime-daemon request path unreadable: {exc}",
        )
    except json.JSONDecodeError as exc:
        return _blocked_request_result(
            "DECLARED_RUNTIME_DAEMON_REQUEST_MALFORMED",
            f"declared runtime-daemon request JSON malformed: {exc}",
        )
    if not isinstance(loaded, Mapping):
        return _blocked_request_result(
            "DECLARED_RUNTIME_DAEMON_REQUEST_MALFORMED",
            "declared runtime-daemon request JSON must be an object",
        )
    return resolve_post_self_recursive_growth_runtime_daemon(loaded)
...
def build_post_self_recursive_growth_runtime_daemon_summary(result: Mapping[str, Any]) -> dict[str, Any]:
    """Build a compact summary from a runtime-daemon result artifact."""

    metadata = result.get("post_self_recursive_growth_runtime_daemon_metadata", {})
    question = result.get("declared_runtime_daemon_question", {})
    checks = result.get("runtime_daemon_checks", [])
    ...
    statement = result.get("runtime_daemon_statement", {})
    ...
    summary: dict[str, Any] = {
        ...
        "request_id": metadata.get("post_self_recursive_growth_runtime_daemon_id")
        or question.get("runtime_daemon_request_id"),
        "question": question.get("runtime_daemon_question"),
        "intent": question.get("runtime_daemon_intent"),
        "passed_check_count": passed_count,
        "failed_check_count": failed_count,
        "result_version": metadata.get("post_self_recursive_growth_runtime_daemon_version", RESULT_VERSION),
        "resolver_module": metadata.get("resolver_module", RESOLVER_MODULE),
        "bounded_runtime_daemon_envelope_posture": result.get("bounded_runtime_daemon_envelope"),
...
def _safe_filename_part(value: Any) -> str:
    raw = str(value or "post_self_recursive_growth_runtime_daemon_request")
    safe = []
    for char in raw:
        if char.isalnum() or char in ("-", "_", "."):
            ...
            safe.append("_")
    return "".join(safe).strip("._") or "post_self_recursive_growth_runtime_daemon_request"
...
def write_post_self_recursive_growth_runtime_daemon_result(
    result: Mapping[str, Any],
    output_path: Path | str | None = None,
) -> Path:
    """Write a runtime-daemon result JSON file without overwriting existing files."""
    ...
    if isinstance(metadata, Mapping):
        ...
        request_id = None
    filename = f"{_safe_filename_part(request_id)}__post_self_recursive_growth_runtime_daemon_result.json"
...
def build_declared_post_self_recursive_growth_runtime_daemon_request(
    runtime_daemon_request_id: str = "post_self_recursive_growth_runtime_daemon_reference_review_001",
    runtime_daemon_question: str = RUNTIME_DAEMON_QUESTION,
    runtime_daemon_intent: str = INTENT_RECORD,
    runtime_daemon_scope: list[str] | tuple[str, ...] | None = None,
    requested_bounded_runtime_daemon_envelope: Mapping[str, Any] | None = None,
    **overrides: Any,
) -> dict[str, Any]:
    """Build a valid declared request for one bounded runtime-daemon posture."""

    envelope = dict(requested_bounded_runtime_daemon_envelope or _requested_envelope({}))
    request: dict[str, Any] = {
        "runtime_daemon_request_id": runtime_daemon_request_id,
        "runtime_daemon_question": runtime_daemon_question,
        "runtime_daemon_intent": runtime_daemon_intent,
        "selected_runtime_daemon_boundary_basis": _basis_reference(
            ...
            one_future_runtime_daemon_review_declared=True,
        ...
        "selected_runtime_daemon_boundary_terminal_summary_basis": {
            "path": "spec/POST_SELF_RECURSIVE_GROWTH_RUNTIME_DAEMON_BOUNDARY_TERMINAL_SUMMARY_V0.md",
            "runtime_daemon_not_created": True,
            "no_runtime_daemon_selected": True,
        ...
        "selected_self_recursive_growth_basis": _basis_reference(
            ...
            "POST_SELF_CONTINUATION_SELF_RECURSIVE_GROWTH_RECORDED",
            bounded_self_recursive_growth_posture_recorded=True,
            bounded_self_recursive_growth_envelope_recorded=True,
            runtime_loop_not_created=True,
            public_api_not_created=True,
            participant_facing_interface_not_created=True,
            distributed_network_behavior_not_created=True,
        ...
        "runtime_daemon_spec_only_posture": {"declared": True},
        "one_bounded_runtime_daemon_posture": {"declared": True},
        "runtime_daemon_boundary_basis_preserved_posture": {"declared": True},
        "self_recursive_growth_basis_preserved_posture": {"declared": True},
        "bounded_self_recursive_growth_envelope_preserved_posture": {"declared": True},
        "bounded_runtime_daemon_envelope_declared_posture": {"declared": True},
        "runtime_daemon_not_runtime_loop_posture": {"declared": True},
        "runtime_daemon_not_public_api_posture": {"declared": True},
        "runtime_daemon_not_participant_facing_interface_posture": {"declared": True},
        "runtime_daemon_not_distributed_network_behavior_posture": {"declared": True},
        ...
        "repo_local_availability_not_runtime_daemon_authority_posture": {"declared": True},
        "artifact_existence_not_runtime_daemon_authority_posture": {"declared": True},
        "latest_file_posture_not_runtime_daemon_authority_posture": {"declared": True},
        ...
        "runtime_daemon_scope": list(runtime_daemon_scope or SUPPORTED_SCOPE_VALUES),
        "declared_non_claims": _canonical_non_claims(),
        "requested_bounded_runtime_daemon_envelope": envelope,
        "selected_runtime_daemon_boundary_declared_future_review": True,
        "selected_runtime_daemon_boundary_non_claims_canonicalized": True,
    ...
    for key in (
        "selected_runtime_daemon_boundary_already_created_runtime_daemon",
        "selected_runtime_daemon_boundary_already_created_runtime_loop",
        "selected_runtime_daemon_boundary_already_created_public_api",
        "selected_runtime_daemon_boundary_already_created_participant_facing_interface",
        "selected_runtime_daemon_boundary_already_created_distributed_network_behavior",
        "selected_runtime_daemon_boundary_treated_as_runtime_daemon",
        "selected_runtime_daemon_boundary_treated_as_runtime_loop",
        "selected_runtime_daemon_boundary_treated_as_public_api",
        "selected_runtime_daemon_boundary_authorized_future_work",
        "selected_runtime_daemon_boundary_v1_failure_hidden",
        "selected_runtime_daemon_boundary_v1_failure_repaired",
        "selected_runtime_daemon_boundary_v1_failure_claimed_passed",
        "selected_self_recursive_growth_already_created_runtime_loop",
        "selected_self_recursive_growth_already_created_public_api",
        ...
        "selected_bounded_self_recursive_growth_envelope_treated_as_runtime_daemon_before_review",
        "selected_bounded_self_recursive_growth_envelope_authorized_arbitrary_runtime_activity_before_review",
        "selected_runtime_hosting_boundary_v1_failure_repaired",
        "selected_runtime_hosting_boundary_v1_failure_hidden",
        "selected_runtime_hosting_boundary_v1_failure_claimed_passed",
        "runtime_daemon_recorded_before_review",
