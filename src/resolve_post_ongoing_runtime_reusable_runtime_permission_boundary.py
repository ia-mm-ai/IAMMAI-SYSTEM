"""Bounded post-ongoing-runtime reusable-runtime-permission-boundary resolver.

This resolver is downstream of the post-runtime-hosting ongoing-runtime line.
It records one bounded reusable-runtime-permission-boundary posture and one
future reusable-runtime-permission review declaration only. It does not create
reusable runtime permission, continuation, self-continuation, self-recursive
growth, daemon, loop, public API, participant-facing interface, distributed
network behavior, source transfer, source receipt, reception authorization,
...
class PostOngoingRuntimeReusableRuntimePermissionBoundaryError(Exception):
    """Bounded resolver error for reusable-runtime-permission-boundary handling."""
...
RESOLVER_MODULE = "resolve_post_ongoing_runtime_reusable_runtime_permission_boundary"

OUTCOME_RECORDED = "POST_ONGOING_RUNTIME_REUSABLE_RUNTIME_PERMISSION_BOUNDARY_RECORDED"
OUTCOME_NOT_RECORDED = (
    "POST_ONGOING_RUNTIME_REUSABLE_RUNTIME_PERMISSION_BOUNDARY_NOT_RECORDED"
)
OUTCOME_REQUIRES_ADDITIONAL_BASIS = (
    "POST_ONGOING_RUNTIME_REUSABLE_RUNTIME_PERMISSION_BOUNDARY_REQUIRES_ADDITIONAL_BASIS"
)
OUTCOME_BLOCKED = "POST_ONGOING_RUNTIME_REUSABLE_RUNTIME_PERMISSION_BOUNDARY_BLOCKED"
OUTCOME_FAMILY = (
    OUTCOME_RECORDED,
    OUTCOME_NOT_RECORDED,
    OUTCOME_REQUIRES_ADDITIONAL_BASIS,
...
INTENT_RECORD = "RECORD_POST_ONGOING_RUNTIME_REUSABLE_RUNTIME_PERMISSION_BOUNDARY"
INTENT_DO_NOT_RECORD = (
    "DO_NOT_RECORD_POST_ONGOING_RUNTIME_REUSABLE_RUNTIME_PERMISSION_BOUNDARY"
)
INTENT_BLOCK = "BLOCK_POST_ONGOING_RUNTIME_REUSABLE_RUNTIME_PERMISSION_BOUNDARY"
...
CORE_QUESTION = (
    "Can the clean post-runtime-hosting ongoing-runtime basis be bounded for "
    "one future reusable-runtime-permission review without creating reusable "
...
SUPPORTED_REUSABLE_RUNTIME_PERMISSION_BOUNDARY_SCOPE = SUPPORTED_SCOPE_VALUES
...
BLOCK_CODES = _tokens(
    ...
    CONSUMED_REQUEST_REOPENED
    AUTHORIZATION_TOKEN_REUSED
    REUSABLE_RUNTIME_PERMISSION_BOUNDARY_REQUIRED_POSTURE_MISSING
...
_DEFAULT_REQUEST_ID = (
    "post_ongoing_runtime_reusable_runtime_permission_boundary_reference_review_001"
)
...
_OPEN_ITEMS = (
    "reusable-runtime-permission-boundary test",
    "reusable-runtime-permission-boundary live artifact",
    "reusable-runtime-permission-boundary terminal summary, if needed",
    "reusable-runtime-permission specification",
    "reusable-runtime-permission resolver/test/live artifact",
...
def _scope_values(request: Mapping[str, Any]) -> list[Any]:
    scope = request.get("reusable_runtime_permission_boundary_scope")
...
def _validate_scope(request: Mapping[str, Any], checks: list[dict[str, Any]]) -> None:
    ...
    redaction_values = {
        ...
        "[bounded-reusable-runtime-permission-redacted]",
    }
    redacted = [value for value in scope_values if value in redaction_values]
    _check(
        checks,
        "reusable_runtime_permission_boundary_scope_supported",
...
def _base_request_checks(
    ...
    question = request.get("reusable_runtime_permission_boundary_question")
    intent = request.get("reusable_runtime_permission_boundary_intent")
    _check(
        checks,
        "reusable_runtime_permission_boundary_question_declared",
    ...
    _check(
        checks,
        "reusable_runtime_permission_boundary_intent_supported",
    ...
    _check(
        checks,
        "reusable_runtime_permission_boundary_intent_not_explicit_block",
        intent != INTENT_BLOCK,
...
def _ongoing_runtime_checks(
    ...
    false_flags = (
        (
            "selected_ongoing_runtime_already_created_reusable_runtime_permission",
            "ongoing_runtime_did_not_create_reusable_runtime_permission",
            "ONGOING_RUNTIME_ALREADY_CREATED_REUSABLE_RUNTIME_PERMISSION",
        ),
        (
        ...
        (
            "selected_ongoing_runtime_already_created_runtime_daemon",
            "ongoing_runtime_did_not_create_runtime_daemon",
            "ONGOING_RUNTIME_ALREADY_CREATED_RUNTIME_DAEMON",
        ),
        (
            "selected_ongoing_runtime_already_created_runtime_loop",
            "ongoing_runtime_did_not_create_runtime_loop",
            "ONGOING_RUNTIME_ALREADY_CREATED_RUNTIME_LOOP",
        ),
        (
            "selected_ongoing_runtime_already_created_public_api",
            "ongoing_runtime_did_not_create_public_api",
            "ONGOING_RUNTIME_ALREADY_CREATED_PUBLIC_API",
        ),
        (
            "selected_ongoing_runtime_already_created_participant_facing_interface",
            "ongoing_runtime_did_not_create_participant_facing_interface",
            "ONGOING_RUNTIME_ALREADY_CREATED_PARTICIPANT_FACING_INTERFACE",
        ),
        (
            "selected_ongoing_runtime_already_created_distributed_network_behavior",
            "ongoing_runtime_did_not_create_distributed_network_behavior",
            "ONGOING_RUNTIME_ALREADY_CREATED_DISTRIBUTED_NETWORK_BEHAVIOR",
        ),
        (
            "selected_ongoing_runtime_treated_as_reusable_runtime_permission",
            "ongoing_runtime_not_treated_as_reusable_runtime_permission",
            "ONGOING_RUNTIME_TREATED_AS_REUSABLE_RUNTIME_PERMISSION",
        ),
        (
            "selected_ongoing_runtime_treated_as_continuation",
            "ongoing_runtime_not_treated_as_continuation",
            "ONGOING_RUNTIME_TREATED_AS_CONTINUATION",
        ),
        (
            "selected_ongoing_runtime_treated_as_self_continuation",
            "ongoing_runtime_not_treated_as_self_continuation",
            "ONGOING_RUNTIME_TREATED_AS_SELF_CONTINUATION",
        ),
        (
            "selected_ongoing_runtime_treated_as_runtime_daemon",
            "ongoing_runtime_not_treated_as_runtime_daemon",
            "ONGOING_RUNTIME_TREATED_AS_RUNTIME_DAEMON",
        ),
        (
            "selected_ongoing_runtime_treated_as_runtime_loop",
            "ongoing_runtime_not_treated_as_runtime_loop",
            "ONGOING_RUNTIME_TREATED_AS_RUNTIME_LOOP",
        ),
        (
            "selected_ongoing_runtime_treated_as_public_api",
            "ongoing_runtime_not_treated_as_public_api",
            "ONGOING_RUNTIME_TREATED_AS_PUBLIC_API",
        ),
        (
            "selected_ongoing_runtime_treated_as_participant_facing_interface",
            "ongoing_runtime_not_treated_as_participant_facing_interface",
            "ONGOING_RUNTIME_TREATED_AS_PARTICIPANT_FACING_INTERFACE",
        ),
        (
            "selected_ongoing_runtime_treated_as_distributed_network_behavior",
            "ongoing_runtime_not_treated_as_distributed_network_behavior",
            "ONGOING_RUNTIME_TREATED_AS_DISTRIBUTED_NETWORK_BEHAVIOR",
        ),
        (
            "selected_ongoing_runtime_authorized_future_work",
            "ongoing_runtime_did_not_authorize_future_work",
            "ONGOING_RUNTIME_AUTHORIZED_FUTURE_WORK",
        ),
        (
            "selected_ongoing_runtime_persistence_treated_as_repeatability",
            "ongoing_runtime_persistence_not_repeatability",
            "ONGOING_RUNTIME_PERSISTENCE_TREATED_AS_REPEATABILITY",
        ),
        (
            "selected_ongoing_runtime_persistence_authorized_reuse",
            "ongoing_runtime_persistence_did_not_authorize_reuse",
            "ONGOING_RUNTIME_PERSISTENCE_AUTHORIZED_REUSE",
        ),
    )
    ...
    _check(
        checks,
        "ongoing_runtime_canonicalized_result_level_non_claims",
        request.get("selected_ongoing_runtime_non_claims_canonicalized") is True,
        True,
        request.get("selected_ongoing_runtime_non_claims_canonicalized"),
        "ONGOING_RUNTIME_DID_NOT_CANONICALIZE_NON_CLAIMS",
    )
...
def _posture_checks(request: Mapping[str, Any], checks: list[dict[str, Any]]) -> None:
    for field in _POSTURE_FIELDS:
        _check(
            ...
            "bounded reusable-runtime-permission-boundary posture declared",
            request.get(field),
            "REUSABLE_RUNTIME_PERMISSION_BOUNDARY_REQUIRED_POSTURE_MISSING",
        )
...
def _determine_outcome(request: Mapping[str, Any], checks: list[dict[str, Any]]) -> str:
    ...
    requested = request.get("requested_reusable_runtime_permission_boundary_outcome")
    if requested == OUTCOME_REQUIRES_ADDITIONAL_BASIS:
        return OUTCOME_REQUIRES_ADDITIONAL_BASIS
    if (
        requested == OUTCOME_NOT_RECORDED
        or request.get("reusable_runtime_permission_boundary_intent")
        == INTENT_DO_NOT_RECORD
    ):
...
def _reusable_runtime_permission_boundary_statement(outcome: str) -> dict[str, bool]:
...
def _reusable_runtime_permission_boundary_non_meaning() -> dict[str, bool]:
    return {
        "reusable_runtime_permission_boundary_is_reusable_runtime_permission": False,
        "reusable_runtime_permission_boundary_is_continuation": False,
        "reusable_runtime_permission_boundary_is_self_continuation": False,
        "reusable_runtime_permission_boundary_is_self_recursive_growth": False,
        "reusable_runtime_permission_boundary_is_runtime_daemon": False,
        "reusable_runtime_permission_boundary_is_runtime_loop": False,
        "reusable_runtime_permission_boundary_is_public_api": False,
        "reusable_runtime_permission_boundary_is_participant_facing_interface": False,
        "reusable_runtime_permission_boundary_is_distributed_network_behavior": False,
        "reusable_runtime_permission_boundary_is_source_transfer": False,
        "reusable_runtime_permission_boundary_is_source_receipt": False,
        "reusable_runtime_permission_boundary_is_reception_authorization": False,
        "reusable_runtime_permission_boundary_is_source": False,
        "reusable_runtime_permission_boundary_is_authority": False,
        "reusable_runtime_permission_boundary_is_currentness": False,
        "reusable_runtime_permission_boundary_is_deployment": False,
        "reusable_runtime_permission_boundary_is_public_release": False,
        "reusable_runtime_permission_boundary_is_operation_permission": False,
        "reusable_runtime_permission_boundary_is_reusable_permission": False,
        "reusable_runtime_permission_boundary_is_follow_on_work": False,
        "ongoing_runtime_is_reusable_runtime_permission": False,
        "ongoing_runtime_is_continuation": False,
        "ongoing_runtime_persistence_is_repeatability": False,
    }
...
def _build_result(
    ...
    request_id = str(
        request.get("reusable_runtime_permission_boundary_request_id")
        or _DEFAULT_REQUEST_ID
    )
    metadata = {
        "post_ongoing_runtime_reusable_runtime_permission_boundary_id": request_id,
        "post_ongoing_runtime_reusable_runtime_permission_boundary_type": (
            "post_ongoing_runtime_reusable_runtime_permission_boundary"
        ),
        "post_ongoing_runtime_reusable_runtime_permission_boundary_version": RESULT_VERSION,
        "generated_at": _utc_now(),
        "resolver_module": RESOLVER_MODULE,
        "request_intent": _sanitize(
            request.get("reusable_runtime_permission_boundary_intent")
        ),
    ...
    if outcome == OUTCOME_BLOCKED:
        block = {
            ...
            or "DECLARED_REUSABLE_RUNTIME_PERMISSION_BOUNDARY_REQUEST_MALFORMED",
            "block_reason": _sanitize(
                block_reason
                or request.get("block_reason")
                or "reusable-runtime-permission-boundary review blocked by bounded resolver check"
            ),
        }

    result: dict[str, Any] = {
        "post_ongoing_runtime_reusable_runtime_permission_boundary_metadata": metadata,
        "declared_reusable_runtime_permission_boundary_question": {
            "request_id": request_id,
            "question": _sanitize(
                request.get("reusable_runtime_permission_boundary_question")
            ),
            "intent": _sanitize(
                request.get("reusable_runtime_permission_boundary_intent")
            ),
        ...
        "selected_ongoing_runtime_basis": _basis_detail(
            ...
            (
                ...
                "selected_ongoing_runtime_non_claims_canonicalized",
            ),
        ),
        ...
        "reusable_runtime_permission_boundary_scope": _sanitize(_scope_values(request)),
        "reusable_runtime_permission_boundary_checks": checks,
        "reusable_runtime_permission_boundary_statement": (
            _reusable_runtime_permission_boundary_statement(outcome)
        ),
        "reusable_runtime_permission_boundary_non_meaning": (
            _reusable_runtime_permission_boundary_non_meaning()
        ),
    ...
    result["post_ongoing_runtime_reusable_runtime_permission_boundary_summary"] = (
        build_post_ongoing_runtime_reusable_runtime_permission_boundary_summary(result)
    )
    return result
...
def _malformed_result(code: str, reason: str) -> dict[str, Any]:
    request = {
        "reusable_runtime_permission_boundary_request_id": _DEFAULT_REQUEST_ID,
        "reusable_runtime_permission_boundary_question": None,
        "reusable_runtime_permission_boundary_intent": None,
        "reusable_runtime_permission_boundary_scope": [],
    }
    checks: list[dict[str, Any]] = []
    _check(
        checks,
        "declared_reusable_runtime_permission_boundary_request_readable",
        False,
        "readable mapping",
        reason,
        code,
...
def resolve_post_ongoing_runtime_reusable_runtime_permission_boundary(
    declared_reusable_runtime_permission_boundary_request: Mapping[str, Any] | None = None,
) -> dict:
    """Resolve one bounded reusable-runtime-permission-boundary request."""

    if declared_reusable_runtime_permission_boundary_request is None:
        return _malformed_result(
            "DECLARED_REUSABLE_RUNTIME_PERMISSION_BOUNDARY_REQUEST_MALFORMED",
            "declared reusable-runtime-permission-boundary request is missing",
        )
    if not isinstance(declared_reusable_runtime_permission_boundary_request, Mapping):
        return _malformed_result(
            "DECLARED_REUSABLE_RUNTIME_PERMISSION_BOUNDARY_REQUEST_MALFORMED",
            "declared reusable-runtime-permission-boundary request is not a mapping",
        )

    request = deepcopy(dict(declared_reusable_runtime_permission_boundary_request))
    checks = _build_checks(request)
    outcome = _determine_outcome(request, checks)
    return _build_result(request, checks, outcome)


def resolve_post_ongoing_runtime_reusable_runtime_permission_boundary_from_path(
    declared_reusable_runtime_permission_boundary_request_path: Path | str,
) -> dict:
    """Read and resolve a declared boundary request from a JSON path."""

    path = Path(declared_reusable_runtime_permission_boundary_request_path)
    try:
        raw = path.read_text(encoding="utf-8")
    except OSError as exc:
        return _malformed_result(
            "DECLARED_REUSABLE_RUNTIME_PERMISSION_BOUNDARY_REQUEST_UNREADABLE",
            f"declared reusable-runtime-permission-boundary request could not be read: {exc}",
        )
    try:
        ...
        return _malformed_result(
            "DECLARED_REUSABLE_RUNTIME_PERMISSION_BOUNDARY_REQUEST_UNREADABLE",
            f"declared reusable-runtime-permission-boundary request JSON could not be decoded: {exc}",
        )
    if not isinstance(request, Mapping):
        return _malformed_result(
            "DECLARED_REUSABLE_RUNTIME_PERMISSION_BOUNDARY_REQUEST_MALFORMED",
            "declared reusable-runtime-permission-boundary request JSON is not an object",
        )
    return resolve_post_ongoing_runtime_reusable_runtime_permission_boundary(request)


def build_post_ongoing_runtime_reusable_runtime_permission_boundary_summary(
    result: Mapping[str, Any],
) -> dict:
    """Build a deterministic summary for one boundary result."""

    checks = list(result.get("reusable_runtime_permission_boundary_checks", []))
    ...
    question = result.get("declared_reusable_runtime_permission_boundary_question", {})
    statement = result.get("reusable_runtime_permission_boundary_statement", {})
    ...
    return {
        ...
        "resolver_module": RESOLVER_MODULE,
        "reusable_runtime_permission_boundary_recorded": statement.get(
            "reusable_runtime_permission_boundary_recorded"
        )
        is True,
        "one_future_reusable_runtime_permission_review_declared": statement.get(
            "one_future_reusable_runtime_permission_review_declared"
        )
        is True,
        "ongoing_runtime_basis_preserved": statement.get(
            "ongoing_runtime_basis_preserved"
        )
        is True,
        ...
        is True,
        "ongoing_runtime_persistence_not_repeatability": statement.get(
            "ongoing_runtime_persistence_not_repeatability"
        )
        is True,
        "reusable_runtime_permission_boundary_not_reusable_runtime_permission": statement.get(
            "reusable_runtime_permission_boundary_not_reusable_runtime_permission"
        )
        is True,
        "reusable_runtime_permission_boundary_not_continuation": statement.get(
            "reusable_runtime_permission_boundary_not_continuation"
        )
        is True,
        ...
        "hidden_repo_state_not_used_as_reusable_runtime_permission_boundary_authority": statement.get(
            "hidden_repo_state_not_used_as_reusable_runtime_permission_boundary_authority"
        )
        is True,
        "repo_local_availability_not_reusable_runtime_permission_boundary_authority": statement.get(
            "repo_local_availability_not_reusable_runtime_permission_boundary_authority"
        )
        is True,
        "artifact_existence_not_reusable_runtime_permission_boundary_authority": statement.get(
            "artifact_existence_not_reusable_runtime_permission_boundary_authority"
        )
        is True,
        "latest_file_posture_not_reusable_runtime_permission_boundary_authority": statement.get(
            "latest_file_posture_not_reusable_runtime_permission_boundary_authority"
        )
        is True,
...
def write_post_ongoing_runtime_reusable_runtime_permission_boundary_result(
    result: Mapping[str, Any], output_path: Path | str | None = None
) -> Path:
    """Write a bounded boundary result JSON without overwriting."""

    metadata = result.get(
        "post_ongoing_runtime_reusable_runtime_permission_boundary_metadata", {}
    )
    request_id = (
        metadata.get("post_ongoing_runtime_reusable_runtime_permission_boundary_id")
        if isinstance(metadata, Mapping)
        else None
    )
    request_id = str(request_id or _DEFAULT_REQUEST_ID)
    filename = (
        f"{request_id}__post_ongoing_runtime_reusable_runtime_permission_boundary_result.json"
    )
...
def build_declared_post_ongoing_runtime_reusable_runtime_permission_boundary_request(
    reusable_runtime_permission_boundary_request_id: str = _DEFAULT_REQUEST_ID,
    reusable_runtime_permission_boundary_scope: list[str] | tuple[str, ...] | None = None,
    **overrides: Any,
) -> dict[str, Any]:
    """Build a clean declared reusable-runtime-permission-boundary request."""

    scope = list(reusable_runtime_permission_boundary_scope or SUPPORTED_SCOPE_VALUES)
    request: dict[str, Any] = {
        "reusable_runtime_permission_boundary_request_id": (
            reusable_runtime_permission_boundary_request_id
        ),
        "reusable_runtime_permission_boundary_question": CORE_QUESTION,
        "reusable_runtime_permission_boundary_intent": INTENT_RECORD,
        ...
        "selected_ongoing_runtime_already_created_reusable_runtime_permission": False,
        ...
        "selected_ongoing_runtime_already_created_runtime_daemon": False,
        "selected_ongoing_runtime_already_created_runtime_loop": False,
        "selected_ongoing_runtime_already_created_public_api": False,
        "selected_ongoing_runtime_already_created_participant_facing_interface": False,
        "selected_ongoing_runtime_already_created_distributed_network_behavior": False,
        "selected_ongoing_runtime_treated_as_reusable_runtime_permission": False,
        "selected_ongoing_runtime_treated_as_continuation": False,
        "selected_ongoing_runtime_treated_as_self_continuation": False,
        "selected_ongoing_runtime_treated_as_runtime_daemon": False,
        "selected_ongoing_runtime_treated_as_runtime_loop": False,
        "selected_ongoing_runtime_treated_as_public_api": False,
        "selected_ongoing_runtime_treated_as_participant_facing_interface": False,
        "selected_ongoing_runtime_treated_as_distributed_network_behavior": False,
        "selected_ongoing_runtime_authorized_future_work": False,
        "selected_ongoing_runtime_persistence_treated_as_repeatability": False,
        "selected_ongoing_runtime_persistence_authorized_reuse": False,
        "selected_ongoing_runtime_non_claims_canonicalized": True,
        ...
        "reusable_runtime_permission_boundary_scope": scope,
        "declared_non_claims": _canonical_false_non_claims(),
        "reference_shaped_input_posture": True,
        "requested_reusable_runtime_permission_boundary_outcome": OUTCOME_RECORDED,
    }
    for field in _POSTURE_FIELDS:
