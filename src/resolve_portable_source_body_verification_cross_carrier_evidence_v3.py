"""Bounded portable source-body verification cross-carrier evidence resolver v3.

This successor resolver is downstream of the cross-carrier-evidence-boundary
line. It records one bounded cross-carrier evidence posture only. It does not
create portable verification closure, source transfer, source receipt,
...
The predecessor cross-carrier evidence resolvers and v2 test remain preserved
conformance-failure evidence. This v3 resolver keeps the v2 public shape while
blocking deep returned-capture promotion into cross-carrier evidence/proof under
selected cross-carrier-evidence-boundary basis sections.
"""
...
class PortableSourceBodyVerificationCrossCarrierEvidenceError(Exception):
    """Raised for unreadable paths, malformed JSON, or impossible result shape."""


RESULT_VERSION = "0.1.0"
RESOLVER_MODULE = "resolve_portable_source_body_verification_cross_carrier_evidence_v3"
RESULT_TYPE = "portable_source_body_verification_cross_carrier_evidence"
DEFAULT_REQUEST_ID = (
    "portable_source_body_verification_cross_carrier_evidence_reference_review_001"
)
OUTPUT_ROOT = Path(
    "artifacts/"
...
CORE_QUESTION = (
    "Can the clean cross-carrier-evidence-boundary basis be used to record one "
    "bounded cross-carrier evidence posture without creating portable "
    "verification closure, source transfer, source receipt, reception "
...
OUTCOME_RECORDED = "PORTABLE_SOURCE_BODY_VERIFICATION_CROSS_CARRIER_EVIDENCE_RECORDED"
OUTCOME_NOT_RECORDED = (
    "PORTABLE_SOURCE_BODY_VERIFICATION_CROSS_CARRIER_EVIDENCE_NOT_RECORDED"
)
OUTCOME_REQUIRES_ADDITIONAL_BASIS = (
    "PORTABLE_SOURCE_BODY_VERIFICATION_CROSS_CARRIER_EVIDENCE_REQUIRES_ADDITIONAL_BASIS"
)
OUTCOME_BLOCKED = "PORTABLE_SOURCE_BODY_VERIFICATION_CROSS_CARRIER_EVIDENCE_BLOCKED"
OUTCOME_FAMILY = (
    OUTCOME_RECORDED,
    OUTCOME_NOT_RECORDED,
    OUTCOME_REQUIRES_ADDITIONAL_BASIS,
...
INTENT_RECORD = "RECORD_PORTABLE_SOURCE_BODY_VERIFICATION_CROSS_CARRIER_EVIDENCE"
INTENT_DO_NOT_RECORD = "DO_NOT_RECORD_PORTABLE_SOURCE_BODY_VERIFICATION_CROSS_CARRIER_EVIDENCE"
INTENT_BLOCK = "BLOCK_PORTABLE_SOURCE_BODY_VERIFICATION_CROSS_CARRIER_EVIDENCE"
...
SUPPORTED_SCOPE_VALUES = (
    "CROSS_CARRIER_EVIDENCE_SPEC_ONLY",
    "ONE_BOUNDED_CROSS_CARRIER_EVIDENCE_RECORDED",
    ...
    "CROSS_CARRIER_EVIDENCE_RECORDED_BOUNDED",
    "CROSS_CARRIER_EVIDENCE_ARTIFACT_RECORDED_OR_BOUNDED",
    ...
    "ZERO_EXIT_CODE_NOT_CROSS_CARRIER_EVIDENCE_AS_STANDALONE_INFERENCE",
    "STRING_ZERO_NOT_CROSS_CARRIER_EVIDENCE_AS_STANDALONE_INFERENCE",
    "OK_OUTPUT_NOT_CROSS_CARRIER_EVIDENCE_AS_STANDALONE_INFERENCE",
    "RAN_7_TESTS_NOT_CROSS_CARRIER_EVIDENCE_AS_STANDALONE_INFERENCE",
    "RETURNED_CAPTURE_NOT_CROSS_CARRIER_EVIDENCE_AS_STANDALONE_INFERENCE",
...
SUPPORTED_CROSS_CARRIER_EVIDENCE_SCOPE = SUPPORTED_SCOPE_VALUES

ALLOWED_TRUE_RECORDED_FIELDS = (
    "cross_carrier_evidence_recorded",
    "bounded_cross_carrier_evidence_recorded",
    "cross_carrier_evidence_artifact_recorded_or_bounded",
    "cross_carrier_evidence_boundary_basis_preserved",
    "second_carrier_external_result_basis_preserved",
    "external_result_artifact_basis_preserved",
...
BLOCK_CODES = (
    "DECLARED_CROSS_CARRIER_EVIDENCE_REQUEST_MALFORMED",
    "DECLARED_CROSS_CARRIER_EVIDENCE_REQUEST_UNREADABLE",
    ...
    "SECOND_CARRIER_EXTERNAL_RESULT_TREATED_RAN_7_TESTS_AS_CROSS_CARRIER_EVIDENCE",
...
NON_MEANING_KEYS = (
    ...
    "cross_carrier_evidence_became_source_transfer_source_receipt_reception_authorization",
    "cross_carrier_evidence_became_source_authority_currentness",
    "cross_carrier_evidence_artifact_became_portable_verification_closure",
    "returned_capture_became_cross_carrier_proof_by_itself",
    "zero_exit_code_became_cross_carrier_evidence_automatically",
    "string_zero_became_cross_carrier_evidence_automatically",
    "string_zero_became_doctrine",
    "ok_became_cross_carrier_evidence_automatically",
    "ran_7_tests_became_cross_carrier_evidence_automatically",
    "macbook_pro_became_authority",
    "macbook_air_became_source",
    "artifact_existence_became_cross_carrier_evidence_authority",
    "artifact_path_became_currentness",
    "repo_local_availability_became_cross_carrier_evidence_authority",
    "hidden_repo_state_became_cross_carrier_evidence_authority",
    ...
    "predecessor_cross_carrier_evidence_resolver_repaired_hidden_or_claimed_passed",
    "predecessor_cross_carrier_evidence_v2_resolver_test_repaired_hidden_or_claimed_passed",
)

WHAT_REMAINS_OPEN = (
    "cross-carrier evidence test",
    "cross-carrier evidence live artifact",
    "cross-carrier evidence terminal summary, if needed",
...
BOUNDARY_STRING_ZERO_DOCTRINE_DIRECT_KEYS = {
    "selected_cross_carrier_evidence_boundary_treated_string_zero_as_doctrine",
    "cross_carrier_evidence_boundary_treated_string_zero_as_doctrine",
}
BOUNDARY_STRING_ZERO_DOCTRINE_NESTED_KEYS = (
    BOUNDARY_STRING_ZERO_DOCTRINE_DIRECT_KEYS
    | {
        "treated_string_zero_as_doctrine",
        "string_zero_representation_turned_into_doctrine",
        "string_zero_turned_into_doctrine",
    }
)
BOUNDARY_RETURNED_CAPTURE_PROMOTION_DIRECT_KEYS = {
    ...
    "cross_carrier_evidence_boundary_treated_returned_capture_as_cross_carrier_proof",
}
BOUNDARY_RETURNED_CAPTURE_PROMOTION_NESTED_KEYS = (
    BOUNDARY_RETURNED_CAPTURE_PROMOTION_DIRECT_KEYS
    | {
        "treated_returned_capture_as_cross_carrier_evidence",
        "treated_returned_capture_as_cross_carrier_proof",
        "returned_capture_treated_as_cross_carrier_evidence",
        "returned_capture_treated_as_cross_carrier_proof",
        "returned_capture_treated_as_cross_carrier_evidence_standalone",
        "returned_capture_promoted_to_cross_carrier_evidence",
        "returned_capture_promoted_to_cross_carrier_proof",
        "returned_capture_became_cross_carrier_evidence",
        "returned_capture_became_cross_carrier_proof",
    }
)
BOUNDARY_OVERREACH_SECTIONS = (
    "selected_cross_carrier_evidence_boundary_basis",
    "selected_cross_carrier_evidence_boundary_terminal_summary_basis",
)
...
def _contains_truthy_key(value: Any, keys: set[str]) -> bool:
    if isinstance(value, Mapping):
        for key, nested in value.items():
            if str(key) in keys and _truthy(nested):
                return True
...
def _boundary_overreach_truthy(
    request: Mapping[str, Any],
    direct_keys: set[str],
    nested_keys: set[str],
    non_claim_keys: set[str],
) -> bool:
    for key in direct_keys:
        if _truthy(request.get(key)):
            return True
    for section in BOUNDARY_OVERREACH_SECTIONS:
        if _contains_truthy_key(request.get(section), nested_keys):
            return True
    declared = request.get("declared_non_claims")
    if isinstance(declared, Mapping):
        for key in non_claim_keys:
            if _truthy(declared.get(key)):
                return True
    return False
...
def _posture(name: str, recorded: bool) -> dict[str, Any]:
    return {
        ...
        "bounded_to": "cross_carrier_evidence",
...
def _shortcut_prefixes_for_field(field: str) -> tuple[str, ...]:
    ...
    if field == "selected_returned_second_carrier_live_capture_intake_basis":
        return ("selected_returned_capture_", "selected_returned_second_carrier_live_capture_intake")
        ...
        selected.update(
            {
                ...
                "predecessor_cross_carrier_evidence_resolver_failure_preserved": True,
                "predecessor_cross_carrier_evidence_resolver_not_repaired": True,
                "predecessor_cross_carrier_evidence_resolver_not_hidden": True,
                "predecessor_cross_carrier_evidence_resolver_not_claimed_passed": True,
                "predecessor_cross_carrier_evidence_v2_resolver_failure_preserved": True,
                "predecessor_cross_carrier_evidence_v2_test_failure_preserved": True,
                "predecessor_cross_carrier_evidence_v2_not_repaired": True,
                "predecessor_cross_carrier_evidence_v2_not_hidden": True,
                "predecessor_cross_carrier_evidence_v2_not_claimed_passed": True,
...
OVERREACH_FLAG_CODES: tuple[tuple[set[str], str], ...] = (
    ...
    ({"cross_carrier_evidence_treated_as_source_transfer"}, "CROSS_CARRIER_EVIDENCE_TREATED_AS_SOURCE_TRANSFER"),
    ({"cross_carrier_evidence_treated_as_source_receipt"}, "CROSS_CARRIER_EVIDENCE_TREATED_AS_SOURCE_RECEIPT"),
    (
        {"cross_carrier_evidence_treated_as_reception_authorization"},
        "CROSS_CARRIER_EVIDENCE_TREATED_AS_RECEPTION_AUTHORIZATION",
    ),
    ({"cross_carrier_evidence_treated_as_source"}, "CROSS_CARRIER_EVIDENCE_TREATED_AS_SOURCE"),
    ({"cross_carrier_evidence_treated_as_authority"}, "CROSS_CARRIER_EVIDENCE_TREATED_AS_AUTHORITY"),
    ({"cross_carrier_evidence_treated_as_currentness"}, "CROSS_CARRIER_EVIDENCE_TREATED_AS_CURRENTNESS"),
    (
        {"cross_carrier_evidence_treated_as_final_completion"},
        "CROSS_CARRIER_EVIDENCE_TREATED_AS_FINAL_COMPLETION",
    ),
    ({"cross_carrier_evidence_treated_as_runtime"}, "CROSS_CARRIER_EVIDENCE_TREATED_AS_RUNTIME"),
    ({"cross_carrier_evidence_treated_as_continuation"}, "CROSS_CARRIER_EVIDENCE_TREATED_AS_CONTINUATION"),
    (
        {"cross_carrier_evidence_treated_as_reusable_permission"},
        "CROSS_CARRIER_EVIDENCE_TREATED_AS_REUSABLE_PERMISSION",
    ),
    ({"cross_carrier_evidence_treated_as_follow_on_work"}, "CROSS_CARRIER_EVIDENCE_TREATED_AS_FOLLOW_ON_WORK"),
    (
        {
            "zero_exit_code_treated_as_cross_carrier_evidence_standalone",
            "zero_exit_code_treated_as_cross_carrier_evidence",
    ...
    (
        {"ok_output_treated_as_cross_carrier_evidence_standalone", "ok_output_treated_as_cross_carrier_evidence"},
        "OK_OUTPUT_TREATED_AS_CROSS_CARRIER_EVIDENCE",
    ),
    (
        {
...
def _evaluate_request(request: Mapping[str, Any]) -> tuple[list[dict[str, Any]], dict[str, Any] | None]:
    ...
    question = request.get("cross_carrier_evidence_question")
    _check(
        checks,
        "cross-carrier evidence question declared",
        isinstance(question, str) and bool(question.strip()),
        "declared bounded cross-carrier evidence question",
        question,
        "CROSS_CARRIER_EVIDENCE_QUESTION_UNDECLARED",
    )

    intent = request.get("cross_carrier_evidence_intent")
    _check(
        checks,
        "cross-carrier evidence intent supported",
    ...
    if intent == INTENT_BLOCK:
        _check(
            checks,
            "cross-carrier evidence explicit block intent absent",
            False,
    ...
    scope = _scope_values(request.get("cross_carrier_evidence_scope"))
    unsupported_scope = [value for value in scope if value not in SUPPORTED_SCOPE_VALUES]
    _check(
        checks,
        "cross-carrier evidence scope supported",
        not unsupported_scope,
        "only supported cross-carrier evidence scope values",
        unsupported_scope,
        "UNSUPPORTED_CROSS_CARRIER_EVIDENCE_SCOPE",
    )

    boundary_string_doctrine = _boundary_overreach_truthy(
        request,
        BOUNDARY_STRING_ZERO_DOCTRINE_DIRECT_KEYS,
        BOUNDARY_STRING_ZERO_DOCTRINE_NESTED_KEYS,
        {"string_zero_representation_turned_into_doctrine"},
    ...
    _check(
        checks,
        "cross-carrier evidence boundary did not treat string zero as doctrine",
        not boundary_string_doctrine,
        False,
        boundary_string_doctrine,
        "CROSS_CARRIER_EVIDENCE_BOUNDARY_TREATED_STRING_ZERO_AS_DOCTRINE",
    )

    boundary_returned_capture_promoted = _boundary_overreach_truthy(
        request,
        BOUNDARY_RETURNED_CAPTURE_PROMOTION_DIRECT_KEYS,
        BOUNDARY_RETURNED_CAPTURE_PROMOTION_NESTED_KEYS,
        {
    ...
    _check(
        checks,
        "cross-carrier evidence boundary did not treat returned capture as cross-carrier evidence",
        not boundary_returned_capture_promoted,
        False,
        boundary_returned_capture_promoted,
        "CROSS_CARRIER_EVIDENCE_BOUNDARY_TREATED_RETURNED_CAPTURE_AS_CROSS_CARRIER_EVIDENCE",
    )
    ...
    _check(
        ...
        _basis_declared(request, "selected_cross_carrier_evidence_boundary_basis"),
        "selected cross-carrier evidence boundary basis declared",
        request.get("selected_cross_carrier_evidence_boundary_basis"),
        "CROSS_CARRIER_EVIDENCE_BOUNDARY_BASIS_MISSING",
    )

    boundary_outcome = _request_value(
        request,
        {"selected_cross_carrier_evidence_boundary_result_outcome", "cross_carrier_evidence_boundary_outcome"},
    )
    _check(
        checks,
        "cross-carrier evidence boundary outcome recorded",
        boundary_outcome == EXPECTED_CROSS_CARRIER_EVIDENCE_BOUNDARY_OUTCOME,
        EXPECTED_CROSS_CARRIER_EVIDENCE_BOUNDARY_OUTCOME,
        boundary_outcome,
        "CROSS_CARRIER_EVIDENCE_BOUNDARY_NOT_RECORDED",
    )
    ...
    boundary_version = _request_value(
        request,
        {"selected_cross_carrier_evidence_boundary_result_version", "cross_carrier_evidence_boundary_result_version"},
    )
    _check(
        checks,
        "cross-carrier evidence boundary version 0.1.0",
    ...
    boundary_failed = _as_int(_request_value(request, {"selected_cross_carrier_evidence_boundary_failed_check_count"}, 0))
    _check(
        checks,
    ...
    boundary_required_true_checks = (
        (
            "cross-carrier evidence boundary declared future review step",
            {"selected_cross_carrier_evidence_boundary_declared_future_cross_carrier_evidence_review_step"},
            "CROSS_CARRIER_EVIDENCE_BOUNDARY_DID_NOT_DECLARE_FUTURE_CROSS_CARRIER_EVIDENCE_REVIEW_STEP",
        ),
        (
            "cross-carrier evidence boundary kept zero exit code not cross-carrier evidence",
            {"selected_cross_carrier_evidence_boundary_zero_exit_code_not_cross_carrier_evidence"},
            "CROSS_CARRIER_EVIDENCE_BOUNDARY_TREATED_ZERO_EXIT_CODE_AS_CROSS_CARRIER_EVIDENCE",
        ),
        (
            "cross-carrier evidence boundary kept string zero not cross-carrier evidence",
            {"selected_cross_carrier_evidence_boundary_string_zero_not_cross_carrier_evidence"},
            "CROSS_CARRIER_EVIDENCE_BOUNDARY_TREATED_STRING_ZERO_AS_CROSS_CARRIER_EVIDENCE",
        ),
        (
            "cross-carrier evidence boundary kept OK not cross-carrier evidence",
            {"selected_cross_carrier_evidence_boundary_ok_not_cross_carrier_evidence"},
            "CROSS_CARRIER_EVIDENCE_BOUNDARY_TREATED_OK_AS_CROSS_CARRIER_EVIDENCE",
        ),
        (
            "cross-carrier evidence boundary kept Ran 7 tests not cross-carrier evidence",
            {"selected_cross_carrier_evidence_boundary_ran_7_tests_not_cross_carrier_evidence"},
            "CROSS_CARRIER_EVIDENCE_BOUNDARY_TREATED_RAN_7_TESTS_AS_CROSS_CARRIER_EVIDENCE",
        ),
        (
            "cross-carrier evidence boundary kept returned capture not cross-carrier evidence",
            {"selected_cross_carrier_evidence_boundary_returned_capture_not_cross_carrier_evidence"},
            "CROSS_CARRIER_EVIDENCE_BOUNDARY_TREATED_RETURNED_CAPTURE_AS_CROSS_CARRIER_EVIDENCE",
        ),
        (
            "cross-carrier evidence boundary predecessor external-result v1 failure preserved",
            {"selected_cross_carrier_evidence_boundary_predecessor_external_result_v1_failure_preserved"},
            "PREDECESSOR_EXTERNAL_RESULT_V1_FAILURE_MISSING_OR_REPAIRED_OR_HIDDEN_OR_CLAIMED_PASSED",
        ),
    )
    for check_name, keys, code in boundary_required_true_checks:
        actual = _request_truthy(request, keys)
        _check(checks, check_name, actual, True, actual, code)

    boundary_required_false_checks = (
        (
            "cross-carrier evidence boundary did not already create cross-carrier evidence",
            {"selected_cross_carrier_evidence_boundary_already_created_cross_carrier_evidence"},
            "CROSS_CARRIER_EVIDENCE_BOUNDARY_ALREADY_CREATED_CROSS_CARRIER_EVIDENCE",
        ),
        (
            "cross-carrier evidence boundary did not already create portable verification closure",
            {"selected_cross_carrier_evidence_boundary_already_created_portable_verification_closure"},
            "CROSS_CARRIER_EVIDENCE_BOUNDARY_ALREADY_CREATED_PORTABLE_VERIFICATION_CLOSURE",
        ),
        (
            "cross-carrier evidence boundary did not treat boundary as cross-carrier evidence",
            {"selected_cross_carrier_evidence_boundary_treated_boundary_as_cross_carrier_evidence"},
            "CROSS_CARRIER_EVIDENCE_BOUNDARY_TREATED_BOUNDARY_AS_CROSS_CARRIER_EVIDENCE",
        ),
        (
            "cross-carrier evidence boundary did not treat boundary as portable verification closure",
            {"selected_cross_carrier_evidence_boundary_treated_boundary_as_portable_verification_closure"},
            "CROSS_CARRIER_EVIDENCE_BOUNDARY_TREATED_BOUNDARY_AS_PORTABLE_VERIFICATION_CLOSURE",
        ),
        (
            "cross-carrier evidence boundary did not redact official enum scope strings",
            {"selected_cross_carrier_evidence_boundary_official_enum_scope_strings_redacted"},
            "CROSS_CARRIER_EVIDENCE_BOUNDARY_REDACTED_OFFICIAL_ENUM_SCOPE_STRINGS",
        ),
    )
    for check_name, keys, code in boundary_required_false_checks:
        actual = _request_truthy(request, keys)
    ...
    external_result_outcome = _request_value(
        request,
        {"selected_second_carrier_external_result_result_outcome", "external_result_outcome"},
    )
    _check(
        checks,
    ...
    external_result_version = _request_value(
        request,
        {"selected_second_carrier_external_result_result_version", "external_result_result_version"},
    )
    _check(
        checks,
    ...
    external_result_failed = _as_int(
        _request_value(request, {"selected_second_carrier_external_result_failed_check_count"}, 0)
    )
    _check(
        checks,
    ...
    external_result_guard_checks = (
        ...
        (
            "second-carrier external result did not treat zero exit code as cross-carrier evidence",
            {"selected_second_carrier_external_result_treated_zero_exit_code_as_cross_carrier_evidence"},
            "SECOND_CARRIER_EXTERNAL_RESULT_TREATED_ZERO_EXIT_CODE_AS_CROSS_CARRIER_EVIDENCE",
        ),
        (
            "second-carrier external result did not treat string zero as cross-carrier evidence",
            {"selected_second_carrier_external_result_treated_string_zero_as_cross_carrier_evidence"},
            "SECOND_CARRIER_EXTERNAL_RESULT_TREATED_STRING_ZERO_AS_CROSS_CARRIER_EVIDENCE",
        ),
        (
        ...
        (
            "second-carrier external result did not treat OK as cross-carrier evidence",
            {"selected_second_carrier_external_result_treated_ok_as_cross_carrier_evidence"},
            "SECOND_CARRIER_EXTERNAL_RESULT_TREATED_OK_AS_CROSS_CARRIER_EVIDENCE",
        ),
        (
            "second-carrier external result did not treat Ran 7 tests as cross-carrier evidence",
            {"selected_second_carrier_external_result_treated_ran_7_tests_as_cross_carrier_evidence"},
            "SECOND_CARRIER_EXTERNAL_RESULT_TREATED_RAN_7_TESTS_AS_CROSS_CARRIER_EVIDENCE",
        ),
    )
    ...
    basis_checks = (
        (
            "selected_cross_carrier_evidence_boundary_terminal_summary_basis",
            "cross-carrier evidence boundary terminal summary basis declared",
            "CROSS_CARRIER_EVIDENCE_BOUNDARY_BASIS_MISSING",
        ),
        (
            "selected_second_carrier_external_result_terminal_summary_basis",
    ...
    for field in ancillary_basis_fields:
        _check(checks, f"{field} declared", _basis_declared(request, field), "declared", request.get(field), "SECOND_CARRIER_OUTPUT_CAPTURE_BASIS_MISSING")
...
def _result_id(request: Mapping[str, Any]) -> str:
    value = request.get("cross_carrier_evidence_request_id")
...
def _build_result(
    ...
    scope_values = _scope_values(request.get("cross_carrier_evidence_scope"))

    result: dict[str, Any] = {
        "portable_source_body_verification_cross_carrier_evidence_metadata": {
            "portable_source_body_verification_cross_carrier_evidence_id": request_id,
            "portable_source_body_verification_cross_carrier_evidence_type": RESULT_TYPE,
            "portable_source_body_verification_cross_carrier_evidence_version": RESULT_VERSION,
    ...
    result["cross_carrier_evidence_scope"] = {
    ...
    result["cross_carrier_evidence_checks"] = checks
    result["cross_carrier_evidence_statement"] = statement
    result["cross_carrier_evidence_non_meaning"] = {key: False for key in NON_MEANING_KEYS}
    ...
    result["block"] = block
    result["portable_source_body_verification_cross_carrier_evidence_summary"] = (
        build_portable_source_body_verification_cross_carrier_evidence_summary(result)
    )
    return result
...
def resolve_portable_source_body_verification_cross_carrier_evidence(
    declared_cross_carrier_evidence_request: Mapping[str, Any] | None = None,
) -> dict:
    """Resolve one bounded cross-carrier evidence posture."""

    if declared_cross_carrier_evidence_request is None:
        return _malformed_result(
            "declared cross-carrier evidence request missing",
            "DECLARED_CROSS_CARRIER_EVIDENCE_REQUEST_MALFORMED",
        )
    if not isinstance(declared_cross_carrier_evidence_request, Mapping):
        return _malformed_result(
            "declared cross-carrier evidence request malformed",
            "DECLARED_CROSS_CARRIER_EVIDENCE_REQUEST_MALFORMED",
        )

    request = copy.deepcopy(dict(declared_cross_carrier_evidence_request))
    checks, block = _evaluate_request(request)
    requested_outcome = request.get("requested_cross_carrier_evidence_outcome")

    if block is not None:
        outcome = OUTCOME_BLOCKED
    elif request.get("cross_carrier_evidence_intent") == INTENT_DO_NOT_RECORD:
...
def resolve_portable_source_body_verification_cross_carrier_evidence_from_path(
    declared_cross_carrier_evidence_request_path: Path | str,
) -> dict:
    """Load a JSON object request from path and resolve it."""

    path = Path(declared_cross_carrier_evidence_request_path)
    try:
        raw_text = path.read_text(encoding="utf-8")
    except OSError as exc:
        raise PortableSourceBodyVerificationCrossCarrierEvidenceError(
            f"declared cross-carrier evidence request unreadable: {path}"
        ) from exc
    try:
        loaded = json.loads(raw_text)
    except json.JSONDecodeError as exc:
        raise PortableSourceBodyVerificationCrossCarrierEvidenceError(
            f"declared cross-carrier evidence request malformed JSON: {path}"
        ) from exc
    if not isinstance(loaded, Mapping):
        return _malformed_result(
            "declared cross-carrier evidence request path did not contain JSON object",
            "DECLARED_CROSS_CARRIER_EVIDENCE_REQUEST_MALFORMED",
        )
    return resolve_portable_source_body_verification_cross_carrier_evidence(loaded)
...
def build_portable_source_body_verification_cross_carrier_evidence_summary(
    result: Mapping[str, Any],
) -> dict:
    """Build a compact JSON-safe summary from a cross-carrier evidence result."""

    metadata = result.get("portable_source_body_verification_cross_carrier_evidence_metadata", {})
    declared = result.get("declared_cross_carrier_evidence_question", {})
    checks = result.get("cross_carrier_evidence_checks", [])
    statement = result.get("cross_carrier_evidence_statement", {})
    ...
    summary = {
        ...
        "request_id": metadata.get("portable_source_body_verification_cross_carrier_evidence_id"),
        "question": declared.get("question"),
        "intent": declared.get("intent"),
        "passed_check_count": passed_count,
        "failed_check_count": failed_count,
        "result_version": metadata.get(
            "portable_source_body_verification_cross_carrier_evidence_version",
            RESULT_VERSION,
        ),
        "resolver_module": metadata.get("resolver_module", RESOLVER_MODULE),
        "selected_cross_carrier_evidence_boundary_outcome": _selected_summary_value(
            result, "selected_cross_carrier_evidence_boundary_basis", "selected_cross_carrier_evidence_boundary_result_outcome"
        ),
        "selected_cross_carrier_evidence_boundary_version": _selected_summary_value(
            result, "selected_cross_carrier_evidence_boundary_basis", "selected_cross_carrier_evidence_boundary_result_version"
        ),
        "selected_cross_carrier_evidence_boundary_failed_check_count": _selected_summary_value(
            result, "selected_cross_carrier_evidence_boundary_basis", "selected_cross_carrier_evidence_boundary_failed_check_count"
        ),
        ...
        "predecessor_cross_carrier_evidence_resolver_failure_preserved": True,
        "predecessor_cross_carrier_evidence_resolver_not_repaired_hidden_or_claimed_passed": True,
        "predecessor_cross_carrier_evidence_v2_resolver_failure_preserved": True,
        "predecessor_cross_carrier_evidence_v2_test_failure_preserved": True,
        "predecessor_cross_carrier_evidence_v2_not_repaired_hidden_or_claimed_passed": True,
    }
...
def write_portable_source_body_verification_cross_carrier_evidence_result(
    result: Mapping[str, Any],
    ...
    if isinstance(metadata, Mapping):
        candidate = metadata.get("portable_source_body_verification_cross_carrier_evidence_id")
        if isinstance(candidate, str) and candidate.strip():
            request_id = candidate.strip()

    if output_path is None:
        base_path = OUTPUT_ROOT / f"{request_id}__portable_source_body_verification_cross_carrier_evidence_result.json"
    else:
...
def build_declared_portable_source_body_verification_cross_carrier_evidence_request(
    **overrides: Any,
) -> dict[str, Any]:
    """Build a valid declared request for one bounded cross-carrier evidence posture."""

    request: dict[str, Any] = {
        "cross_carrier_evidence_request_id": DEFAULT_REQUEST_ID,
        "cross_carrier_evidence_question": CORE_QUESTION,
        "cross_carrier_evidence_intent": INTENT_RECORD,
        "cross_carrier_evidence_scope": list(SUPPORTED_SCOPE_VALUES),
        "declared_non_claims": _non_claims(),
        "reference_shaped_input_posture": True,
        "requested_cross_carrier_evidence_outcome": OUTCOME_RECORDED,
        ...
        "selected_cross_carrier_evidence_boundary_result_version": RESULT_VERSION,
        "selected_cross_carrier_evidence_boundary_failed_check_count": 0,
        "selected_cross_carrier_evidence_boundary_declared_future_cross_carrier_evidence_review_step": True,
        "selected_cross_carrier_evidence_boundary_already_created_cross_carrier_evidence": False,
        "selected_cross_carrier_evidence_boundary_already_created_portable_verification_closure": False,
        "selected_cross_carrier_evidence_boundary_treated_boundary_as_cross_carrier_evidence": False,
        "selected_cross_carrier_evidence_boundary_treated_boundary_as_portable_verification_closure": False,
        "selected_cross_carrier_evidence_boundary_treated_string_zero_as_doctrine": False,
        "selected_cross_carrier_evidence_boundary_treated_returned_capture_as_cross_carrier_evidence": False,
        "selected_cross_carrier_evidence_boundary_treated_returned_capture_as_cross_carrier_proof": False,
        "selected_cross_carrier_evidence_boundary_zero_exit_code_not_cross_carrier_evidence": True,
        "selected_cross_carrier_evidence_boundary_string_zero_not_cross_carrier_evidence": True,
        "selected_cross_carrier_evidence_boundary_ok_not_cross_carrier_evidence": True,
        "selected_cross_carrier_evidence_boundary_ran_7_tests_not_cross_carrier_evidence": True,
        "selected_cross_carrier_evidence_boundary_returned_capture_not_cross_carrier_evidence": True,
        "selected_cross_carrier_evidence_boundary_official_enum_scope_strings_redacted": False,
        "selected_cross_carrier_evidence_boundary_predecessor_external_result_v1_failure_preserved": True,
        ...
        "selected_second_carrier_external_result_treated_zero_exit_code_as_cross_carrier_evidence": False,
        "selected_second_carrier_external_result_treated_string_zero_as_cross_carrier_evidence": False,
        "selected_second_carrier_external_result_treated_string_zero_as_doctrine": False,
        "selected_second_carrier_external_result_treated_ok_as_cross_carrier_evidence": False,
        "selected_second_carrier_external_result_treated_ran_7_tests_as_cross_carrier_evidence": False,
        ...
        "selected_second_carrier_verification_result_path": (
            "artifacts/integrity_host_v0_min_coexistence_portable_source_body_verification_"
            "second_carrier_verification/portable_source_body_verification_second_carrier_verification_result.json"
        ),
        "selected_second_carrier_verification_result_outcome": (
            EXPECTED_SECOND_CARRIER_VERIFICATION_OUTCOME
        ),
        ...
        "selected_second_carrier_success_result_path": (
            "artifacts/integrity_host_v0_min_coexistence_portable_source_body_verification_"
            "second_carrier_success/portable_source_body_verification_second_carrier_success_result.json"
        ),
        ...
        "selected_second_carrier_result_result_path": (
            "artifacts/integrity_host_v0_min_coexistence_portable_source_body_verification_"
            "second_carrier_result/portable_source_body_verification_second_carrier_result_result.json"
        ),
        ...
        "selected_returned_capture_working_directory": "/Users/second-carrier/IAMMAI-SYSTEM",
        "selected_returned_capture_started_at": "2026-05-11T00:00:00Z",
        "selected_returned_capture_completed_at": "2026-05-11T00:00:01Z",
    ...
    for field in SELECTED_BASIS_FIELDS:
        request[field] = {
            ...
            "does_not_create_source_authority_currentness_runtime_final_completion_or_follow_on": True,
        }
    ...
    request["selected_cross_carrier_evidence_boundary_basis"].update(
        {
            ...
            "one_future_cross_carrier_evidence_review_step_declared": True,
            "treated_string_zero_as_doctrine": False,
            "treated_returned_capture_as_cross_carrier_evidence": False,
            "treated_returned_capture_as_cross_carrier_proof": False,
        }
    )
    request["selected_cross_carrier_evidence_boundary_terminal_summary_basis"].update(
        {
            "cross_carrier_evidence_not_created": True,
            "cross_carrier_evidence_boundary_not_cross_carrier_evidence": True,
            "string_zero_not_cross_carrier_evidence": True,
            "string_zero_not_doctrine": True,
            "returned_capture_not_cross_carrier_evidence": True,
        }
    )
