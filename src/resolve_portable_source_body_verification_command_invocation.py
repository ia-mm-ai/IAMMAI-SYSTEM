"""Bounded portable source-body verification command invocation resolver.

This module records one command invocation event only. It may spend one
preserved one-shot command invocation authorization token exactly once, but it
does not execute a command, create command output, create command result, create
command success, create execution permission, create execution approval, reopen
the consumed request token, create a standing invocation lane, or create repeat
...
class PortableSourceBodyVerificationCommandInvocationError(Exception):
    """Raised for hard command-invocation resolver failures."""


RESOLVER_MODULE = "resolve_portable_source_body_verification_command_invocation"
RESULT_VERSION = "0.1.0"
RESULT_TYPE = "portable_source_body_verification_command_invocation_result"

PORTABLE_SOURCE_BODY_VERIFICATION_COMMAND_INVOCATION_ROOT = Path(
    "artifacts/integrity_host_v0_min_coexistence_portable_source_body_verification_command_invocation"
)
OUTPUT_ROOT = PORTABLE_SOURCE_BODY_VERIFICATION_COMMAND_INVOCATION_ROOT

CORE_COMMAND_INVOCATION_QUESTION = (
    "Can the preserved one-shot command invocation authorization token be spent exactly once to "
    "create one bounded command invocation event without executing the command, creating command "
    "output, command result, command success, execution permission, execution approval, standing "
    "invocation lane, repeat permission, source, authority, currentness, final completion, "
    "continuation, reusable permission, derivative reception, vessel relation, another reception "
    "request, or follow-on work?"
)

INTENT_RECORD = "RECORD_PORTABLE_SOURCE_BODY_VERIFICATION_COMMAND_INVOCATION"
INTENT_DO_NOT_RECORD = "DO_NOT_RECORD_PORTABLE_SOURCE_BODY_VERIFICATION_COMMAND_INVOCATION"
INTENT_BLOCK = "BLOCK_PORTABLE_SOURCE_BODY_VERIFICATION_COMMAND_INVOCATION"
SUPPORTED_INTENTS = frozenset({INTENT_RECORD, INTENT_DO_NOT_RECORD, INTENT_BLOCK})

OUTCOME_RECORDED = "PORTABLE_SOURCE_BODY_VERIFICATION_COMMAND_INVOCATION_RECORDED"
OUTCOME_NOT_RECORDED = "PORTABLE_SOURCE_BODY_VERIFICATION_COMMAND_INVOCATION_NOT_RECORDED"
OUTCOME_REQUIRES_ADDITIONAL_BASIS = (
    "PORTABLE_SOURCE_BODY_VERIFICATION_COMMAND_INVOCATION_REQUIRES_ADDITIONAL_BASIS"
)
OUTCOME_BLOCKED = "PORTABLE_SOURCE_BODY_VERIFICATION_COMMAND_INVOCATION_BLOCKED"
...
SUPPORTED_COMMAND_INVOCATION_SCOPE = (
    "COMMAND_INVOCATION_ONLY",
    ...
    "INVOCATION_IS_NOT_EXECUTION",
    "INVOCATION_IS_NOT_COMMAND_SUCCESS",
    "INVOCATION_IS_NOT_SOURCE",
    "INVOCATION_IS_NOT_AUTHORITY",
...
SUPPORTED_COMMAND_INVOCATION_SCOPE_SET = frozenset(SUPPORTED_COMMAND_INVOCATION_SCOPE)
...
BLOCK_CODES = frozenset(
    {
        ...
        "COMMAND_INVOCATION_BOUNDARY_AUTHORIZATION_TOKEN_NOT_PRESERVED",
        "COMMAND_INVOCATION_BOUNDARY_AUTHORIZATION_TOKEN_ALREADY_SPENT",
        "COMMAND_INVOCATION_BOUNDARY_TERMINAL_SUMMARY_MISSING",
        ...
        "COMMAND_INVOCATION_AUTHORIZATION_TOKEN_ALREADY_SPENT",
        ...
        "INVOCATION_ONLY_POSTURE_MISSING",
        "ONE_SHOT_TOKEN_SPEND_POSTURE_MISSING",
        "TOKEN_SPENT_EXACTLY_ONCE_POSTURE_MISSING",
        "NO_TOKEN_REUSE_POSTURE_MISSING",
        "NO_STANDING_LANE_POSTURE_MISSING",
        "NO_REPEAT_PERMISSION_POSTURE_MISSING",
        "UNSUPPORTED_COMMAND_INVOCATION_SCOPE",
        "COMMAND_EXECUTION_PERFORMED",
        "COMMAND_OUTPUT_CREATED",
        "COMMAND_RESULT_CREATED",
        "COMMAND_SUCCESS_CREATED",
...
def _authorization_token_already_spent(value: Mapping[str, Any]) -> bool:
    return _find_truthy(
        value,
        (
            "authorization_token_spent_here",
            "authorization_token_spent",
            "authorization_token_already_spent",
...
def _boundary_authorization_token_preserved(
    basis: Mapping[str, Any], request: Mapping[str, Any]
) -> bool:
    if "selected_command_invocation_boundary_authorization_token_preserved" in request:
        return request["selected_command_invocation_boundary_authorization_token_preserved"] is True
    return _find_truthy(
        basis,
        (
            "command_invocation_authorization_token_preserved",
            "authorization_token_preserved",
            "authorization_token_remains_one_shot",
        ),
    )


def _boundary_authorization_token_not_spent(
    basis: Mapping[str, Any], request: Mapping[str, Any]
) -> bool:
    if "selected_command_invocation_boundary_authorization_token_not_spent" in request:
        return request["selected_command_invocation_boundary_authorization_token_not_spent"] is True
    if _authorization_token_already_spent(basis):
        return False
    return _find_truthy(
        basis,
        (
            "authorization_token_not_spent",
            "authorization_token_not_spent_here",
...
def _supported_scope(scope: Any) -> bool:
    ...
    return bool(values) and all(value in SUPPORTED_COMMAND_INVOCATION_SCOPE_SET for value in values)
...
COLLAPSE_TRUE_BLOCKS = (
    ...
    ("authorization_token_reuse_created", "COMMAND_INVOCATION_AUTHORIZATION_TOKEN_REUSED"),
    ("authorization_token_reuse_permitted", "COMMAND_INVOCATION_AUTHORIZATION_TOKEN_REUSED"),
...
def _build_metadata(request: Mapping[str, Any], outcome: str) -> dict[str, Any]:
    request_id = str(request.get("command_invocation_request_id") or "undeclared")
    result_id = f"{request_id}__portable_source_body_verification_command_invocation_result"
    return {
        "portable_source_body_verification_command_invocation_result_id": result_id,
        "portable_source_body_verification_command_invocation_result_type": RESULT_TYPE,
        "portable_source_body_verification_command_invocation_result_version": RESULT_VERSION,
        "generated_at": _utc_now(),
        "resolver_module": RESOLVER_MODULE,
        "command_invocation_request_id": request_id,
        "naming_containment": {
        ...
        "requested_outcome": request.get("requested_command_invocation_outcome"),
        "outcome": outcome,
    }
...
def _statement(outcome: str) -> dict[str, Any]:
    ...
    statement["command_invocation_not_recorded"] = outcome == OUTCOME_NOT_RECORDED
    statement["command_invocation_requires_additional_basis"] = outcome == OUTCOME_REQUIRES_ADDITIONAL_BASIS
    statement["command_invocation_blocked"] = outcome == OUTCOME_BLOCKED
    statement["command_invocation_is_not_command_execution"] = True
    statement["command_invocation_is_not_command_output"] = True
    statement["command_invocation_is_not_command_result"] = True
    statement["command_invocation_is_not_command_success"] = True
    statement["command_invocation_is_not_execution_permission"] = True
    statement["command_invocation_is_not_execution_approval"] = True
    return statement
...
def _non_meaning() -> dict[str, bool]:
    ...
    return {f"command_invocation_does_not_mean_{name}": True for name in names}
...
def _scope_section(scope: Any, outcome: str) -> dict[str, Any]:
    values = _scope_values(scope)
    unsupported = [value for value in values if value not in SUPPORTED_COMMAND_INVOCATION_SCOPE_SET]
    return {
        "selected_scope_values": values,
        "supported_scope_values": list(SUPPORTED_COMMAND_INVOCATION_SCOPE),
        "unsupported_scope_values": unsupported,
        "all_selected_scope_values_supported": not unsupported and bool(values),
        "command_invocation_only": "COMMAND_INVOCATION_ONLY" in values,
        "bounded_command_invocation_event_recorded": outcome == OUTCOME_RECORDED,
        "one_shot_authorization_token_spent_exactly_once": outcome == OUTCOME_RECORDED,
        "authorization_token_reuse_not_created": True,
        ...
        "invocation_is_not_execution": True,
        "invocation_is_not_command_success": True,
        "invocation_is_not_source": True,
        "invocation_is_not_authority": True,
...
def _build_checks(request: Mapping[str, Any], request_malformed: bool = False) -> list[dict[str, Any]]:
    ...
    if request_malformed:
        _check(
            checks,
            "declared command invocation request mapping",
            False,
    ...
    boundary_basis = _mapping_from_basis(request.get("selected_command_invocation_boundary_basis"))
    boundary_summary = request.get("selected_command_invocation_boundary_terminal_summary_basis")
    authorization_basis = _mapping_from_basis(request.get("selected_command_invocation_authorization_basis"))
    authorization_summary = request.get("selected_command_invocation_authorization_terminal_summary_basis")
    ...
    question = request.get("command_invocation_question")
    intent = request.get("command_invocation_intent")
    _check(
        checks,
    ...
    boundary_outcome = _basis_outcome(
        boundary_basis,
        request,
        ("selected_command_invocation_boundary_result_outcome",),
    )
    _check(
        checks,
        "command invocation boundary live artifact recorded outcome",
        boundary_outcome == COMMAND_INVOCATION_BOUNDARY_OUTCOME,
        COMMAND_INVOCATION_BOUNDARY_OUTCOME,
        boundary_outcome,
        "COMMAND_INVOCATION_BOUNDARY_NOT_RECORDED",
    )
    boundary_failed = _basis_failed_count(
        boundary_basis,
        request,
        ("selected_command_invocation_boundary_failed_check_count",),
    )
    _check(
        checks,
    ...
    _check(
        ...
        _boundary_authorization_token_preserved(boundary_basis, request),
        "authorization token preserved",
        boundary_basis,
        "COMMAND_INVOCATION_BOUNDARY_AUTHORIZATION_TOKEN_NOT_PRESERVED",
    )
    _check(
        ...
        _boundary_authorization_token_not_spent(boundary_basis, request),
        "authorization token not spent in boundary",
        boundary_basis,
        "COMMAND_INVOCATION_BOUNDARY_AUTHORIZATION_TOKEN_ALREADY_SPENT",
    )
    ...
    _check(
        ...
        _basis_declared(authorization_basis),
        "authorization basis is declared",
        authorization_basis,
        "COMMAND_INVOCATION_AUTHORIZATION_BASIS_MISSING",
    )
    authorization_outcome = _basis_outcome(
        authorization_basis,
        request,
    ...
    _check(
        ...
        authorization_outcome == COMMAND_INVOCATION_AUTHORIZATION_OUTCOME,
        COMMAND_INVOCATION_AUTHORIZATION_OUTCOME,
        authorization_outcome,
        "COMMAND_INVOCATION_AUTHORIZATION_NOT_RECORDED",
    )
    authorization_failed = _basis_failed_count(
        authorization_basis,
        request,
    ...
    _check(
        ...
        _authorization_token_created(authorization_basis, request),
    ...
    _check(
        ...
        _authorization_token_one_shot(authorization_basis, request),
    ...
    _check(
        ...
        _present(authorization_summary),
        "authorization terminal summary basis is declared",
        authorization_summary,
        "COMMAND_INVOCATION_AUTHORIZATION_BASIS_MISSING",
    )
    _check(
        checks,
        "command invocation authorization token not already spent",
        not _authorization_token_already_spent(authorization_basis),
        "authorization token is not already spent before invocation",
        authorization_basis,
        "COMMAND_INVOCATION_AUTHORIZATION_TOKEN_ALREADY_SPENT",
    )
    _check(
        checks,
        "command invocation authorization token not reused",
        not _authorization_token_reused(authorization_basis),
        "authorization token is not reused",
        authorization_basis,
        "COMMAND_INVOCATION_AUTHORIZATION_TOKEN_REUSED",
    )
    ...
    consumption_failed = _basis_failed_count(consumption_basis, request, ("selected_request_consumption_failed_check_count",))
    _check(
        checks,
    ...
    _check(
        ...
        "v2 does not claim v1 passed",
        {"v1": v1_basis, "v2": v2_basis},
        "V1_CLAIMED_PASSED",
    )
    _check(
        checks,
        "v2 not treated as repairing v1",
        not _find_truthy(v1_basis, ("v2_treated_as_repairing_v1", "v1_repaired"))
    ...
    for check_name, key, block_code in basis_presence:
        _check(checks, check_name, _basis_declared(_mapping_from_basis(request.get(key))), "basis is declared", request.get(key), block_code)

    posture_presence = (
        ("invocation-only posture declared", "invocation_only_posture", "INVOCATION_ONLY_POSTURE_MISSING"),
        ("one-shot-token-spend posture declared", "one_shot_token_spend_posture", "ONE_SHOT_TOKEN_SPEND_POSTURE_MISSING"),
        ("token-spent-exactly-once posture declared", "token_spent_exactly_once_posture", "TOKEN_SPENT_EXACTLY_ONCE_POSTURE_MISSING"),
        ("no-token-reuse posture declared", "no_token_reuse_posture", "NO_TOKEN_REUSE_POSTURE_MISSING"),
    ...
    for check_name, key, block_code in posture_presence:
        _check(checks, check_name, _present(request.get(key)), "posture is declared", request.get(key), block_code)

    token_spend_posture = _mapping_from_basis(request.get("token_spent_exactly_once_posture"))
    no_reuse_posture = _mapping_from_basis(request.get("no_token_reuse_posture"))
    _check(
        checks,
        "authorization token spent exactly once",
        _find_truthy(token_spend_posture, ("authorization_token_spent_exactly_once", "token_spent_exactly_once")),
        "authorization token is spent exactly once in invocation result",
        token_spend_posture,
        "TOKEN_SPENT_EXACTLY_ONCE_POSTURE_MISSING",
    )
    _check(
        ...
        not _authorization_token_reused(no_reuse_posture)
        and _find_truthy(no_reuse_posture, ("authorization_token_reuse_blocked", "no_token_reuse", "authorization_token_not_reused")),
        "authorization token reuse is blocked",
        no_reuse_posture,
        "NO_TOKEN_REUSE_POSTURE_MISSING",
    )

    scope = request.get("command_invocation_scope")
    _check(
        checks,
        "command invocation scope supported",
        _supported_scope(scope),
        "all scope values are supported",
        scope,
        "UNSUPPORTED_COMMAND_INVOCATION_SCOPE",
    )

    collapse = _first_collapse_block(
        (
            request,
            ...
            consumption_basis,
            consumed_basis,
            request.get("invocation_only_posture"),
    ...
    _check(
        ...
        collapse is None,
        "no execution/output/result/success/reuse/mutation/overreach flags",
        collapse,
    ...
    _check(
        ...
        "full prior artifact body is not emitted",
...
def _select_outcome(
    ...
    if intent == INTENT_BLOCK:
        return OUTCOME_BLOCKED, "COMMAND_INVOCATION_BLOCKED_BY_REQUEST", str(
            request.get("block_reason") or "blocked by request intent"
        )
    if intent not in SUPPORTED_INTENTS:
        return OUTCOME_BLOCKED, "COMMAND_INVOCATION_INTENT_UNSUPPORTED", "unsupported command invocation intent"

    requested = request.get("requested_command_invocation_outcome", OUTCOME_RECORDED)
    if requested == OUTCOME_BLOCKED:
        return OUTCOME_BLOCKED, "COMMAND_INVOCATION_BLOCKED_BY_REQUEST", str(
            request.get("block_reason") or "blocked by requested outcome"
        )
    if requested not in OUTCOME_FAMILY:
        return OUTCOME_BLOCKED, "DECLARED_COMMAND_INVOCATION_REQUEST_MALFORMED", "unsupported requested outcome"

    first_failed = _first_failed_check(checks)
    if first_failed is not None:
        return OUTCOME_BLOCKED, str(first_failed.get("block_code")), str(first_failed.get("check_name"))
...
def _passed_failed_counts(checks: Sequence[Mapping[str, Any]]) -> tuple[int, int]:
    passed = sum(1 for check in checks if check.get("passed") is True)
    return passed, len(checks) - passed


def _summary_source_counts(result: Mapping[str, Any]) -> tuple[int, int]:
    checks = result.get("command_invocation_checks")
    if isinstance(checks, Sequence) and not isinstance(checks, (str, bytes, bytearray)):
        return _passed_failed_counts([check for check in checks if isinstance(check, Mapping)])
    return 0, 0


def build_portable_source_body_verification_command_invocation_summary(
    result: Mapping[str, Any]
) -> dict[str, Any]:
    """Build a bounded summary of a command-invocation result."""

    statement = _mapping_from_basis(result.get("command_invocation_statement"))
    block = _mapping_from_basis(result.get("block"))
    metadata = _mapping_from_basis(result.get("portable_source_body_verification_command_invocation_metadata"))
    question = _mapping_from_basis(result.get("declared_command_invocation_question"))
    non_claims = _mapping_from_basis(result.get("non_claims"))
    boundary_basis = _mapping_from_basis(result.get("selected_command_invocation_boundary_basis"))
    authorization_basis = _mapping_from_basis(result.get("selected_command_invocation_authorization_basis"))
    ...
    passed, failed = _summary_source_counts(result)
    outcome = result.get("outcome")
    return {
        "outcome": outcome,
        "block_code": block.get("code"),
        "block_reason": block.get("reason"),
        "command_invocation_request_id": metadata.get("command_invocation_request_id"),
        "command_invocation_question": question.get("question"),
        "command_invocation_intent": question.get("intent"),
        "passed_check_count": passed,
        "failed_check_count": failed,
        "command_invocation_recorded": statement.get("command_invocation_recorded") is True,
        "bounded_command_invocation_event_recorded": statement.get("bounded_command_invocation_event_recorded") is True,
        "authorization_token_spent_exactly_once": statement.get("authorization_token_spent_exactly_once") is True,
        ...
        "selected_command_invocation_boundary_outcome": _find_first(boundary_basis, ("outcome", "result_outcome")),
        "selected_command_invocation_boundary_failed_check_count": _find_first(
            boundary_basis, ("failed_check_count", "selected_failed_check_count")
        ),
        "selected_command_invocation_authorization_outcome": _find_first(
            authorization_basis, ("outcome", "result_outcome")
        ),
        "selected_command_invocation_authorization_failed_check_count": _find_first(
            authorization_basis, ("failed_check_count", "selected_failed_check_count")
        ),
        "selected_request_consumption_outcome": _find_first(consumption_basis, ("outcome", "result_outcome")),
        "selected_request_consumption_failed_check_count": _find_first(
            consumption_basis, ("failed_check_count", "selected_failed_check_count")
        ),
        "selected_v2_admitted_request_outcome": _find_first(v2_basis, ("outcome", "result_outcome")),
        "selected_v2_admitted_request_version": _find_first(v2_basis, ("result_version", "version")),
        "selected_v2_admitted_request_failed_check_count": _find_first(
            v2_basis, ("failed_check_count", "selected_failed_check_count")
        ),
        "command_execution_not_performed": non_claims.get("command_execution_performed") is False,
        "command_output_result_success_not_created": all(
            non_claims.get(key) is False
            for key in ("command_output_created", "command_result_created", "command_success_created")
        ),
        "execution_permission_not_created_non_claim": non_claims.get("execution_permission_created") is False,
        "execution_approval_not_created_non_claim": non_claims.get("execution_approval_created") is False,
        "authorization_token_not_reused": non_claims.get("authorization_token_reused") is False,
        ...
        "invocation_not_execution": non_claims.get("invocation_treated_as_execution") is False,
        "invocation_not_command_success": non_claims.get("invocation_treated_as_command_success") is False,
        "invocation_not_source": non_claims.get("invocation_treated_as_source") is False,
        "invocation_not_authority": non_claims.get("invocation_treated_as_authority") is False,
        "v1_not_repaired_hidden_or_claimed_passed": all(
            non_claims.get(key) is False for key in ("v1_repaired", "v1_hidden", "v1_claimed_passed")
        ),
        ...
        "no_continuation_publication_flow_reusable_permission": all(
            non_claims.get(key) is False
            for key in ("continuation_authorized", "publication_flow_opened", "reusable_permission_created")
        ),
...
def _build_result(
    ...
    *,
    ...
    metadata = _build_metadata(request, outcome)
    if request_path:
        metadata["declared_command_invocation_request_path"] = request_path
    statement = _statement(outcome)
    non_claims = _default_non_claims()
    declared_non_claims = _declared_non_claims(request)
    for key in REQUIRED_FALSE_NON_CLAIMS:
        if declared_non_claims.get(key) is False:
            non_claims[key] = False

    boundary_basis = _basis_section(
        request.get("selected_command_invocation_boundary_basis"),
        path=request.get("selected_command_invocation_boundary_result_path"),
        extra={
            "selected_result_id": request.get("selected_command_invocation_boundary_result_id"),
            "selected_result_outcome": request.get("selected_command_invocation_boundary_result_outcome"),
            "selected_failed_check_count": request.get("selected_command_invocation_boundary_failed_check_count"),
            "authorization_token_preserved": request.get(
                "selected_command_invocation_boundary_authorization_token_preserved"
            ),
            "authorization_token_not_spent": request.get(
                "selected_command_invocation_boundary_authorization_token_not_spent"
            ),
    ...
    authorization_basis = _basis_section(
        ...
        extra={
            "selected_result_id": request.get("selected_command_invocation_authorization_result_id"),
            "selected_result_outcome": request.get("selected_command_invocation_authorization_result_outcome"),
            "selected_failed_check_count": request.get("selected_command_invocation_authorization_failed_check_count"),
            "selected_authorization_token_created": request.get(
                "selected_command_invocation_authorization_token_created"
            ),
            "selected_authorization_token_is_one_shot": request.get(
    ...
    result = {
        "portable_source_body_verification_command_invocation_metadata": metadata,
        "declared_command_invocation_question": {
            "question": request.get("command_invocation_question"),
            "expected_question": CORE_COMMAND_INVOCATION_QUESTION,
            "intent": request.get("command_invocation_intent"),
            "command_invocation_is_not_command_execution": True,
            "command_invocation_is_not_command_output": True,
            "command_invocation_is_not_command_result": True,
            "command_invocation_is_not_command_success": True,
        },
        "selected_command_invocation_boundary_basis": boundary_basis,
        "selected_command_invocation_boundary_terminal_summary_basis": _basis_section(
            request.get("selected_command_invocation_boundary_terminal_summary_basis"),
            path=request.get("selected_command_invocation_boundary_terminal_summary_path"),
            extra={"terminal_summary_remains_readability_basis_only": True},
        ),
        "selected_command_invocation_authorization_basis": authorization_basis,
        ...
        "selected_v2_admitted_request_basis": v2_basis,
        ...
        "invocation_only_posture": _posture_section(
            request.get("invocation_only_posture"),
            extra={"command_invocation_only": True, "command_invocation_is_not_execution": True},
        ),
        "one_shot_token_spend_posture": _posture_section(
            request.get("one_shot_token_spend_posture"),
            extra={"one_shot_token_spend_posture_declared": True},
        ),
        "token_spent_exactly_once_posture": _posture_section(
            request.get("token_spent_exactly_once_posture"),
            extra={"authorization_token_spent_exactly_once": outcome == OUTCOME_RECORDED},
        ),
        "no_token_reuse_posture": _posture_section(
            request.get("no_token_reuse_posture"),
        ...
        "no_command_execution_posture": _posture_section(
            request.get("no_command_execution_posture"), extra={"command_execution_not_performed": True}
        ),
        ...
        "no_execution_permission_posture": _posture_section(
            request.get("no_execution_permission_posture"), extra={"execution_permission_not_created": True}
        ),
        "no_execution_approval_posture": _posture_section(
            request.get("no_execution_approval_posture"), extra={"execution_approval_not_created": True}
        ),
        "no_standing_lane_posture": _posture_section(
            request.get("no_standing_lane_posture"), extra={"standing_invocation_lane_created": False}
        ),
        "no_repeat_permission_posture": _posture_section(
            request.get("no_repeat_permission_posture"), extra={"repeat_invocation_permission_created": False}
        ),
        ...
        "command_invocation_scope": _scope_section(request.get("command_invocation_scope"), outcome),
        "command_invocation_checks": _sanitize_reference_shape(list(checks)),
        "command_invocation_statement": statement,
        "command_invocation_non_meaning": _non_meaning(),
    ...
    result["portable_source_body_verification_command_invocation_summary"] = (
        build_portable_source_body_verification_command_invocation_summary(result)
    )
    return result


def resolve_portable_source_body_verification_command_invocation(
    declared_command_invocation_request: Mapping[str, Any] | None = None,
) -> dict:
    """Resolve one bounded portable source-body verification command invocation request."""

    if declared_command_invocation_request is None:
        request: Mapping[str, Any] = {}
        checks = _build_checks(request)
        outcome, block_code, block_reason = _select_outcome(
            request, checks, forced_block="COMMAND_INVOCATION_QUESTION_UNDECLARED"
        )
    ...
    if not isinstance(declared_command_invocation_request, Mapping):
        request = {}
        checks = _build_checks(request, request_malformed=True)
        outcome, block_code, block_reason = _select_outcome(
            request, checks, forced_block="DECLARED_COMMAND_INVOCATION_REQUEST_MALFORMED"
        )
        return _build_result(
            request,
            checks=checks,
    ...
    request = _deepcopy(declared_command_invocation_request)
    checks = _build_checks(request)
    outcome, block_code, block_reason = _select_outcome(request, checks)
    return _build_result(
        request,
        checks=checks,
        outcome=outcome,
...
def resolve_portable_source_body_verification_command_invocation_from_path(
    declared_command_invocation_request_path: Path | str,
) -> dict:
    """Resolve one command-invocation request loaded from a JSON object path."""

    path = Path(declared_command_invocation_request_path)
    try:
        loaded = json.loads(path.read_text(encoding="utf-8"))
    except OSError:
        request: dict[str, Any] = {"command_invocation_request_id": "unreadable_path"}
        checks = _build_checks(request)
        outcome, block_code, block_reason = _select_outcome(
            request, checks, forced_block="DECLARED_COMMAND_INVOCATION_REQUEST_UNREADABLE"
        )
        return _build_result(
            request,
            checks=checks,
        ...
        request = {"command_invocation_request_id": "malformed_json"}
        checks = _build_checks(request)
        outcome, block_code, block_reason = _select_outcome(
            request, checks, forced_block="DECLARED_COMMAND_INVOCATION_REQUEST_MALFORMED"
        )
    ...
    if not isinstance(loaded, Mapping):
        request = {"command_invocation_request_id": "non_object_json"}
        checks = _build_checks(request, request_malformed=True)
        outcome, block_code, block_reason = _select_outcome(
            request, checks, forced_block="DECLARED_COMMAND_INVOCATION_REQUEST_MALFORMED"
        )
...
def write_portable_source_body_verification_command_invocation_result(
    result: Mapping[str, Any], output_path: Path | str | None = None
) -> Path:
    """Write a command-invocation result JSON without silently overwriting."""

    if output_path is None:
        metadata = _mapping_from_basis(
            result.get("portable_source_body_verification_command_invocation_metadata")
        )
        request_id = metadata.get("command_invocation_request_id") or "undeclared_command_invocation_request"
        filename = (
            f"{_safe_component(request_id, 'undeclared_command_invocation_request')}"
            "__portable_source_body_verification_command_invocation_result.json"
        )
        path = PORTABLE_SOURCE_BODY_VERIFICATION_COMMAND_INVOCATION_ROOT / filename
    else:
...
def build_declared_portable_source_body_verification_command_invocation_request(
    command_invocation_request_id: str,
    command_invocation_question: str,
    selected_command_invocation_boundary_basis: Mapping[str, Any] | str,
    selected_command_invocation_boundary_terminal_summary_basis: Mapping[str, Any] | str,
    ...
    invocation_only_posture: Mapping[str, Any] | str,
    one_shot_token_spend_posture: Mapping[str, Any] | str,
    token_spent_exactly_once_posture: Mapping[str, Any] | str,
    no_token_reuse_posture: Mapping[str, Any] | str,
    ...
    command_invocation_scope: Sequence[str] | Mapping[str, Any],
    command_invocation_intent: str = INTENT_RECORD,
    *,
    selected_command_invocation_boundary_result_path: str | None = None,
    selected_command_invocation_boundary_result_id: str | None = None,
    selected_command_invocation_boundary_result_outcome: str | None = None,
    selected_command_invocation_boundary_failed_check_count: int | None = None,
    selected_command_invocation_boundary_authorization_token_preserved: bool | None = None,
    selected_command_invocation_boundary_authorization_token_not_spent: bool | None = None,
    selected_command_invocation_boundary_terminal_summary_path: str | None = None,
    ...
    selected_command_invocation_authorization_terminal_summary_path: str | None = None,
    ...
    selected_v2_successor_metadata: Mapping[str, Any] | None = None,
    selected_v1_predecessor_artifact_path: str | None = None,
    selected_v1_predecessor_artifact_id: str | None = None,
    selected_v1_predecessor_outcome: str | None = None,
    selected_command_execution_boundary_result_path: str | None = None,
    selected_command_report_path: str | None = None,
    selected_command_implementation_boundary_result_path: str | None = None,
    selected_command_boundary_result_path: str | None = None,
    selected_artifact_emission_containment_result_path: str | None = None,
    selected_evidence_manifest_result_path: str | None = None,
    selected_portable_verification_result_path: str | None = None,
    reference_shaped_input_posture: Mapping[str, Any] | str | None = None,
    requested_command_invocation_outcome: str = OUTCOME_RECORDED,
    additional_basis_context: Mapping[str, Any] | None = None,
    not_recorded_basis: Mapping[str, Any] | str | None = None,
) -> dict:
    """Build a declared command-invocation request with explicit false non-claims."""

    request: dict[str, Any] = {
        "command_invocation_request_id": command_invocation_request_id,
        "command_invocation_question": command_invocation_question,
        "command_invocation_intent": command_invocation_intent,
        "selected_command_invocation_boundary_basis": _deepcopy(selected_command_invocation_boundary_basis),
        "selected_command_invocation_boundary_terminal_summary_basis": _deepcopy(
        ...
        "invocation_only_posture": _deepcopy(invocation_only_posture),
        "one_shot_token_spend_posture": _deepcopy(one_shot_token_spend_posture),
        "token_spent_exactly_once_posture": _deepcopy(token_spent_exactly_once_posture),
        "no_token_reuse_posture": _deepcopy(no_token_reuse_posture),
        ...
        "command_invocation_scope": _deepcopy(command_invocation_scope),
        "requested_command_invocation_outcome": requested_command_invocation_outcome,
        "declared_non_claims": _default_non_claims(),
    }
    optional_fields = {
        "selected_command_invocation_boundary_result_path": selected_command_invocation_boundary_result_path,
        "selected_command_invocation_boundary_result_id": selected_command_invocation_boundary_result_id,
        "selected_command_invocation_boundary_result_outcome": selected_command_invocation_boundary_result_outcome,
        "selected_command_invocation_boundary_failed_check_count": selected_command_invocation_boundary_failed_check_count,
        "selected_command_invocation_boundary_authorization_token_preserved": (
            selected_command_invocation_boundary_authorization_token_preserved
        ),
        "selected_command_invocation_boundary_authorization_token_not_spent": (
        ...
        "selected_command_invocation_boundary_terminal_summary_path": (
            selected_command_invocation_boundary_terminal_summary_path
        ),
        ...
        "selected_command_invocation_authorization_terminal_summary_path": (
            selected_command_invocation_authorization_terminal_summary_path
        ),
        ...
        "selected_v2_successor_metadata": _deepcopy(selected_v2_successor_metadata),
        "selected_v1_predecessor_artifact_path": selected_v1_predecessor_artifact_path,
        "selected_v1_predecessor_artifact_id": selected_v1_predecessor_artifact_id,
        "selected_v1_predecessor_outcome": selected_v1_predecessor_outcome,
        "selected_command_execution_boundary_result_path": selected_command_execution_boundary_result_path,
        "selected_command_report_path": selected_command_report_path,
        ...
        "selected_artifact_emission_containment_result_path": selected_artifact_emission_containment_result_path,
        ...
        "reference_shaped_input_posture": _deepcopy(reference_shaped_input_posture),
        "additional_basis_context": _deepcopy(additional_basis_context),
        "not_recorded_basis": _deepcopy(not_recorded_basis),
    }
