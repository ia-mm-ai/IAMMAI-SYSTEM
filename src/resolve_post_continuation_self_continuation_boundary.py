"""Resolve one bounded post-continuation self-continuation-boundary posture.

This module is downstream of the post-reusable-runtime-permission continuation
line.  It records, at most, one bounded boundary posture that a future
self-continuation review may later be approached.  It does not authorize
self-continuation, self-recursive growth, runtime daemon or loop behavior,
...
class PostContinuationSelfContinuationBoundaryError(Exception):
    """Raised for bounded self-continuation-boundary resolver I/O errors."""


RESULT_VERSION = "0.1.0"
RESOLVER_MODULE = "resolve_post_continuation_self_continuation_boundary"

OUTCOME_RECORDED = "POST_CONTINUATION_SELF_CONTINUATION_BOUNDARY_RECORDED"
OUTCOME_NOT_RECORDED = "POST_CONTINUATION_SELF_CONTINUATION_BOUNDARY_NOT_RECORDED"
OUTCOME_REQUIRES_ADDITIONAL_BASIS = (
    "POST_CONTINUATION_SELF_CONTINUATION_BOUNDARY_REQUIRES_ADDITIONAL_BASIS"
)
OUTCOME_BLOCKED = "POST_CONTINUATION_SELF_CONTINUATION_BOUNDARY_BLOCKED"
OUTCOME_FAMILY = (
    OUTCOME_RECORDED,
...
INTENT_RECORD = "RECORD_POST_CONTINUATION_SELF_CONTINUATION_BOUNDARY"
INTENT_DO_NOT_RECORD = "DO_NOT_RECORD_POST_CONTINUATION_SELF_CONTINUATION_BOUNDARY"
INTENT_BLOCK = "BLOCK_POST_CONTINUATION_SELF_CONTINUATION_BOUNDARY"
SUPPORTED_INTENTS = (INTENT_RECORD, INTENT_DO_NOT_RECORD, INTENT_BLOCK)

SELF_CONTINUATION_BOUNDARY_QUESTION = (
    "Can the clean post-continuation basis be bounded for one future "
    "self-continuation review without authorizing self-continuation, "
...
SUPPORTED_SELF_CONTINUATION_BOUNDARY_SCOPE = SUPPORTED_SCOPE_VALUES
...
REQUIRED_FALSE_NON_CLAIMS = (
    ...
    "self_continuation_boundary_treated_as_runtime_daemon",
    "self_continuation_boundary_treated_as_runtime_loop",
    "self_continuation_boundary_treated_as_public_api",
    "self_continuation_boundary_treated_as_participant_facing_interface",
    "self_continuation_boundary_treated_as_distributed_network_behavior",
...
BLOCK_CODES = (
    ...
    "SELF_CONTINUATION_BOUNDARY_EXPLICIT_BLOCK_REQUESTED",
    ...
    "CONTINUATION_TERMINAL_SUMMARY_DID_NOT_PRESERVE_NO_SELF_CONTINUATION",
    "CONTINUATION_TERMINAL_SUMMARY_DID_NOT_REQUIRE_FRESH_ADMISSION",
    "CONTINUATION_TERMINAL_SUMMARY_DID_NOT_REQUIRE_SEPARATE_REVIEW",
    "BOUNDED_CONTINUATION_ENVELOPE_TREATED_AS_SELF_CONTINUATION",
    "BOUNDED_CONTINUATION_ENVELOPE_AUTHORIZED_SELF_CONTINUATION",
    "BOUNDED_CONTINUATION_ENVELOPE_AUTHORIZED_SELF_RECURSIVE_GROWTH",
    "BOUNDED_CONTINUATION_ENVELOPE_AUTHORIZED_ARBITRARY_RUNTIME_ACTIVITY",
    ...
    "SELF_CONTINUATION_BOUNDARY_REQUIRED_POSTURE_MISSING",
    "SELF_CONTINUATION_BOUNDARY_CREATED_BEFORE_REVIEW",
    "SELF_CONTINUATION_AUTHORIZED",
    "SELF_RECURSIVE_GROWTH_CREATED",
    "RUNTIME_DAEMON_CREATED",
...
POSTURE_FIELD_TO_STATEMENT_FIELD = {
    "self_continuation_boundary_spec_only_posture": "self_continuation_boundary_recorded",
    "one_future_self_continuation_review_posture": "one_future_self_continuation_review_declared",
    "continuation_basis_preserved_posture": "continuation_basis_preserved",
    "continuation_not_self_continuation_posture": "continuation_not_self_continuation",
    ...
    "self_continuation_not_authorized_posture": "self_continuation_not_authorized",
...
FALSE_INPUT_CHECKS = (
    ("self_continuation_boundary_created_before_review", "SELF_CONTINUATION_BOUNDARY_CREATED_BEFORE_REVIEW"),
    ...
    ("self_continuation_boundary_treated_as_source", "SELF_CONTINUATION_BOUNDARY_TREATED_AS_SOURCE"),
    (
        "self_continuation_boundary_treated_as_authority",
        "SELF_CONTINUATION_BOUNDARY_TREATED_AS_AUTHORITY",
    ),
...
DEFAULT_REQUEST_ID = "post_continuation_self_continuation_boundary_reference_review_001"
...
def _flag_false(request: Mapping[str, Any], key: str) -> bool:
...
def _first_failed_code(checks: list[dict[str, Any]]) -> str | None:
    for check in checks:
        if check.get("passed") is not True:
            ...
            return str(code) if code else "DECLARED_SELF_CONTINUATION_BOUNDARY_REQUEST_MALFORMED"
    return None
...
def _basis_summary(request: Mapping[str, Any], field: str, *, basis_only: bool = True) -> dict[str, Any]:
    ...
    if isinstance(summary, dict):
        ...
        summary.setdefault("selected_basis_reference_shape", bool(request.get("reference_shaped_input_posture", True)))
    return summary
...
def _validate_base_request(request: Mapping[str, Any], checks: list[dict[str, Any]]) -> None:
    question = request.get("self_continuation_boundary_question")
    _check(
        checks,
        "self-continuation-boundary question declared",
        question == SELF_CONTINUATION_BOUNDARY_QUESTION,
        SELF_CONTINUATION_BOUNDARY_QUESTION,
        question,
        "SELF_CONTINUATION_BOUNDARY_QUESTION_UNDECLARED",
    )

    intent = request.get("self_continuation_boundary_intent")
    _check(
        checks,
        "self-continuation-boundary intent supported",
    ...
    scopes = _scope_list(request.get("self_continuation_boundary_scope"))
    unsupported = [scope for scope in scopes if scope not in SUPPORTED_SCOPE_VALUES]
    _check(
        checks,
        "self-continuation-boundary scope supported",
        not unsupported,
...
def _validate_continuation_basis(request: Mapping[str, Any], checks: list[dict[str, Any]]) -> None:
    ...
    _check(
        ...
        request.get("selected_continuation_bounded_continuation_envelope_recorded") is True,
        True,
    ...
    continuation_false_checks = (
        ("selected_continuation_already_authorized_self_continuation", "CONTINUATION_ALREADY_AUTHORIZED_SELF_CONTINUATION"),
        ("selected_continuation_already_created_self_recursive_growth", "CONTINUATION_ALREADY_CREATED_SELF_RECURSIVE_GROWTH"),
        ("selected_continuation_already_created_runtime_daemon", "CONTINUATION_ALREADY_CREATED_RUNTIME_DAEMON"),
        ("selected_continuation_already_created_runtime_loop", "CONTINUATION_ALREADY_CREATED_RUNTIME_LOOP"),
        ("selected_continuation_already_created_public_api", "CONTINUATION_ALREADY_CREATED_PUBLIC_API"),
        (
        ...
        ("selected_continuation_treated_as_self_continuation", "CONTINUATION_TREATED_AS_SELF_CONTINUATION"),
        ("selected_continuation_treated_as_self_recursive_growth", "CONTINUATION_TREATED_AS_SELF_RECURSIVE_GROWTH"),
        ("selected_continuation_treated_as_runtime_daemon", "CONTINUATION_TREATED_AS_RUNTIME_DAEMON"),
        ("selected_continuation_treated_as_runtime_loop", "CONTINUATION_TREATED_AS_RUNTIME_LOOP"),
        ("selected_continuation_treated_as_public_api", "CONTINUATION_TREATED_AS_PUBLIC_API"),
        (
            "selected_continuation_treated_as_participant_facing_interface",
            "CONTINUATION_TREATED_AS_PARTICIPANT_FACING_INTERFACE",
        ),
        (
            "selected_continuation_treated_as_distributed_network_behavior",
            "CONTINUATION_TREATED_AS_DISTRIBUTED_NETWORK_BEHAVIOR",
        ),
        ("selected_continuation_authorized_future_work", "CONTINUATION_AUTHORIZED_FUTURE_WORK"),
        (
            "selected_bounded_continuation_envelope_treated_as_self_continuation",
            "BOUNDED_CONTINUATION_ENVELOPE_TREATED_AS_SELF_CONTINUATION",
        ),
        (
            "selected_bounded_continuation_envelope_authorized_self_continuation",
            "BOUNDED_CONTINUATION_ENVELOPE_AUTHORIZED_SELF_CONTINUATION",
        ),
        (
            "selected_bounded_continuation_envelope_authorized_self_recursive_growth",
            "BOUNDED_CONTINUATION_ENVELOPE_AUTHORIZED_SELF_RECURSIVE_GROWTH",
        ),
        (
            "selected_bounded_continuation_envelope_authorized_arbitrary_runtime_activity",
            "BOUNDED_CONTINUATION_ENVELOPE_AUTHORIZED_ARBITRARY_RUNTIME_ACTIVITY",
        ),
    )
    ...
    _check(
        checks,
        "continuation canonicalized result-level non-claims",
        request.get("selected_continuation_non_claims_canonicalized") is True,
        True,
        request.get("selected_continuation_non_claims_canonicalized"),
        "NON_CLAIM_MISSING_OR_FLIPPED",
    )
    _check(
        checks,
        "continuation terminal summary preserves no self-continuation",
        request.get("selected_continuation_terminal_summary_self_continuation_not_authorized") is True
        and request.get("selected_continuation_terminal_summary_no_self_continuation_selected") is True,
        True,
        {
            "self_continuation_not_authorized": request.get(
                "selected_continuation_terminal_summary_self_continuation_not_authorized"
            ),
            "no_self_continuation_selected": request.get(
                "selected_continuation_terminal_summary_no_self_continuation_selected"
            ),
        },
        "CONTINUATION_TERMINAL_SUMMARY_DID_NOT_PRESERVE_NO_SELF_CONTINUATION",
    )
    _check(
        checks,
        "continuation terminal summary requires fresh admission outside envelope",
        request.get("selected_continuation_terminal_summary_anything_outside_envelope_requires_fresh_admission")
        is True,
        True,
        request.get("selected_continuation_terminal_summary_anything_outside_envelope_requires_fresh_admission"),
        "CONTINUATION_TERMINAL_SUMMARY_DID_NOT_REQUIRE_FRESH_ADMISSION",
    ...
    _check(
        checks,
        "continuation terminal summary requires separate future review",
        request.get("selected_continuation_terminal_summary_future_work_requires_separate_step_back_review")
        is True,
        True,
        request.get("selected_continuation_terminal_summary_future_work_requires_separate_step_back_review"),
        "CONTINUATION_TERMINAL_SUMMARY_DID_NOT_REQUIRE_SEPARATE_REVIEW",
...
def _determine_outcome(request: Mapping[str, Any], checks: list[dict[str, Any]]) -> str:
    ...
    requested = request.get("requested_self_continuation_boundary_outcome")
    if requested == OUTCOME_NOT_RECORDED or request.get("self_continuation_boundary_intent") == INTENT_DO_NOT_RECORD:
...
def _statement_for_outcome(outcome: str) -> dict[str, bool]:
    ...
    statement["self_continuation_boundary_recorded"] = recorded
    statement["one_future_self_continuation_review_declared"] = recorded
    return statement
...
def _non_meaning() -> dict[str, bool]:
    return {
        ...
        "authorizes_line_to_continue_itself": False,
...
def _additional_basis_required(outcome: str, request: Mapping[str, Any]) -> dict[str, Any]:
    return {
        ...
        "does_not_authorize_self_continuation": True,
...
def _what_remains_open() -> list[str]:
    return [
        "self-continuation-boundary resolver tests",
        "self-continuation-boundary live artifact",
        "self-continuation-boundary terminal summary, if separately selected",
        "self-continuation specification",
        "self-continuation resolver/test/live artifact",
...
def _block_for_outcome(outcome: str, checks: list[dict[str, Any]], request: Mapping[str, Any]) -> dict[str, Any] | None:
    if outcome != OUTCOME_BLOCKED:
        return None
    code = _first_failed_code(checks) or "DECLARED_SELF_CONTINUATION_BOUNDARY_REQUEST_MALFORMED"
    return {
        "blocked": True,
        "block_code": code,
...
def _build_metadata(request: Mapping[str, Any]) -> dict[str, Any]:
    request_id = str(request.get("self_continuation_boundary_request_id") or DEFAULT_REQUEST_ID)
    return {
        "post_continuation_self_continuation_boundary_id": request_id,
        "post_continuation_self_continuation_boundary_type": (
            "post_continuation_self_continuation_boundary"
        ),
        "post_continuation_self_continuation_boundary_version": RESULT_VERSION,
...
def _build_result(request: Mapping[str, Any], checks: list[dict[str, Any]], outcome: str) -> dict[str, Any]:
    ...
    result: dict[str, Any] = {
        "post_continuation_self_continuation_boundary_metadata": metadata,
        "declared_self_continuation_boundary_question": {
            "self_continuation_boundary_request_id": metadata[
                "post_continuation_self_continuation_boundary_id"
            ],
            "question": request.get("self_continuation_boundary_question"),
            "intent": request.get("self_continuation_boundary_intent"),
            "bounded_question_only": True,
        },
        "selected_continuation_basis": _basis_summary(request, "selected_continuation_basis"),
        "selected_continuation_terminal_summary_basis": _basis_summary(
            request, "selected_continuation_terminal_summary_basis"
        ),
        "selected_continuation_boundary_basis": _basis_summary(
            request, "selected_continuation_boundary_basis"
        ),
        "selected_reusable_runtime_permission_basis": _basis_summary(
            request, "selected_reusable_runtime_permission_basis"
        ),
        "selected_reusable_runtime_permission_boundary_basis": _basis_summary(
            request, "selected_reusable_runtime_permission_boundary_basis"
        ),
        "selected_ongoing_runtime_basis": _basis_summary(request, "selected_ongoing_runtime_basis"),
        "selected_runtime_hosting_basis": _basis_summary(request, "selected_runtime_hosting_basis"),
        "selected_runtime_hosting_boundary_v2_basis": _basis_summary(
            request, "selected_runtime_hosting_boundary_v2_basis"
        ),
        "selected_runtime_hosting_boundary_v1_failure_lineage_basis": _basis_summary(
            request, "selected_runtime_hosting_boundary_v1_failure_lineage_basis"
        ),
        "selected_successor_runtime_step_basis": _basis_summary(
            request, "selected_successor_runtime_step_basis"
        ),
        "selected_minimal_runtime_basis": _basis_summary(request, "selected_minimal_runtime_basis"),
        "selected_runtime_boundary_basis": _basis_summary(request, "selected_runtime_boundary_basis"),
        "selected_runtime_readiness_basis": _basis_summary(
            request, "selected_runtime_readiness_basis"
        ),
        "selected_portable_verification_final_completion_basis": _basis_summary(
            request, "selected_portable_verification_final_completion_basis"
        ),
        "selected_post_portable_verification_currentness_basis": _basis_summary(
            request, "selected_post_portable_verification_currentness_basis"
        ),
        "selected_returned_second_carrier_capture_lineage_basis": _basis_summary(
    ...
    result.update(
        {
            "self_continuation_boundary_scope": _scope_list(
                request.get("self_continuation_boundary_scope")
            ),
            "self_continuation_boundary_checks": checks,
            "self_continuation_boundary_statement": statement,
            "self_continuation_boundary_non_meaning": _non_meaning(),
    ...
    result["post_continuation_self_continuation_boundary_summary"] = (
        build_post_continuation_self_continuation_boundary_summary(result)
    )
    return result


def _malformed_result(code: str, reason: str, *, request_id: str = DEFAULT_REQUEST_ID) -> dict[str, Any]:
    request = build_declared_post_continuation_self_continuation_boundary_request(
        self_continuation_boundary_request_id=request_id
    )
    request["block_reason"] = reason
    checks = [
        {
            "check_name": "declared self-continuation-boundary request readable and mapping-shaped",
            "passed": False,
...
def resolve_post_continuation_self_continuation_boundary(
    declared_self_continuation_boundary_request: Mapping[str, Any] | None = None,
) -> dict[str, Any]:
    """Resolve a declared self-continuation-boundary request."""

    if declared_self_continuation_boundary_request is None:
        return _malformed_result(
            "DECLARED_SELF_CONTINUATION_BOUNDARY_REQUEST_MALFORMED",
            "Declared self-continuation-boundary request is missing.",
        )
    if not isinstance(declared_self_continuation_boundary_request, Mapping):
        return _malformed_result(
            "DECLARED_SELF_CONTINUATION_BOUNDARY_REQUEST_MALFORMED",
            "Declared self-continuation-boundary request is not a mapping.",
        )

    request = _deepcopy_mapping(declared_self_continuation_boundary_request)
    checks = _run_checks(request)
    outcome = _determine_outcome(request, checks)
    return _build_result(request, checks, outcome)


def resolve_post_continuation_self_continuation_boundary_from_path(
    declared_self_continuation_boundary_request_path: Path | str,
) -> dict[str, Any]:
    """Read and resolve a declared self-continuation-boundary request JSON file."""

    path = Path(declared_self_continuation_boundary_request_path)
    try:
        loaded = json.loads(path.read_text(encoding="utf-8"))
    except OSError as exc:
        return _malformed_result(
            "DECLARED_SELF_CONTINUATION_BOUNDARY_REQUEST_UNREADABLE",
            f"Declared self-continuation-boundary request could not be read: {exc}",
        )
    except json.JSONDecodeError as exc:
        return _malformed_result(
            "DECLARED_SELF_CONTINUATION_BOUNDARY_REQUEST_MALFORMED",
            f"Declared self-continuation-boundary request JSON is malformed: {exc}",
        )
    if not isinstance(loaded, Mapping):
        return _malformed_result(
            "DECLARED_SELF_CONTINUATION_BOUNDARY_REQUEST_MALFORMED",
            "Declared self-continuation-boundary request JSON is not an object.",
        )
    return resolve_post_continuation_self_continuation_boundary(loaded)


def build_post_continuation_self_continuation_boundary_summary(
    result: Mapping[str, Any],
) -> dict[str, Any]:
    """Build a compact summary for a self-continuation-boundary result."""

    metadata = result.get("post_continuation_self_continuation_boundary_metadata", {})
    if not isinstance(metadata, Mapping):
        metadata = {}
    declared_question = result.get("declared_self_continuation_boundary_question", {})
    if not isinstance(declared_question, Mapping):
        declared_question = {}
    statement = result.get("self_continuation_boundary_statement", {})
    if not isinstance(statement, Mapping):
        statement = {}
    block = result.get("block")
    if not isinstance(block, Mapping):
        block = {}
    checks = result.get("self_continuation_boundary_checks", [])
    ...
    summary: dict[str, Any] = {
        ...
        "request_id": declared_question.get("self_continuation_boundary_request_id")
        or metadata.get("post_continuation_self_continuation_boundary_id"),
        "question": declared_question.get("question"),
        "intent": declared_question.get("intent"),
        "passed_check_count": passed_count,
        "failed_check_count": failed_count,
        "result_version": metadata.get("post_continuation_self_continuation_boundary_version"),
        "resolver_module": metadata.get("resolver_module"),
        "key_non_claims": _canonical_false_non_claims(),
        "no_self_continuation_self_recursive_growth_daemon_loop_api_interface_distributed_network_source_authority_currentness_deployment_public_release_follow_on": True,
    }
    ...
    summary.update(
        {
            ...
            "selected_reusable_runtime_permission_boundary_version": _basis_value(
                result, "selected_reusable_runtime_permission_boundary_basis", "result_version"
            ),
...
def write_post_continuation_self_continuation_boundary_result(
    result: Mapping[str, Any],
    output_path: Path | str | None = None,
) -> Path:
    """Write a self-continuation-boundary result JSON file without overwriting."""

    if not isinstance(result, Mapping):
        raise PostContinuationSelfContinuationBoundaryError("Result must be a mapping.")
    metadata = result.get("post_continuation_self_continuation_boundary_metadata", {})
    request_id = DEFAULT_REQUEST_ID
    if isinstance(metadata, Mapping):
        request_id = str(
            metadata.get("post_continuation_self_continuation_boundary_id") or request_id
        )
    filename = f"{request_id}__post_continuation_self_continuation_boundary_result.json"
...
def build_declared_post_continuation_self_continuation_boundary_request(
    *,
    self_continuation_boundary_request_id: str = DEFAULT_REQUEST_ID,
    self_continuation_boundary_question: str = SELF_CONTINUATION_BOUNDARY_QUESTION,
    self_continuation_boundary_intent: str = INTENT_RECORD,
    self_continuation_boundary_scope: Any = SUPPORTED_SCOPE_VALUES,
    **overrides: Any,
) -> dict[str, Any]:
    """Build a declared self-continuation-boundary request that records cleanly."""

    request: dict[str, Any] = {
        "self_continuation_boundary_request_id": self_continuation_boundary_request_id,
        "self_continuation_boundary_question": self_continuation_boundary_question,
        "self_continuation_boundary_intent": self_continuation_boundary_intent,
        ...
        "self_continuation_boundary_scope": list(self_continuation_boundary_scope)
        if not isinstance(self_continuation_boundary_scope, str)
        else self_continuation_boundary_scope,
        ...
        "selected_continuation_non_claims_canonicalized": True,
        "selected_continuation_terminal_summary_self_continuation_not_authorized": True,
        "selected_continuation_terminal_summary_no_self_continuation_selected": True,
        "selected_continuation_terminal_summary_anything_outside_envelope_requires_fresh_admission": True,
        "selected_continuation_terminal_summary_future_work_requires_separate_step_back_review": True,
