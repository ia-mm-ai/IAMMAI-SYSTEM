"""Bounded post-reusable-runtime-permission continuation resolver.

This resolver is downstream of the continuation-boundary line. It may record
one bounded continuation posture and one bounded continuation envelope only.
It does not authorize self-continuation, self-recursive growth, daemon, loop,
...
class PostReusableRuntimePermissionContinuationError(Exception):
    """Bounded resolver error for continuation handling."""
...
RESOLVER_MODULE = "resolve_post_reusable_runtime_permission_continuation"

OUTCOME_RECORDED = "POST_REUSABLE_RUNTIME_PERMISSION_CONTINUATION_RECORDED"
OUTCOME_NOT_RECORDED = "POST_REUSABLE_RUNTIME_PERMISSION_CONTINUATION_NOT_RECORDED"
OUTCOME_REQUIRES_ADDITIONAL_BASIS = (
    "POST_REUSABLE_RUNTIME_PERMISSION_CONTINUATION_REQUIRES_ADDITIONAL_BASIS"
)
OUTCOME_BLOCKED = "POST_REUSABLE_RUNTIME_PERMISSION_CONTINUATION_BLOCKED"
OUTCOME_FAMILY = (
    OUTCOME_RECORDED,
...
INTENT_RECORD = "RECORD_POST_REUSABLE_RUNTIME_PERMISSION_CONTINUATION"
INTENT_DO_NOT_RECORD = "DO_NOT_RECORD_POST_REUSABLE_RUNTIME_PERMISSION_CONTINUATION"
INTENT_BLOCK = "BLOCK_POST_REUSABLE_RUNTIME_PERMISSION_CONTINUATION"
...
CORE_QUESTION = (
    "Can the clean post-reusable-runtime-permission continuation-boundary "
    "basis be used to record one bounded continuation posture without "
    "authorizing self-continuation, self-recursive growth, runtime daemon, "
...
SUPPORTED_CONTINUATION_SCOPE = SUPPORTED_SCOPE_VALUES
...
BLOCK_CODES = _tokens(
    ...
    CONTINUATION_EXPLICIT_BLOCK_REQUESTED
    ...
    CONTINUATION_REQUIRED_POSTURE_MISSING
    BOUNDED_CONTINUATION_ENVELOPE_UNDECLARED
    BOUNDED_CONTINUATION_ENVELOPE_OVERBROAD
    CONTINUATION_CREATED_BEFORE_REVIEW
    CONTINUATION_TREATED_AS_SELF_CONTINUATION
    CONTINUATION_TREATED_AS_SELF_RECURSIVE_GROWTH
    CONTINUATION_TREATED_AS_RUNTIME_DAEMON
...
_DEFAULT_REQUEST_ID = "post_reusable_runtime_permission_continuation_reference_review_001"
_REDACTED_RAW_OR_HIDDEN_STATE = "[bounded-redacted-raw-or-hidden-state]"
_REDACTED_CONTINUATION_PLACEHOLDER = "[bounded-continuation-redacted]"
...
_OPEN_ITEMS = (
    "continuation test",
    "continuation live artifact",
    "continuation terminal summary, if needed",
    "self-continuation",
...
def _scope_values(request: Mapping[str, Any]) -> list[Any]:
    scope = request.get("continuation_scope")
...
def _validate_scope(request: Mapping[str, Any], checks: list[dict[str, Any]]) -> None:
    ...
    redaction_values = {
        _REDACTED_CONTINUATION_PLACEHOLDER,
...
def _base_request_checks(request: Mapping[str, Any], checks: list[dict[str, Any]]) -> None:
    question = request.get("continuation_question")
    intent = request.get("continuation_intent")
    _check(
        checks,
    ...
    _check(
        checks,
        "continuation_intent_not_explicit_block",
        intent != INTENT_BLOCK,
...
def _continuation_boundary_checks(
    request: Mapping[str, Any], checks: list[dict[str, Any]]
) -> None:
    _check(
        checks,
        "continuation_boundary_basis_declared",
        _is_declared(request.get("selected_continuation_boundary_basis")),
        "selected continuation-boundary live artifact basis declared",
        request.get("selected_continuation_boundary_basis"),
        "CONTINUATION_BOUNDARY_BASIS_MISSING",
    )
    _check(
        checks,
        "continuation_boundary_terminal_summary_basis_declared",
        _is_declared(request.get("selected_continuation_boundary_terminal_summary_basis")),
        "selected continuation-boundary terminal summary basis declared",
        request.get("selected_continuation_boundary_terminal_summary_basis"),
        "CONTINUATION_BOUNDARY_BASIS_MISSING",
    )
    _check(
        checks,
        "continuation_boundary_outcome_recorded",
        request.get("selected_continuation_boundary_result_outcome")
        == EXPECTED_CONTINUATION_BOUNDARY_OUTCOME,
        EXPECTED_CONTINUATION_BOUNDARY_OUTCOME,
        request.get("selected_continuation_boundary_result_outcome"),
        "CONTINUATION_BOUNDARY_NOT_RECORDED",
    ...
    _check(
        checks,
        "continuation_boundary_version_0_1_0",
        request.get("selected_continuation_boundary_result_version") == "0.1.0",
        "0.1.0",
        request.get("selected_continuation_boundary_result_version"),
        "CONTINUATION_BOUNDARY_VERSION_NOT_0_1_0",
    )
    _check(
        checks,
        "continuation_boundary_failed_checks_zero",
        request.get("selected_continuation_boundary_failed_check_count") == 0,
        0,
        request.get("selected_continuation_boundary_failed_check_count"),
        "CONTINUATION_BOUNDARY_FAILED_CHECKS_PRESENT",
    )
    _check(
        checks,
        "continuation_boundary_declared_future_continuation_review",
        request.get("selected_continuation_boundary_declared_future_review") is True,
        True,
        request.get("selected_continuation_boundary_declared_future_review"),
        "CONTINUATION_BOUNDARY_DID_NOT_DECLARE_FUTURE_CONTINUATION_REVIEW",
    )
    _check(
        checks,
        "continuation_boundary_terminal_summary_continuation_not_authorized",
        request.get("selected_continuation_boundary_terminal_summary_continuation_not_authorized")
        is True,
        True,
        request.get("selected_continuation_boundary_terminal_summary_continuation_not_authorized"),
        "CONTINUATION_BOUNDARY_ALREADY_AUTHORIZED_CONTINUATION",
    ...
    _check(
        checks,
        "continuation_boundary_terminal_summary_self_continuation_not_authorized",
        request.get(
            "selected_continuation_boundary_terminal_summary_self_continuation_not_authorized"
        )
        is True,
        True,
        request.get(
    ...
    _check(
        checks,
        "continuation_boundary_terminal_summary_no_continuation_selected",
        request.get("selected_continuation_boundary_terminal_summary_no_continuation_selected")
        is True,
        True,
        request.get("selected_continuation_boundary_terminal_summary_no_continuation_selected"),
        "CONTINUATION_BOUNDARY_TREATED_AS_CONTINUATION",
    ...
    _check(
        checks,
        "continuation_boundary_terminal_summary_future_work_separate",
        request.get(
            "selected_continuation_boundary_terminal_summary_future_work_requires_separate_step_back_review"
        )
        is True,
        True,
        request.get(
    ...
    false_flags = (
        (
            "selected_continuation_boundary_already_authorized_continuation",
            "continuation_boundary_did_not_authorize_continuation",
            "CONTINUATION_BOUNDARY_ALREADY_AUTHORIZED_CONTINUATION",
        ),
        (
            "selected_continuation_boundary_already_authorized_self_continuation",
            "continuation_boundary_did_not_authorize_self_continuation",
            "CONTINUATION_BOUNDARY_ALREADY_AUTHORIZED_SELF_CONTINUATION",
        ),
        (
            "selected_continuation_boundary_already_created_runtime_daemon",
            "continuation_boundary_did_not_create_runtime_daemon",
            "CONTINUATION_BOUNDARY_ALREADY_CREATED_RUNTIME_DAEMON",
        ),
        (
            "selected_continuation_boundary_already_created_runtime_loop",
            "continuation_boundary_did_not_create_runtime_loop",
            "CONTINUATION_BOUNDARY_ALREADY_CREATED_RUNTIME_LOOP",
        ),
        (
            "selected_continuation_boundary_already_created_public_api",
            "continuation_boundary_did_not_create_public_api",
            "CONTINUATION_BOUNDARY_ALREADY_CREATED_PUBLIC_API",
        ),
        (
            "selected_continuation_boundary_already_created_participant_facing_interface",
            "continuation_boundary_did_not_create_participant_facing_interface",
            "CONTINUATION_BOUNDARY_ALREADY_CREATED_PARTICIPANT_FACING_INTERFACE",
        ),
        (
            "selected_continuation_boundary_already_created_distributed_network_behavior",
            "continuation_boundary_did_not_create_distributed_network_behavior",
            "CONTINUATION_BOUNDARY_ALREADY_CREATED_DISTRIBUTED_NETWORK_BEHAVIOR",
        ),
        (
            "selected_continuation_boundary_treated_as_continuation",
            "continuation_boundary_not_treated_as_continuation",
            "CONTINUATION_BOUNDARY_TREATED_AS_CONTINUATION",
        ),
        (
            "selected_continuation_boundary_treated_as_self_continuation",
            "continuation_boundary_not_treated_as_self_continuation",
            "CONTINUATION_BOUNDARY_TREATED_AS_SELF_CONTINUATION",
        ),
        (
            "selected_continuation_boundary_authorized_future_work",
            "continuation_boundary_did_not_authorize_future_work",
            "CONTINUATION_BOUNDARY_AUTHORIZED_FUTURE_WORK",
        ),
    )
    ...
    _check(
        checks,
        "continuation_boundary_canonicalized_result_level_non_claims",
        request.get("selected_continuation_boundary_non_claims_canonicalized") is True,
        True,
        request.get("selected_continuation_boundary_non_claims_canonicalized"),
        "NON_CLAIM_MISSING_OR_FLIPPED",
    )
...
def _reusable_runtime_permission_checks(
    ...
    false_flags = (
        ...
        (
            "selected_bounded_runtime_reuse_envelope_treated_as_continuation_before_review",
            "bounded_runtime_reuse_envelope_not_treated_as_continuation_before_review",
            "BOUNDED_RUNTIME_REUSE_ENVELOPE_TREATED_AS_CONTINUATION_BEFORE_REVIEW",
        ),
        (
            "selected_bounded_runtime_reuse_envelope_authorized_arbitrary_runtime_activity_before_review",
            "bounded_runtime_reuse_envelope_did_not_authorize_arbitrary_runtime_activity_before_review",
            "BOUNDED_RUNTIME_REUSE_ENVELOPE_AUTHORIZED_ARBITRARY_RUNTIME_ACTIVITY_BEFORE_REVIEW",
        ),
    )
    for field, check_name, code in false_flags:
...
def _posture_checks(request: Mapping[str, Any], checks: list[dict[str, Any]]) -> None:
    for field in _POSTURE_FIELDS:
        _check(
            ...
            "bounded continuation posture declared",
            request.get(field),
            "CONTINUATION_REQUIRED_POSTURE_MISSING",
        )
...
def _false_field_checks(
    ...
    false_fields = (
        ("continuation_created_before_review", "CONTINUATION_CREATED_BEFORE_REVIEW"),
        ("continuation_treated_as_self_continuation", "CONTINUATION_TREATED_AS_SELF_CONTINUATION"),
        ("continuation_treated_as_self_recursive_growth", "CONTINUATION_TREATED_AS_SELF_RECURSIVE_GROWTH"),
        ("continuation_treated_as_runtime_daemon", "CONTINUATION_TREATED_AS_RUNTIME_DAEMON"),
        ("continuation_treated_as_runtime_loop", "CONTINUATION_TREATED_AS_RUNTIME_LOOP"),
        ("continuation_treated_as_public_api", "CONTINUATION_TREATED_AS_PUBLIC_API"),
        ("continuation_treated_as_participant_facing_interface", "CONTINUATION_TREATED_AS_PARTICIPANT_FACING_INTERFACE"),
        ("continuation_treated_as_distributed_network_behavior", "CONTINUATION_TREATED_AS_DISTRIBUTED_NETWORK_BEHAVIOR"),
        ("continuation_treated_as_source_transfer", "CONTINUATION_TREATED_AS_SOURCE_TRANSFER"),
        ("continuation_treated_as_source_receipt", "CONTINUATION_TREATED_AS_SOURCE_RECEIPT"),
        ("continuation_treated_as_reception_authorization", "CONTINUATION_TREATED_AS_RECEPTION_AUTHORIZATION"),
        ("continuation_treated_as_source", "CONTINUATION_TREATED_AS_SOURCE"),
        ("continuation_treated_as_authority", "CONTINUATION_TREATED_AS_AUTHORITY"),
        ("continuation_treated_as_currentness", "CONTINUATION_TREATED_AS_CURRENTNESS"),
        ("continuation_treated_as_deployment", "CONTINUATION_TREATED_AS_DEPLOYMENT"),
        ("continuation_treated_as_public_release", "CONTINUATION_TREATED_AS_PUBLIC_RELEASE"),
        ("continuation_treated_as_operation_permission", "CONTINUATION_TREATED_AS_OPERATION_PERMISSION"),
        ("continuation_treated_as_broader_reusable_permission", "CONTINUATION_TREATED_AS_BROADER_REUSABLE_PERMISSION"),
        ("continuation_treated_as_follow_on_work", "CONTINUATION_TREATED_AS_FOLLOW_ON_WORK"),
        ("continuation_boundary_treated_as_continuation_without_review", "CONTINUATION_BOUNDARY_TREATED_AS_CONTINUATION"),
        ("reusable_runtime_permission_treated_as_continuation_without_review", "BOUNDED_RUNTIME_REUSE_ENVELOPE_TREATED_AS_CONTINUATION_BEFORE_REVIEW"),
        ("bounded_runtime_reuse_envelope_treated_as_continuation_without_review", "BOUNDED_RUNTIME_REUSE_ENVELOPE_TREATED_AS_CONTINUATION_BEFORE_REVIEW"),
        ...
        ("artifact_existence_treated_as_continuation_authority", "ARTIFACT_EXISTENCE_TREATED_AS_CONTINUATION_AUTHORITY"),
        ("artifact_path_treated_as_currentness", "ARTIFACT_PATH_TREATED_AS_CURRENTNESS"),
        ("latest_file_posture_treated_as_continuation_authority", "LATEST_FILE_POSTURE_TREATED_AS_CONTINUATION_AUTHORITY"),
        ("repo_local_availability_treated_as_continuation_authority", "REPO_LOCAL_AVAILABILITY_TREATED_AS_CONTINUATION_AUTHORITY"),
        ("hidden_repo_state_used_as_continuation_content", "HIDDEN_REPO_STATE_USED_AS_CONTINUATION_CONTENT"),
        ("hidden_repo_state_used_as_continuation_authority", "HIDDEN_REPO_STATE_USED_AS_CONTINUATION_AUTHORITY"),
...
def _default_bounded_continuation_envelope() -> dict[str, Any]:
    return {
        "declared": True,
        "envelope_name": "one_bounded_post_reusable_runtime_permission_continuation_envelope",
        "continuation_posture": "one bounded continuation posture from selected continuation-boundary and reusable-runtime-permission basis",
        "scope": (
            "record one bounded continuation posture only; preserve selected "
            "basis as reference-shaped and preserve the bounded runtime-reuse "
            "envelope as basis"
        ),
        "limits": [
...
def _requested_envelope(request: Mapping[str, Any]) -> Any:
    return request.get("requested_bounded_continuation_envelope")


def _envelope_checks(request: Mapping[str, Any], checks: list[dict[str, Any]]) -> None:
    envelope = _requested_envelope(request)
    _check(
        checks,
        "bounded_continuation_envelope_declared",
        _is_declared(envelope),
        "one explicit narrow bounded continuation envelope declared",
        envelope,
        "BOUNDED_CONTINUATION_ENVELOPE_UNDECLARED",
    )
    ...
    overbroad_fields = (
        ...
        "creates_follow_on_work",
    )
    for field in overbroad_fields:
        _check(
            checks,
            f"bounded_continuation_envelope_{field}_false",
    ...
    _check(
        checks,
        "bounded_continuation_envelope_requires_fresh_admission_outside",
        envelope.get("anything_outside_requires_fresh_admission") is True,
        True,
        envelope.get("anything_outside_requires_fresh_admission"),
        "BOUNDED_CONTINUATION_ENVELOPE_OVERBROAD",
    )
...
def _build_checks(request: Mapping[str, Any]) -> list[dict[str, Any]]:
    ...
    _continuation_boundary_checks(request, checks)
    ...
    _envelope_checks(request, checks)
...
def _determine_outcome(request: Mapping[str, Any], checks: list[dict[str, Any]]) -> str:
    ...
    requested = request.get("requested_continuation_outcome")
    if requested == OUTCOME_REQUIRES_ADDITIONAL_BASIS:
        return OUTCOME_REQUIRES_ADDITIONAL_BASIS
    if (
        requested == OUTCOME_NOT_RECORDED
        or request.get("continuation_intent") == INTENT_DO_NOT_RECORD
    ):
        return OUTCOME_NOT_RECORDED
    return OUTCOME_RECORDED


def _continuation_statement(outcome: str) -> dict[str, bool]:
...
def _continuation_non_meaning() -> dict[str, bool]:
    return {
        "continuation_is_self_continuation": False,
        "continuation_is_self_recursive_growth": False,
        "continuation_is_runtime_daemon": False,
        "continuation_is_runtime_loop": False,
        "continuation_is_public_api": False,
        "continuation_is_participant_facing_interface": False,
        "continuation_is_distributed_network_behavior": False,
        "continuation_is_source_transfer": False,
        "continuation_is_source_receipt": False,
        "continuation_is_reception_authorization": False,
        "continuation_is_source": False,
        "continuation_is_authority": False,
        "continuation_is_currentness": False,
        "continuation_is_deployment": False,
        "continuation_is_public_release": False,
        "continuation_is_operation_permission": False,
        "continuation_is_broader_reusable_permission": False,
        "continuation_is_follow_on_work": False,
        "continuation_boundary_is_continuation_without_review": False,
        "reusable_runtime_permission_is_continuation_without_review": False,
        "bounded_runtime_reuse_envelope_is_continuation_without_review": False,
        "artifact_existence_is_continuation_authority": False,
        "repo_local_availability_is_continuation_authority": False,
        "latest_file_posture_is_continuation_authority": False,
    }


def _bounded_continuation_envelope(
    request: Mapping[str, Any], outcome: str
) -> dict[str, Any]:
    envelope = _default_bounded_continuation_envelope()
    requested = _requested_envelope(request)
    if isinstance(requested, Mapping):
        envelope["requested_envelope_reference"] = _sanitize(requested)
    elif requested is not None:
        envelope["requested_envelope_reference"] = _sanitize(requested)
    envelope["declared"] = outcome == OUTCOME_RECORDED
    envelope["recorded"] = outcome == OUTCOME_RECORDED
    envelope["anything_outside_requires_fresh_admission"] = True
    envelope["authorizes_arbitrary_runtime_activity"] = False
    envelope["authorizes_self_continuation"] = False
    envelope["authorizes_follow_on_work"] = False
    return envelope


def _selected_basis_metadata(request: Mapping[str, Any]) -> dict[str, Any]:
    return {
        "selected_continuation_boundary_outcome": _sanitize(
            request.get("selected_continuation_boundary_result_outcome")
        ),
        "selected_continuation_boundary_result_version": _sanitize(
            request.get("selected_continuation_boundary_result_version")
        ),
        "selected_continuation_boundary_failed_check_count": _sanitize(
            request.get("selected_continuation_boundary_failed_check_count")
        ),
...
def _build_result(
    ...
    request_id = str(request.get("continuation_request_id") or _DEFAULT_REQUEST_ID)
    metadata = {
        "post_reusable_runtime_permission_continuation_id": request_id,
        "post_reusable_runtime_permission_continuation_type": (
            "post_reusable_runtime_permission_continuation"
        ),
        "post_reusable_runtime_permission_continuation_version": RESULT_VERSION,
        "generated_at": _utc_now(),
        "resolver_module": RESOLVER_MODULE,
        "request_intent": _sanitize(request.get("continuation_intent")),
    ...
    if outcome == OUTCOME_BLOCKED:
        block = {
            "blocked": True,
            "block_code": first_failed_code or "DECLARED_CONTINUATION_REQUEST_MALFORMED",
            "block_reason": _sanitize(
                block_reason
                or request.get("block_reason")
                or "continuation review blocked by bounded resolver check"
            ),
        }

    result: dict[str, Any] = {
        "post_reusable_runtime_permission_continuation_metadata": metadata,
        "declared_continuation_question": {
            "request_id": request_id,
            "question": _sanitize(request.get("continuation_question")),
            "intent": _sanitize(request.get("continuation_intent")),
        },
        "selected_continuation_boundary_basis": _basis_detail(
            request,
            ...
            "selected_continuation_boundary_result_path",
            (
                "selected_continuation_boundary_declared_future_review",
                "selected_continuation_boundary_non_claims_canonicalized",
            ),
        ),
        "selected_continuation_boundary_terminal_summary_basis": _basis_detail(
            request,
            "selected_continuation_boundary_terminal_summary_basis",
            extra_fields=(
                "selected_continuation_boundary_terminal_summary_continuation_not_authorized",
                "selected_continuation_boundary_terminal_summary_self_continuation_not_authorized",
                "selected_continuation_boundary_terminal_summary_no_continuation_selected",
                "selected_continuation_boundary_terminal_summary_future_work_requires_separate_step_back_review",
            ),
        ),
        ...
        "selected_reusable_runtime_permission_terminal_summary_basis": _basis_detail(
            request, "selected_reusable_runtime_permission_terminal_summary_basis"
        ),
        ...
        "continuation_scope": _sanitize(_scope_values(request)),
        "continuation_checks": checks,
        "continuation_statement": _continuation_statement(outcome),
        "continuation_non_meaning": _continuation_non_meaning(),
        "bounded_continuation_envelope": _bounded_continuation_envelope(
            request, outcome
        ),
    ...
    result["post_reusable_runtime_permission_continuation_summary"] = (
        build_post_reusable_runtime_permission_continuation_summary(result)
    )
    return result
...
def _malformed_result(code: str, reason: str) -> dict[str, Any]:
    request = {
        "continuation_request_id": _DEFAULT_REQUEST_ID,
        "continuation_question": None,
        "continuation_intent": None,
        "continuation_scope": [],
        "requested_bounded_continuation_envelope": _default_bounded_continuation_envelope(),
    }
    checks: list[dict[str, Any]] = []
    _check(checks, "declared_continuation_request_readable", False, "readable mapping", reason, code)
    return _build_result(request, checks, OUTCOME_BLOCKED, reason)


def resolve_post_reusable_runtime_permission_continuation(
    declared_continuation_request: Mapping[str, Any] | None = None,
) -> dict:
    """Resolve one bounded post-reusable-runtime-permission continuation request."""

    if declared_continuation_request is None:
        return _malformed_result(
            "DECLARED_CONTINUATION_REQUEST_MALFORMED",
            "declared continuation request is missing",
        )
    if not isinstance(declared_continuation_request, Mapping):
        return _malformed_result(
            "DECLARED_CONTINUATION_REQUEST_MALFORMED",
            "declared continuation request is not a mapping",
        )

    request = deepcopy(dict(declared_continuation_request))
    checks = _build_checks(request)
    outcome = _determine_outcome(request, checks)
    return _build_result(request, checks, outcome)


def resolve_post_reusable_runtime_permission_continuation_from_path(
    declared_continuation_request_path: Path | str,
) -> dict:
    """Read and resolve a declared continuation request path."""

    path = Path(declared_continuation_request_path)
    try:
        raw = path.read_text(encoding="utf-8")
    except OSError as exc:
        return _malformed_result(
            "DECLARED_CONTINUATION_REQUEST_UNREADABLE",
            f"declared continuation request could not be read: {exc}",
        )
    try:
        ...
        return _malformed_result(
            "DECLARED_CONTINUATION_REQUEST_UNREADABLE",
            f"declared continuation request JSON could not be decoded: {exc}",
        )
    if not isinstance(request, Mapping):
        return _malformed_result(
            "DECLARED_CONTINUATION_REQUEST_MALFORMED",
            "declared continuation request JSON is not an object",
        )
    return resolve_post_reusable_runtime_permission_continuation(request)


def build_post_reusable_runtime_permission_continuation_summary(
    result: Mapping[str, Any],
) -> dict:
    """Build a deterministic summary for one continuation result."""

    checks = list(result.get("continuation_checks", []))
    ...
    metadata = result.get("post_reusable_runtime_permission_continuation_metadata", {})
    selected = metadata.get("selected_basis_summary", {}) if isinstance(metadata, Mapping) else {}
    question = result.get("declared_continuation_question", {})
    statement = result.get("continuation_statement", {})
    ...
    return {
        ...
        "resolver_module": RESOLVER_MODULE,
        "continuation_recorded": statement.get("continuation_recorded") is True,
        "bounded_continuation_posture_recorded": statement.get(
            "bounded_continuation_posture_recorded"
        )
        is True,
        "continuation_boundary_basis_preserved": statement.get(
            "continuation_boundary_basis_preserved"
        )
        is True,
        ...
        is True,
        "bounded_runtime_reuse_envelope_preserved": statement.get(
            "bounded_runtime_reuse_envelope_preserved"
        )
        is True,
        "bounded_continuation_envelope_declared": statement.get(
            "bounded_continuation_envelope_declared"
        )
        is True,
        "continuation_not_self_continuation": statement.get(
            "continuation_not_self_continuation"
        )
        is True,
        "continuation_not_daemon": statement.get("continuation_not_daemon") is True,
        "continuation_not_loop": statement.get("continuation_not_loop") is True,
        "continuation_not_public_api": statement.get("continuation_not_public_api")
        is True,
        "continuation_not_participant_facing_interface": statement.get(
            "continuation_not_participant_facing_interface"
        )
        is True,
        "continuation_not_distributed_network_behavior": statement.get(
            "continuation_not_distributed_network_behavior"
        )
        is True,
        ...
        "hidden_repo_state_not_used_as_continuation_authority": statement.get(
            "hidden_repo_state_not_used_as_continuation_authority"
        )
        is True,
        "repo_local_availability_not_continuation_authority": statement.get(
            "repo_local_availability_not_continuation_authority"
        )
        is True,
        "artifact_existence_not_continuation_authority": statement.get(
            "artifact_existence_not_continuation_authority"
        )
        is True,
        "latest_file_posture_not_continuation_authority": statement.get(
            "latest_file_posture_not_continuation_authority"
        )
        is True,
        ...
        is True,
        "selected_continuation_boundary_outcome": selected.get(
            "selected_continuation_boundary_outcome"
        ),
        "selected_continuation_boundary_result_version": selected.get(
            "selected_continuation_boundary_result_version"
        ),
        "selected_continuation_boundary_failed_check_count": selected.get(
            "selected_continuation_boundary_failed_check_count"
        ),
        ...
        "bounded_continuation_envelope_posture": _sanitize(
            result.get("bounded_continuation_envelope")
        ),
        "no_self_continuation_daemon_loop_api_interface_distributed_network_source_authority_currentness_deployment_public_release_follow_on": all(
...
def write_post_reusable_runtime_permission_continuation_result(
    result: Mapping[str, Any], output_path: Path | str | None = None
) -> Path:
    """Write a bounded continuation result JSON without overwriting."""

    metadata = result.get("post_reusable_runtime_permission_continuation_metadata", {})
    request_id = (
        metadata.get("post_reusable_runtime_permission_continuation_id")
        if isinstance(metadata, Mapping)
        else None
    )
    request_id = str(request_id or _DEFAULT_REQUEST_ID)
    filename = f"{request_id}__post_reusable_runtime_permission_continuation_result.json"
...
def build_declared_post_reusable_runtime_permission_continuation_request(
    continuation_request_id: str = _DEFAULT_REQUEST_ID,
    continuation_scope: list[str] | tuple[str, ...] | None = None,
    requested_bounded_continuation_envelope: Mapping[str, Any] | None = None,
    **overrides: Any,
) -> dict[str, Any]:
    """Build a clean declared continuation request."""

    scope = list(continuation_scope or SUPPORTED_SCOPE_VALUES)
    envelope = deepcopy(
        dict(requested_bounded_continuation_envelope)
        if requested_bounded_continuation_envelope is not None
        else _default_bounded_continuation_envelope()
    )
    request: dict[str, Any] = {
        "continuation_request_id": continuation_request_id,
        "continuation_question": CORE_QUESTION,
        "continuation_intent": INTENT_RECORD,
        "selected_continuation_boundary_basis": {
            **_basis(
                "post_reusable_runtime_permission_continuation_boundary",
                "artifacts/integrity_host_v0_min_coexistence_post_reusable_runtime_permission_continuation_boundary/post_reusable_runtime_permission_continuation_boundary_reference_review_001__post_reusable_runtime_permission_continuation_boundary_result.json",
            ),
            "supporting_surfaces": (
                "spec/POST_REUSABLE_RUNTIME_PERMISSION_CONTINUATION_BOUNDARY_V0_MIN_SPEC.md",
                "src/resolve_post_reusable_runtime_permission_continuation_boundary.py",
                "tests/test_resolve_post_reusable_runtime_permission_continuation_boundary.py",
            ),
        },
        "selected_continuation_boundary_terminal_summary_basis": _basis(
            "post_reusable_runtime_permission_continuation_boundary_terminal_summary",
            "spec/POST_REUSABLE_RUNTIME_PERMISSION_CONTINUATION_BOUNDARY_TERMINAL_SUMMARY_V0.md",
        ),
        "selected_continuation_boundary_result_path": "artifacts/integrity_host_v0_min_coexistence_post_reusable_runtime_permission_continuation_boundary/post_reusable_runtime_permission_continuation_boundary_reference_review_001__post_reusable_runtime_permission_continuation_boundary_result.json",
        ...
        "selected_continuation_boundary_declared_future_review": True,
        "selected_continuation_boundary_already_authorized_continuation": False,
        "selected_continuation_boundary_already_authorized_self_continuation": False,
        "selected_continuation_boundary_already_created_runtime_daemon": False,
        "selected_continuation_boundary_already_created_runtime_loop": False,
        "selected_continuation_boundary_already_created_public_api": False,
        "selected_continuation_boundary_already_created_participant_facing_interface": False,
        "selected_continuation_boundary_already_created_distributed_network_behavior": False,
        "selected_continuation_boundary_treated_as_continuation": False,
        "selected_continuation_boundary_treated_as_self_continuation": False,
        "selected_continuation_boundary_authorized_future_work": False,
        "selected_continuation_boundary_non_claims_canonicalized": True,
        "selected_continuation_boundary_terminal_summary_continuation_not_authorized": True,
        "selected_continuation_boundary_terminal_summary_self_continuation_not_authorized": True,
        "selected_continuation_boundary_terminal_summary_no_continuation_selected": True,
        "selected_continuation_boundary_terminal_summary_future_work_requires_separate_step_back_review": True,
        "selected_reusable_runtime_permission_basis": {
            **_basis(
        ...
        "selected_bounded_runtime_reuse_envelope_treated_as_continuation_before_review": False,
        "selected_bounded_runtime_reuse_envelope_authorized_arbitrary_runtime_activity_before_review": False,
        ...
        "requested_bounded_continuation_envelope": envelope,
        "continuation_scope": scope,
        "reference_shaped_input_posture": True,
    }
    for field in _POSTURE_FIELDS:
        request[field] = _declared_posture(field.replace("_", "-"))
    request.update(_canonical_false_non_claims())
    request["declared_non_claims"] = _canonical_false_non_claims()
